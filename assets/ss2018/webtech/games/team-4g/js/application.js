...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 24],
    ...
    String_String$fromCharCodes: function(charCodes, start, end) {
      ...
      if (typeof charCodes === "object" && charCodes !== null && charCodes.constructor === Array) {
        ...
        return H.Primitives_stringFromCharCodes(start > 0 || end < len ? J.sublist$2$ax(charCodes, start, end) : charCodes);
      }
    ...
    _MultiElementCssClassSet: {
      ...
      static: {
        _MultiElementCssClassSet__MultiElementCssClassSet: function(elements) {
          return new W._MultiElementCssClassSet(elements, new H.MappedListIterable(elements, new W.closure2(), [H.getTypeArgumentByIndex(elements, 0), null]).toList$0(0));
        }
      }
    },
    closure2: {
    ...
    Brick_Brick$special: function(type, color, coordinates, game, $length, position, randomColor, thickness) {
      ...
      switch (type) {
        ...
        case "split":
          ...
          return t1;
        case "invert":
          t1 = new D.InvertBrick(20, null, null, true, null, null, null, thickness, null, D.randomString(10), null);
          t1.position = position;
          t1.length = $length;
    ...
    Controller: {
      ...
      init$0: function() {
        var url, t1, onError, t2;
        url = this.tutorial ? J.toString$0$(P.Uri_base()) + "levels/tutorial" + this.level + ".json" : J.toString$0$(P.Uri_base()) + "levels/level" + this.level + ".json";
        t1 = W.HttpRequest_getString(this.tutorial ? J.toString$0$(P.Uri_base()) + "levels/tutorial" + (this.level + 1) + ".json" : J.toString$0$(P.Uri_base()) + "levels/level" + (this.level + 1) + ".json", null, null).then$1(new D.Controller_init_closure());
    ...
    View: {
      ...
      showIngameMenu$0: function() {
        var elements, t1, cont, t2, retry, skiplevel, menu;
        this.removeIngameMenuButton$0();
        elements = [];
        t1 = document;
        ...
        elements.push(retry);
        skiplevel = t1.createElement("button");
        skiplevel.textContent = "Skip Level";
        skiplevel.classList.add("skiplevel");
        W._EventStreamSubscription$(skiplevel, "click", new D.View_showIngameMenu_closure1(this), false, t2);
        elements.push(skiplevel);
        menu = t1.createElement("button");
        menu.textContent = "Main Menu";
        menu.classList.add("back");
        W._EventStreamSubscription$(menu, "click", new D.View_showIngameMenu_closure2(this), false, t2);
        elements.push(menu);
    ...
    View_showIngameMenu_closure1: {
      ...
      call$1: function($event) {
        var t1 = this.$this;
        t1.removeOverlay$0();
        t1 = t1.controller.game;
        t1.toString;
        $.Loop_allPaused = false;
        t1.bricks = 0;
      }
    },
    View_showIngameMenu_closure2: {
      "^": "Closure:0;$this",
      call$1: function($event) {
        var t1, t2;
        t1 = this.$this;
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, args: [P.CssClassSetImpl]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.int,,]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, args: [W.HttpRequest]}, {func: 1, args: [W.Element]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, v: true, args: [P.Object]}];
