...
C.Dt.eo(x,"GET",a,!0)
z=H.J(new W.W(x,"load",!1),[null])
H.J(new W.O(0,z.Q,z.a,W.Y(new W.bU(y,x)),z.b),[H.Kp(z,0)]).Y()
z=H.J(new W.W(x,"error",!1),[null])
H.J(new W.O(0,z.Q,z.a,W.Y(y.gYJ()),z.b),[H.Kp(z,0)]).Y()
x.send()
return y.Q},
...
return v},function(a,b,c){return this.r6(a,b,c,null)},"AH",null,null,"gyZ",2,5,null,26,26],
...
E3:function(){var z,y
z={}
y=J.T(J.T(this.e,"level"+this.f),"field")
z.a=!1
J.kH(y,new X.cJ(z,this))},
ui:function(a,b){var z,y,x
this.e=a
z=J.U(a)
y=z.p(a,"levelcounter")
b.a=J.T(z.p(a,"level1"),"length")
b.b=J.T(z.p(a,"level1"),"width")
z=this.a
x=J.V(z.b)
H.J(new W.O(0,x.Q,x.a,W.Y(new X.xP(this)),x.b),[H.Kp(x,0)]).Y()
x=J.V(z.z)
H.J(new W.O(0,x.Q,x.a,W.Y(new X.c7(b,this)),x.b),[H.Kp(x,0)]).Y()
z=J.V(z.y)
H.J(new W.O(0,z.Q,z.a,W.Y(new X.pr(b,this,a,y)),z.b),[H.Kp(z,0)]).Y()
z=H.J(new W.W(window,"keydown",!1),[null])
H.J(new W.O(0,z.Q,z.a,W.Y(new X.F3(this)),z.b),[H.Kp(z,0)]).Y()},
static:{N:function(a){var z=new X.hS(null,new X.Q(document.querySelector("#title"),document.querySelector("#welcome"),document.querySelector("#pacmangame"),document.querySelector("#gameover"),document.querySelector("#reasons"),document.querySelector("#level"),document.querySelector("#points"),document.querySelector("#life"),document.querySelector("#ghost"),document.querySelector("#nextlevel"),document.querySelector("#start")),null,null,null,null,1)
z.ui(a,{})
return z}}},
xP:{
"^":"r:17;Q",
...
z=this.Q
if(J.mG(z.Q.cx,C.ST))if(J.Lz(J.EC(a))==="td"){y=a.toElement
x=J.R(y)
w=x.gjO(y)
w.toString
H.Yx("")
v=H.ys(w,"f","").split("_")
if(J.Lz(x.gDD(y))==="empty"){x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
x.Dk(w,H.BU(v[1],null,null))}else if(J.Lz(x.gDD(y))==="ball"){x=z.Q.x
C.Nm.PP(x,"removeWhere")
C.Nm.LP(x,new X.EW(v),!0)
x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
x.iY(w,H.BU(v[1],null,null))}else if(J.Lz(x.gDD(y))==="item"){x=z.Q.r
C.Nm.PP(x,"removeWhere")
C.Nm.LP(x,new X.Pp(v),!0)
x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
...
x.toString
X.UP(x,w,u)}else if(J.Lz(x.gDD(y))==="wall"){x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
x.MO(w,H.BU(v[1],null,null))}else if(J.Lz(x.gDD(y))==="ghost"){x=z.Q.y
C.Nm.PP(x,"removeWhere")
C.Nm.LP(x,new X.RC(v),!0)
x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
x.Yn(w,H.BU(v[1],null,null))}else if(J.Lz(x.gDD(y))==="enemyA"){x=z.Q.y
C.Nm.PP(x,"removeWhere")
C.Nm.LP(x,new X.JE(v),!0)
x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
x.Iw(w,H.BU(v[1],null,null))}else if(J.Lz(x.gDD(y))==="enemyB"){x=z.Q.y
C.Nm.PP(x,"removeWhere")
C.Nm.LP(x,new X.mn(v),!0)
x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
x.eV(w,H.BU(v[1],null,null))}else if(J.Lz(x.gDD(y))==="enemyC"){x=z.Q.y
C.Nm.PP(x,"removeWhere")
C.Nm.LP(x,new X.Il(v),!0)
x=z.Q
if(0>=v.length)return H.e(v,0)
w=H.BU(v[0],null,null)
if(1>=v.length)return H.e(v,1)
u=H.BU(v[1],null,null)
x.e.q(0,"f"+H.d(w)+"_"+H.d(u),C.VN)}else if(J.Lz(x.gDD(y))==="pacman");z.a.eC(z.Q)}}},
EW:{
"^":"r:2;Q",
$1:function(a){var z,y
z=a.gLj()
...
if(J.mG(z,H.BU(y[0],null,null))){z=a.gYZ()
if(1>=y.length)return H.e(y,1)
y=J.mG(z,H.BU(y[1],null,null))
z=y}else z=!1
return z}},
Pp:{
"^":"r:2;Q",
...
x=y.a
y=y.b
w=new X.Pt(null,null,1,0,3,P.L(null,null,null,null,null),null,[],[],[],!1,!1,null)
w.Q=x
w.a=y
z.Q=w
w.b=z.f
...
y.ul(w)
z.E3()
z.b=P.SZ(C.Xl,new X.Ny(z))
z.c=P.SZ(C.Xl,new X.fE(z))
z=z.Q
z.cx=C.ST
y.eC(z)}},
Ny:{
...
z=this.Q
y=z.Q
if(J.mG(y.cx,C.X8))if(!y.ch)y.f.h7()
z.a.eC(z.Q)
return}},
fE:{
"^":"r:2;Q",
...
w=J.U(x)
v=this.Q
v.a=J.T(w.p(x,"level"+y),"length")
u=J.T(w.p(x,"level"+z.f),"width")
v.b=u
v=v.a
x=new X.Pt(null,null,1,0,3,P.L(null,null,null,null,null),null,[],[],[],!1,!1,null)
x.Q=v
x.a=u
z.Q=x
x.b=z.f
...
"^":"r:18;Q",
$1:function(a){var z=this.Q
if(J.mG(z.Q.cx,C.Vg))return
switch(J.Zm(a)){case 37:case 65:z=z.Q
z.cx=C.X8
z=z.f
z.c=0
z.d=-1
break
case 39:case 68:z=z.Q
z.cx=C.X8
z=z.f
z.c=0
z.d=1
break
case 38:case 87:z=z.Q
z.cx=C.X8
z=z.f
z.c=-1
z.d=0
break
case 40:case 83:z=z.Q
z.cx=C.X8
z=z.f
z.c=1
z.d=0
break
case 19:case 80:if(J.mG(z.Q.cx,C.X8))z.Q.cx=C.Ic
else if(J.mG(z.Q.cx,C.Ic)||J.mG(z.Q.cx,C.ST))z.Q.cx=C.X8
break}}},
cJ:{
"^":"r:12;Q,a",
...
z=J.JA(a,"f","").split("_")
y=J.t(b)
if(y.m(b,"#empty")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
w=H.BU(z[1],null,null)
y.e.q(0,"f"+H.d(x)+"_"+H.d(w),C.VN)}else if(y.m(b,"#ball")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
y.Dk(x,H.BU(z[1],null,null))}else if(y.m(b,"#wall")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
w=H.BU(z[1],null,null)
y.toString
X.UP(y,x,w)}else if(y.m(b,"#enemyA")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
y.Yn(x,H.BU(z[1],null,null))}else if(y.m(b,"#enemyB")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
y.Iw(x,H.BU(z[1],null,null))}else if(y.m(b,"#enemyC")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
y.eV(x,H.BU(z[1],null,null))}else if(y.m(b,"#item")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
y.iY(x,H.BU(z[1],null,null))}else if(y.m(b,"#ghost")){y=this.a.Q
if(0>=z.length)return H.e(z,0)
x=H.BU(z[0],null,null)
if(1>=z.length)return H.e(z,1)
y.MO(x,H.BU(z[1],null,null))}else if(y.m(b,"#pacman")){y=this.Q
x=y.a
w=z.length
v=z[0]
u=this.a
...
w=H.BU(z[1],null,null)
x.toString
u=new X.O0(x,null,null,null,null,null,null,null,null,null,C.VN)
u.MS(x,v,w)
x.f=u
y.a=!0}else{y=u.Q
if(0>=w)return H.e(z,0)
...
if(1>=z.length)return H.e(z,1)
w=H.BU(z[1],null,null)
y.e.q(0,"f"+H.d(v)+"_"+H.d(w),C.VN)}}}},
Cj:{
"^":"iJ;oF:dx<,dy,Q,a,b,c,d,e,f,r,x,y,z,ch,cx,cy,db",
Lu:function(a){this.dx.Hq(1)},
h7:function(){var z,y,x
z=this.dy
if(C.jn.V(1+z.j1(99),5)!==0)return
y=this.cy
if(y==="none")switch(1+z.j1(4)){case 1:y="up"
break
case 2:y="down"
break
case 3:y="left"
...
break}z=this.f
x=this.r
this.dx.e.q(0,"f"+H.d(z)+"_"+H.d(x),C.VN)
switch(y){case"up":this.iC()
break
case"down":this.CE()
break
case"left":this.v3(0)
break
case"right":this.u1(0)
break}this.f0()},
NZ:function(a,b,c){this.a=C.aS
this.f=b
this.r=c
this.d=b
this.e=c
...
h7:function(){var z,y,x
z=this.cy
if(z==="none")switch(1+this.dy.j1(4)){case 1:z="up"
break
case 2:z="down"
break
case 3:z="left"
...
break}y=this.f
x=this.r
this.dx.e.q(0,"f"+H.d(y)+"_"+H.d(x),C.VN)
switch(z){case"up":this.iC()
break
case"down":this.CE()
break
case"left":this.v3(0)
...
z=z.b
y=this.dy
if(C.CD.zQ(y.w7()*10)/10<(z-1)/10){z=J.Wx(x)
if(z.A(x,this.f))this.CE()
else if(z.w(x,this.f))this.iC()
else if(z.m(x,this.f)){z=J.Wx(w)
if(z.A(w,this.r))this.u1(0)
else if(z.w(w,this.r))this.v3(0)}}else switch(1+y.j1(4)){case 1:this.iC()
break
case 2:this.CE()
break
case 3:this.v3(0)
...
x=this.b
w=z.e
w.q(0,"f"+H.d(y)+"_"+H.d(x),C.VN)
v=J.WB(this.a,this.c)
u=J.WB(this.b,this.d)
if(J.vU(v,J.aF(z.a,1)))v=0
if(J.UN(v,0))v=J.aF(z.a,1)
if(J.vU(u,J.aF(z.Q,1)))u=0
if(J.UN(u,0))u=J.aF(z.Q,1)
t="f"+H.d(v)+"_"+H.d(u)
if(w.YH(t)){s=w.p(0,t)
y=J.t(s)
if(y.m(s,C.Mn)){v=J.aF(v,this.c)
u=J.aF(u,this.d)
if(J.vU(v,J.aF(z.a,1)))v=0
if(J.UN(v,0))v=J.aF(z.a,1)
if(J.vU(u,J.aF(z.Q,1)))u=0
...
z.nF(v,u,C.Q7)
this.a=v
this.b=u}else if(y.m(s,C.VN)){z.nF(v,u,C.Q7)
this.a=v
this.b=u}else if(y.m(s,C.zW)){if(J.mG(z.cx,C.X8))if(++z.c===z.x.length){z.z=!0
z.cx=C.Vg}else z.z=!1
z.nF(v,u,C.Q7)
this.a=v
this.b=u}else if(y.m(s,C.ma)||y.m(s,C.aS)||y.m(s,C.DL)){z.nF(v,u,C.Q7)
this.a=v
this.b=u
z.Hq(1)}else if(y.m(s,C.ZX))z.tj()
else if(y.m(s,C.nx)){++z.d
z.nF(v,u,C.Q7)
this.a=v
this.b=u}}},
gLj:function(){return this.a},
gYZ:function(){return this.b},
MS:function(a,b,c){this.a=b
this.b=c
this.e=b
this.f=c
this.Q.nF(b,c,C.Q7)
...
gLj:function(){return this.a},
gYZ:function(){return this.b},
Ke:function(a,b,c){this.a=b
this.b=c
this.Q.nF(b,c,C.Mn)},
static:{UP:function(a,b,c){var z=new X.VZ(a,null,null)
z.Ke(a,b,c)
return z}}},
iJ:{
"^":"a;oF:Q<",
Yx:function(){this.x=this.f
this.y=this.r
this.goF().nF(this.x,this.y,this.db)
this.f=this.d
this.r=this.e
this.goF().nF(this.f,this.r,this.a)},
AG:function(){this.b=0
this.c=0
this.cy="none"},
iC:function(){this.b=-1
this.c=0
this.cy="up"},
CE:function(){this.b=1
this.c=0
this.cy="down"},
v3:function(a){this.b=0
this.c=-1
this.cy="left"},
u1:function(a){this.b=0
this.c=1
this.cy="right"},
...
this.x=z
this.y=this.r
this.z=J.WB(z,this.b)
this.ch=J.WB(this.r,this.c)
if(J.vU(this.z,J.aF(this.goF().a,1)))this.z=0
if(J.UN(this.z,0))this.z=J.aF(this.goF().a,1)
if(J.vU(this.ch,J.aF(this.goF().Q,1)))this.ch=0
if(J.UN(this.ch,0))this.ch=J.aF(this.goF().Q,1)
y="f"+H.d(this.z)+"_"+H.d(this.ch)
if(this.goF().e.YH(y)){x=this.goF().e.p(0,y)
z=J.t(x)
if(z.m(x,C.Mn)){this.z=this.x
this.ch=this.y
this.cy="none"
this.goF().nF(this.z,this.ch,this.a)
this.db=this.db
this.f=this.z
this.r=this.ch
this.h7()}else if(z.m(x,C.zW)||z.m(x,C.VN)){this.goF().nF(this.z,this.ch,this.a)
this.goF().nF(this.x,this.y,this.db)
this.db=x
this.f=this.z
this.r=this.ch}else if(z.m(x,C.ma)||z.m(x,C.aS)||z.m(x,C.DL)||z.m(x,C.ZX)){this.z=this.x
this.ch=this.y
this.cy="none"
this.goF().nF(this.z,this.ch,this.a)
this.db=this.db
this.f=this.z
this.r=this.ch}else if(z.m(x,C.nx)){this.goF().nF(this.z,this.ch,this.a)
this.goF().nF(this.x,this.y,this.db)
this.db=x
z=this.z
this.f=z
...
this.r=w
this.f=z
this.r=w}else if(z.m(x,C.Q7)){this.f=this.z
this.r=this.ch
this.Lu(0)}}},
...
Pt:{
"^":"a;Q,a,b,c,d,e,f,r,x,y,z,ch,cx",
iY:function(a,b){var z=new X.VO(this,null,null)
z.oC(this,a,b)
this.r.push(z)},
Dk:function(a,b){var z=new X.zC(this,null,null)
z.lj(this,a,b)
this.x.push(z)},
Yn:function(a,b){var z=new X.Zg(this,C.Xh,null,null,null,null,null,null,null,null,null,null,null,null,!1,"none",C.VN)
z.Oc(this,a,b)
this.y.push(z)},
Iw:function(a,b){var z=new X.Cj(this,C.Xh,null,null,null,null,null,null,null,null,null,null,null,null,!1,"none",C.VN)
z.NZ(this,a,b)
this.y.push(z)},
eV:function(a,b){var z=new X.XC(this,C.Xh,null,null,null,null,null,null,null,null,null,null,null,null,!1,"none",C.VN)
z.M4(this,a,b)
this.y.push(z)},
MO:function(a,b){var z=new X.wi(this,C.Xh,null,null,null,null,null,null,null,null,null,null,null,null,!1,"none",C.VN)
z.uy(this,a,b)
this.y.push(z)},
Hq:function(a){var z
this.ch=!0
...
z=this.d-=a
if(z<=0){this.f.y=!0
this.cx=C.Vg}this.Ts()},
Am:function(){if(J.mG(this.cx,C.X8)){C.Nm.aN(this.y,new X.Pc(this))
this.ch=!1}},
Ts:function(){this.f.Yx()
C.Nm.aN(this.y,new X.u9())},
tj:function(){this.d=0
this.f.y=!0
this.cx=C.Vg},
nF:function(a,b,c){this.e.q(0,C.xB.g(C.xB.g("f",J.Lz(a))+"_",J.Lz(b)),c)}},
Pc:{
"^":"r:2;Q",
$1:function(a){if(!this.Q.ch)a.h7()}},
u9:{
"^":"r:2;",
$1:function(a){return a.Yx()}},
Q:{
"^":"a;Q,a,b,c,d,e,f,r,x,y,z",
eC:function(a){var z,y,x
z=this.a.style
J.oH(z,J.mG(a.cx,C.Vg)?"block":"none")
z=this.y.style
J.oH(z,a.z?"inline":"none")
J.Qy(this.f,"Points: "+a.c)
J.Qy(this.r,"Life: "+a.d)
J.Qy(this.e,"Level: "+a.b)
z=a.f.y
if(z!=null){y=this.c
x=this.d
if(z===!0){J.Qy(y,"Game Over")
J.Qy(x,"You have been killed by an enemy<br>")}else{J.Qy(y,"")
J.Qy(x,"")}z=y
y=x}else{z=this.c
J.Qy(z,"")
y=this.d
J.Qy(y,"")}a.e.aN(0,new X.q8(this))
x=a.z
if(x){J.Qy(z,"Game Won")
J.Qy(y,"You have won this Level!<br>")}},
...
if(typeof x!=="number")return H.o(x)
if(!(w<x))break
z+="<td id='"+("f"+y+"_"+w)+"' class='empty'></td>";++w}z+="</tr>";++y}J.Qy(this.b,z)}},
q8:{
"^":"r:12;Q",
$2:function(a,b){var z,y,x
z=this.Q.b.querySelector("#"+H.d(a))
if(z!=null){y=J.R(z)
y.gDD(z).V1(0)
x=J.t(b)
if(x.m(b,C.Q7))y.gDD(z).h(0,"pacman")
else if(x.m(b,C.zW))y.gDD(z).h(0,"ball")
else if(x.m(b,C.nx))y.gDD(z).h(0,"item")
else if(x.m(b,C.ma))y.gDD(z).h(0,"enemyA")
else if(x.m(b,C.aS))y.gDD(z).h(0,"enemyB")
else if(x.m(b,C.DL))y.gDD(z).h(0,"enemyC")
else if(x.m(b,C.Mn))y.gDD(z).h(0,"wall")
else if(x.m(b,C.VN))y.gDD(z).h(0,"empty")
else if(x.m(b,C.ZX))y.gDD(z).h(0,"ghost")}}}}],["","",,P,{
"^":"",
...
uQ:{
"^":"r:2;",
$1:function(a){return a.V1(0)}}}],["","",,N,{
"^":"",
Iq:[function(){var z=0,y=new P.S(),x,w=2,v,u,t,s,r,q,p
function body(a,b){if(a===1){v=b
z=w}while(true)switch(z){case 0:P.L(null,null,null,null,null)
p=C.P
z=3
return H.Z(W.X("parameters/global_settings.json",null,null),body,y)
case 3:u=p.kV(b)
t=J.U(u)
s=t.p(u,"levelcounter")
if(typeof s!=="number"){x=H.o(s)
z=1
break}else ;r=1
case 4:if(!(r<=s)){z=6
break}z=7
return H.Z(W.X("parameters/level/level"+r+".json",null,null),body,y)
case 7:q=b
t.q(u,"level"+r,C.P.kV(q))
case 5:++r
z=4
break
case 6:X.N(u)
case 1:return H.Z(x,0,y,null)
case 2:return H.Z(v,1,y)}}return H.Z(null,body,y,null)},"$0","KW",0,0,0]},1],]
...
C.zW=new H.wv("ball")
C.ST=new H.wv("creative")
C.VN=new H.wv("empty")
C.ma=new H.wv("enemyA")
C.aS=new H.wv("enemyB")
C.DL=new H.wv("enemyC")
C.ZX=new H.wv("ghost")
C.nx=new H.wv("item")
C.Q7=new H.wv("pacman")
C.Ic=new H.wv("pause")
C.X8=new H.wv("running")
C.Vg=new H.wv("stopped")
C.Mn=new H.wv("wall")
...
init.metadata=[{func:"NT"},{func:"X0",void:true},{func:"aB",args:[null]},{func:"bb",args:[null,P.Gz]},{func:"TS",args:[null,P.I]},{func:"uO",args:[P.I]},{func:"cO",args:[{func:"X0",void:true}]},{func:"Ns",void:true,args:[P.a],opt:[P.Gz]},{func:"Vx",void:true,args:[null],opt:[P.Gz]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"N5",void:true,args:[null,P.Gz]},{func:"bh",args:[null,null]},{func:"lv",args:[P.GD,null]},{func:"Pt",ret:P.I,args:[P.KN]},{func:"L8",args:[W.zU]},{func:"qu",void:true,args:[W.KV]},{func:"XF",args:[W.Aj]},{func:"c0",args:[W.HL]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"G5",void:true,args:[null]},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"Gm",ret:P.KN,args:[P.a]},{func:"Vv",ret:P.a2,args:[W.cv,P.I,P.I,W.JQ]},,];$=null
