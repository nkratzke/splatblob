...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _GeneratorIterable: {
      "^": "ListIterable;length>,_generator",
      elementAt$1: function(_, index) {
        P.RangeError_checkValidIndex(index, this, null, null, null);
        return this._generator$1(index);
      },
    ...
    EventTarget: {
      ...
      $isEventTarget: 1,
      "%": "Animation|AudioContext|CrossOriginServiceWorkerClient|EventSource|IDBDatabase|MIDIAccess|MediaController|MediaQueryList|MediaSource|Notification|OfflineAudioContext|Performance|Presentation|PresentationAvailability|RTCDTMFSender|RTCPeerConnection|ServicePortCollection|ServiceWorkerContainer|ServiceWorkerRegistration|SpeechRecognition|SpeechSynthesis|SpeechSynthesisUtterance|StashedPortCollection|WorkerPerformance|mozRTCPeerConnection|webkitAudioContext|webkitRTCPeerConnection;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0"
    },
    FieldSetElement: {
      "^": "HtmlElement;name=,type=",
      "%": "HTMLFieldSetElement"
    ...
    "^": "",
    main: [function() {
      X.TankGameController$();
    }, "call$0", "tankclient__main$closure", 0, 0, 1]
  }, 1], ["tankgame", "package:webtechnologie_projekt/tankgame.dart",, X, {
    "^": "",
    TankGameController: {
      "^": "Object;view,game,bulletSpeed,lenkraketenSpeed,enemySpeed,addNewEnemySpeed,shoottimer,playerSpeed,playerLeben,gamekey,_player,bulletTrigger,lenkraketenTrigger,enemyTrigger,gamekeyTrigger,addEnemyTrigger,update",
      _moveLenkrakete$0: function() {
        var t1, t2;
        t1 = this.game;
        t2 = t1._gamestate;
        if (J.$eq$(t2._name, "running")) {
          if (t1.get$gameover()) {
            this._gameOver$0();
            return;
          }
          if (t1.zerstoerteEnemys._collection$_length === t1.aktuellesLevelObjekt.anzahlgegner)
            this._showNextLevelButton$0();
          t1.moveLenkrakete$0();
          this.view.update$2(0, t1, this._player);
        }
      },
      _moveBullet$0: function() {
        var t1, t2;
        t1 = this.game;
        t2 = t1._gamestate;
        if (J.$eq$(t2._name, "running")) {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 7:
                ...
                states = $async$result;
                scores = J.map$1$ax(states, new X.TankGameController_getHighscores_closure()).toList$0(0);
                J.sort$1$ax(scores, new X.TankGameController_getHighscores_closure0());
                $async$handler = 2;
                // goto after finally
                $async$goto = 6;
                break;
      ...
      _gameOver$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1, t2, t3, $async$temp1, $async$temp2;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$self.enemyTrigger.cancel$0(0);
                $async$self.bulletTrigger.cancel$0(0);
                $async$self.addEnemyTrigger.cancel$0(0);
                $async$self.update.cancel$0(0);
                t1._gameObjectsMap.clear$0(0);
                t2 = $async$self.view;
                t3 = t2._nextLevelButton.style;
                t3.display = "none";
                t2.update$2(0, t1, $async$self._player);
                $async$temp1 = t2;
                $async$temp2 = t1;
                $async$goto = 2;
                return P._asyncHelper($async$self.getHighscores$0(), $async$_gameOver$0, $async$completer);
              case 2:
                // returning from await.
                $async$temp1.showHighscore$2($async$temp2, $async$result);
                t1 = document.querySelector("#save");
                t1 = t1 == null ? t1 : J.get$onClick$x(t1);
                if (t1 == null)
                  ;
                else
                  H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1.get$_target(), t1._eventType, W._wrapZone(new X.TankGameController__gameOver_closure($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#close"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.TankGameController__gameOver_closure0($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                // implicit return
      ...
      _showNextLevelButton$0: function() {
        var t1, t2, t3;
        t1 = this.game;
        t1._gamestate = C.Symbol_changeLevel;
        this.update.cancel$0(0);
        this.addEnemyTrigger.cancel$0(0);
        this.bulletTrigger.cancel$0(0);
        this.enemyTrigger.cancel$0(0);
        t2 = this.view;
        t3 = t2._nextLevelButton.style;
        t3.display = "block";
        t2.updateStats$2(t1, this._player);
      },
      _startNextLevel$0: function() {
        var t1, t2, t3;
        t1 = this.game;
        if ($.$get$levels().length > t1._aktuelleLevelNummer) {
          t1._bereitsErstellteGegner = 0;
          t1._anzahlAktiverGegner = 0;
          t2 = this._player;
          t3 = t2._lenkraketenMunition;
          if (typeof t3 !== "number")
            return t3.$add();
          t2._lenkraketenMunition = t3 + 1;
          t1.zerstoerteEnemys.clear$0(0);
          t1._gameObjectsMap = this._loadLevel$1(t1._aktuelleLevelNummer + 1);
          this.addEnemyTrigger = P.Timer_Timer$periodic(this.addNewEnemySpeed, new X.TankGameController__startNextLevel_closure(this));
          this.bulletTrigger = P.Timer_Timer$periodic(this.bulletSpeed, new X.TankGameController__startNextLevel_closure0(this));
          this.enemyTrigger = P.Timer_Timer$periodic(this.enemySpeed, new X.TankGameController__startNextLevel_closure1(this));
          this.update = P.Timer_Timer$periodic(C.Duration_500000, new X.TankGameController__startNextLevel_closure2(this));
          t3 = this.view;
          t2 = t3._nextLevelButton.style;
          t2.display = "none";
          t1._gamestate = C.Symbol_running;
          t3.update$2(0, t1, this._player);
        } else
          this._gameOver$0();
      },
      _moveEnemy$0: function() {
        var t1, t2;
        t1 = this.game;
        t2 = t1._gamestate;
        if (J.$eq$(t2._name, "running")) {
      ...
      _loadLevel$1: function(levelnumber) {
        var t1, nextLevelMap, nextLevel, t2, baseposis, base;
        t1 = this.game;
        t1._gameObjectsMap.clear$0(0);
        nextLevelMap = P.HashMap_HashMap(null, null, null, X.Position, X.GameObject);
        nextLevel = C.JSArray_methods.singleWhere$1($.$get$levels(), new X.TankGameController__loadLevel_closure(levelnumber));
        t1.aktuellesLevelObjekt = nextLevel;
        t1._aktuelleLevelNummer = levelnumber;
        C.JSArray_methods.forEach$1(nextLevel.wallpositions, new X.TankGameController__loadLevel_closure0(this, nextLevelMap));
        t2 = nextLevel.basis;
        baseposis = t1.generatePositions$2(t2._row, t2._col);
        t2 = nextLevel.basis;
        base = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, t1, 1, null, null);
        base._type = C.GameObjectType_4;
        base._mittelpunkt = t2;
        base._coords = baseposis;
        C.JSArray_methods.forEach$1(baseposis, new X.TankGameController__loadLevel_closure1(nextLevelMap, base));
        t1._base = base;
        this._player._mittelpunkt = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.TankGameController__loadLevel_closure2(nextLevel));
        t1 = this._player;
        t1._coords = t1._game.generatePositions$2(t1._mittelpunkt.get$row(), this._player._mittelpunkt.get$col());
        C.JSArray_methods.forEach$1(this._player._coords, new X.TankGameController__loadLevel_closure3(this, nextLevelMap));
        return nextLevelMap;
      },
      _addEnemyTank$0: function() {
        var t1, t2;
        t1 = this.game;
        t2 = t1._gamestate;
        if (J.$eq$(t2._name, "running"))
          t1.addEnemyTank$2(this.shoottimer, this.enemySpeed);
      },
      _newGame$0: function() {
        var t1, t2, t3, t4;
        t1 = this.view;
        J.set$innerHtml$x(t1._overlay, "");
        t2 = this.game;
        t2.resetGame$0();
        t3 = X.GameObject$Player(this.playerLeben, this.shoottimer, this.playerSpeed, t2);
        t2._player = t3;
        this._player = t3;
        t4 = t1._nextLevelButton.style;
        t4.display = "none";
        t4 = t1._startbutton.style;
        t4.display = "block";
        t4 = t1._stats.style;
        t4.display = "none";
        t1.update$2(0, t2, t3);
      },
      TankGameController$0: function() {
        var error, stacktrace, error0, stacktrace0, error1, stacktrace1, exception, t1, t2;
        try {
          W.HttpRequest_getString("parameter.json", null, null).then$1(new X.TankGameController_closure(this)).then$1(new X.TankGameController_closure0(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          error = t1;
          stacktrace = H.getTraceFromException(exception);
          P.print("TankeGameController() caused following error: '" + H.S(error) + "'");
          P.print(H.S(stacktrace));
          J.set$innerHtml$x(this.view._warningoverlay, "Parameter konnten nicht geladen werden. Versuche es bitte Sp\xe4ter erneut.");
        }
        try {
          W.HttpRequest_getString("level.json", null, null).then$1(new X.TankGameController_closure1());
        } catch (exception) {
          t1 = H.unwrapException(exception);
          error0 = t1;
          stacktrace0 = H.getTraceFromException(exception);
          P.print("TankeGameController() caused following error: '" + H.S(error0) + "'");
          P.print(H.S(stacktrace0));
          J.set$innerHtml$x(this.view._warningoverlay, "Level konnten nicht geladen werden. Versuche es bitte Sp\xe4ter erneut.");
        }
        try {
          W.HttpRequest_getString("gamekey.json", null, null).then$1(new X.TankGameController_closure2(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          error1 = t1;
          stacktrace1 = H.getTraceFromException(exception);
          P.print("TankeGameController() caused following error: '" + H.S(error1) + "'");
          P.print(H.S(stacktrace1));
          J.set$innerHtml$x(this.view._warningoverlay, "Could not get gamekey settings. Highscore will not working properly.");
        }
        t1 = this.view;
        t1.generateField$1(this.game);
        t2 = J.get$onClick$x(t1._startbutton);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.TankGameController_closure3(this)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
        t1 = J.get$onClick$x(t1._nextLevelButton);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.TankGameController_closure4(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.TankGameController_closure5(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "touchstart", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_touchstart, 0)]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.TankGameController_closure6(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {
        TankGameController$: function() {
          var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
          t1 = document.querySelector("#tanktable");
          t2 = document.querySelector("#warningoverlay");
          t3 = document.querySelector("#highscore");
          t4 = document.querySelector("#overlaycontent");
          t5 = document.querySelector("#level");
          t6 = document.querySelector("#lenkMunition");
          t7 = document.querySelector("#verbleibendeGegner");
          t8 = document.querySelector("#nextLevelButton");
          t9 = document.querySelector("#startButton");
          t10 = document.querySelector("#playerleben");
          t11 = document.querySelector("#stats");
          t12 = new X.TankGame(null, P.HashMap_HashMap(null, null, null, X.Position, X.GameObject), [], 42, 0, 0, P.LinkedHashSet_LinkedHashSet(null, null, null, X.GameObject), P.LinkedHashSet_LinkedHashSet(null, null, null, X.GameObject), null, null, null, null);
          t12._gamestate = C.Symbol_stopped;
          t12._aktuelleLevelNummer = 1;
          t12.generatePositionsObjects$0();
          t12 = new X.TankGameController(new X.TankView(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, null), t12, P.Duration$(0, 0, 0, 0, 0, 0), P.Duration$(0, 0, 0, 0, 0, 0), P.Duration$(0, 0, 0, 0, 0, 0), P.Duration$(0, 0, 0, 0, 0, 0), P.Duration$(0, 0, 0, 0, 0, 0), P.Duration$(0, 0, 0, 0, 0, 0), null, null, null, null, null, null, null, null, null);
          t12.TankGameController$0();
          return t12;
        }
      }
    },
    TankGameController_closure: {
      "^": "Closure:0;$this",
      call$1: function(json) {
        var parsed, t1;
        parsed = C.JsonCodec_null_null.decode$1(json);
        t1 = this.$this;
        t1.bulletSpeed = P.Duration$(0, 0, 0, J.$index$asx(parsed, "bulletSpeed"), 0, 0);
        t1.lenkraketenSpeed = P.Duration$(0, 0, 0, J.$index$asx(parsed, "lenkraketenSpeed"), 0, 0);
        t1.enemySpeed = P.Duration$(0, 0, 0, J.$index$asx(parsed, "enemySpeed"), 0, 0);
        t1.addNewEnemySpeed = P.Duration$(0, 0, 0, 0, 0, J.$index$asx(parsed, "addNewEnemySpeed"));
        t1.shoottimer = P.Duration$(0, 0, 0, 0, 0, J.$index$asx(parsed, "shootTimer"));
        t1.playerSpeed = P.Duration$(0, 0, 0, J.$index$asx(parsed, "playerSpeed"), 0, 0);
        t1.playerLeben = J.$index$asx(parsed, "playerLifes");
      }
    },
    TankGameController_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1, t2, t3;
        t1 = this.$this;
        t2 = t1.game;
        t3 = X.GameObject$Player(t1.playerLeben, t1.shoottimer, t1.playerSpeed, t2);
        t2._player = t3;
        t1._player = t3;
        return t3;
      }
    },
    TankGameController_closure1: {
      "^": "Closure:0;",
      call$1: function(json) {
        var parsed = C.JsonCodec_null_null.decode$1(json);
        J.forEach$1$ax(J.$index$asx(parsed, "levels"), new X.TankGameController__closure5());
      }
    },
    TankGameController__closure5: {
      "^": "Closure:3;",
      call$2: function(levelnummer, inhalt) {
        var temp = new X.Level(null, null, null, null, [], null, null);
        temp.set$levelnumber(H.Primitives_parseInt(levelnummer, null, null));
        temp.set$anzahlgegner(J.$index$asx(inhalt, "anzahlGegner"));
        temp.set$concurrentlyEnemysOnField(J.$index$asx(inhalt, "concurrentlyEnemysOnField"));
        temp.set$enemyLeben(J.$index$asx(inhalt, "enemyLeben"));
        temp.set$startpositionPlayer(new X.Position(J.$index$asx(J.$index$asx(inhalt, "startpositionPlayer"), "row"), J.$index$asx(J.$index$asx(inhalt, "startpositionPlayer"), "col")));
        temp.set$basis(new X.Position(J.$index$asx(J.$index$asx(inhalt, "basis"), "row"), J.$index$asx(J.$index$asx(inhalt, "basis"), "col")));
        J.forEach$1$ax(J.$index$asx(inhalt, "wallPositionen"), new X.TankGameController___closure(temp));
        $.$get$levels().push(temp);
      }
    },
    TankGameController___closure: {
      "^": "Closure:0;temp",
      call$1: function(key) {
        this.temp.wallpositions.push(new X.Position(J.$index$asx(key, "row"), J.$index$asx(key, "col")));
      }
    },
    TankGameController_closure2: {
      "^": "Closure:0;$this",
      call$1: function(json) {
        ...
        t4 = new X.GameKey(null, J.$index$asx(settings, "gameid"), "13c0fc7472b3cc0b", false);
        t4._uri = P.Uri__makeHttpUri("http", H.S(t2) + ":" + H.S(t3), "/", null);
        t1.gamekey = t4;
        t1.gamekeyTrigger = P.Timer_Timer$periodic(C.Duration_5000000, new X.TankGameController__closure4(t1));
      }
    },
    TankGameController__closure4: {
      "^": "Closure:5;$this",
      call$1: function(_) {
            ...
            switch ($async$goto) {
              ...
              case 2:
                ...
                if ($async$result === true)
                  J.set$innerHtml$x(t2._warningoverlay, "");
                else
                  J.set$innerHtml$x(t2._warningoverlay, "Could not connect to gamekey service. Highscore will not working properly.");
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
    ...
    TankGameController_closure3: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1, t2, t3, t4;
        t1 = this.$this;
        t2 = t1.game;
        t2._gameObjectsMap.clear$0(0);
        t2._gameObjectsMap = t1._loadLevel$1(t2._aktuelleLevelNummer);
        t3 = t1.bulletTrigger;
        if (t3 != null)
          t3.cancel$0(0);
        t3 = t1.enemyTrigger;
        if (t3 != null)
          t3.cancel$0(0);
        t3 = t1.addEnemyTrigger;
        if (t3 != null)
          t3.cancel$0(0);
        t3 = t1.update;
        if (t3 != null)
          t3.cancel$0(0);
        t3 = t1.lenkraketenTrigger;
        if (t3 != null)
          t3.cancel$0(0);
        t1.lenkraketenTrigger = P.Timer_Timer$periodic(t1.lenkraketenSpeed, new X.TankGameController__closure(t1));
        t1.bulletTrigger = P.Timer_Timer$periodic(t1.bulletSpeed, new X.TankGameController__closure0(t1));
        t1.enemyTrigger = P.Timer_Timer$periodic(t1.enemySpeed, new X.TankGameController__closure1(t1));
        t1.addEnemyTrigger = P.Timer_Timer$periodic(t1.addNewEnemySpeed, new X.TankGameController__closure2(t1));
        t1.update = P.Timer_Timer$periodic(C.Duration_500000, new X.TankGameController__closure3(t1));
        t2._gamestate = C.Symbol_running;
        t3 = t1.view;
        t4 = t3._stats.style;
        t4.display = "block";
        t3.updateStats$2(t2, t1._player);
        t4 = t3._startbutton.style;
        t4.display = "none";
        t3.update$2(0, t2, t1._player);
      }
    },
    TankGameController__closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._moveLenkrakete$0();
      }
    },
    TankGameController__closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._moveBullet$0();
      }
    },
    TankGameController__closure1: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._moveEnemy$0();
      }
    },
    TankGameController__closure2: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._addEnemyTank$0();
      }
    },
    TankGameController__closure3: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        return t1.view.updateStats$2(t1.game, t1._player);
      }
    },
    TankGameController_closure4: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._startNextLevel$0();
      }
    },
    TankGameController_closure5: {
      "^": "Closure:27;$this",
      call$1: function(ev) {
        var t1, t2, t3;
        if (J.get$keyCode$x(ev) === 80) {
          t1 = this.$this;
          t2 = t1.game;
          t3 = t2._gamestate;
          if (J.$eq$(t3._name, "changeLevel"))
            ;
          else {
            t3 = t2._gamestate;
            if (J.$eq$(t3._name, "running")) {
              t2._gamestate = C.Symbol_paused;
              J.set$innerHtml$x(t1.view._overlay, "PAUSE");
            } else {
              t3 = t2._gamestate;
              if (J.$eq$(t3._name, "stopped"))
                ;
              else {
                t2._gamestate = C.Symbol_running;
                J.set$innerHtml$x(t1.view._overlay, "");
              }
            }
          }
        }
        ...
        if (J.$eq$(t3._name, "running")) {
          ...
          switch (ev.keyCode) {
            case 76:
              t1._player.lenkrakete$0();
              t1.view.update$2(0, t2, t1._player);
              break;
            case 39:
              t1._player.moveRight$0();
              t1.view.update$2(0, t2, t1._player);
              break;
            case 37:
              t1._player.moveLeft$0();
              t1.view.update$2(0, t2, t1._player);
              break;
            case 38:
              t1._player.moveUp$0();
    ...
    TankGameController_closure6: {
      ...
      call$1: function(ev) {
        ...
        t3 = t2._gamestate;
        if (J.$eq$(t3._name, "running")) {
          test = J.get$target$x(ev);
          t3 = J.getInterceptor$x(test);
          if (t3.get$id(test) === "buttonUp") {
            t1._player.moveUp$0();
            t1.view.update$2(0, t2, t1._player);
          }
          if (t3.get$id(test) === "buttonDown") {
            t1._player.moveDown$0();
            t1.view.update$2(0, t2, t1._player);
          }
          if (t3.get$id(test) === "buttonLeft") {
            t1._player.moveLeft$0();
            t1.view.update$2(0, t2, t1._player);
          }
          if (t3.get$id(test) === "buttonRight") {
            t1._player.moveRight$0();
            t1.view.update$2(0, t2, t1._player);
          }
          if (t3.get$id(test) === "buttonShoot") {
            t1._player.shoot$0();
            t1.view.update$2(0, t2, t1._player);
          }
          if (t3.get$id(test) === "buttonLenkrakete") {
            t1._player.lenkrakete$0();
            t1.view.update$2(0, t2, t1._player);
          }
        }
    ...
    TankGameController_getHighscores_closure: {
      "^": "Closure:0;",
    ...
    TankGameController_getHighscores_closure0: {
      "^": "Closure:3;",
      call$2: function(a, b) {
        return J.$sub$n(J.$index$asx(b, "score"), J.$index$asx(a, "score"));
      }
    },
    TankGameController__gameOver_closure: {
      "^": "Closure:5;$this",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, user, pwd, t1, id, t2, t3, $async$temp1, $async$temp2;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                user = H.interceptedTypeCast(document.querySelector("#user"), "$isInputElement").value;
                pwd = H.interceptedTypeCast(document.querySelector("#pwd"), "$isInputElement").value;
                if (user.length === 0) {
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), "Please provide user name.");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                ...
                t1 = $async$self.$this;
                $async$goto = 3;
                return P._asyncHelper(t1.gamekey.getUserId$1(user), $async$call$1, $async$completer);
              case 3:
                // returning from await.
                id = $async$result;
                t2 = id == null;
                if (t2) {
                  t3 = "User " + H.S(user) + " not found. Shall we create it?<button id='create'>Create</button><button id='cancel' class='discard'>Cancel</button>";
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), t3);
                  t3 = document.querySelector("#cancel");
                  t3 = t3 == null ? t3 : J.get$onClick$x(t3);
                  if (t3 == null)
                    ;
                  else
                    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3.get$_target(), t3._eventType, W._wrapZone(new X.TankGameController__gameOver__closure(t1)), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
                  t3 = document.querySelector("#create");
                  t3 = t3 == null ? t3 : J.get$onClick$x(t3);
                  if (t3 == null)
                    ;
                  else
                    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3.get$_target(), t3._eventType, W._wrapZone(new X.TankGameController__gameOver__closure0(t1, user, pwd)), false), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
                } else
                  ;
                $async$goto = !t2 ? 4 : 5;
                break;
              case 4:
                // then
                $async$goto = 6;
                return P._asyncHelper(t1.gamekey.getUser$2(id, pwd), $async$call$1, $async$completer);
              case 6:
                // returning from await.
                user = $async$result;
                if (user == null) {
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), "Wrong access credentials.");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                ...
                t2 = t1.game;
                $async$goto = 10;
                return P._asyncHelper(t1.gamekey.storeState$2(J.$index$asx(user, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.2", "points", t2.get$highscore()])), $async$call$1, $async$completer);
              case 10:
                // returning from await.
                $async$goto = $async$result === true ? 7 : 9;
                break;
              case 7:
                // then
                t3 = t1.view;
                J.set$innerHtml$x(t3._overlay, "");
                $async$temp1 = t3;
                $async$temp2 = t2;
                $async$goto = 11;
                return P._asyncHelper(t1.getHighscores$0(), $async$call$1, $async$completer);
              case 11:
                // returning from await.
                $async$temp1.showOnlyHighscore$2($async$temp2, $async$result);
                t2 = J.get$onClick$x(document.querySelector("#close"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.TankGameController__gameOver__closure1(t1)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
                // goto join
                $async$goto = 8;
                break;
              case 9:
                // else
                J.set$innerHtml$x(document.querySelector("#highscorewarning"), "Could not save highscore. Retry?");
                // goto return
                $async$goto = 1;
                break;
              case 8:
    ...
    TankGameController__gameOver__closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._newGame$0();
      }
    },
    TankGameController__gameOver__closure0: {
      "^": "Closure:5;$this,user,pwd",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, usr, t3, $async$temp1, $async$temp2;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2 = $async$self.user;
                $async$goto = 3;
                return P._asyncHelper(t1.gamekey.registerUser$2(t2, $async$self.pwd), $async$call$1, $async$completer);
              case 3:
                // returning from await.
                usr = $async$result;
                if (usr == null) {
                  t1 = "Could not register user " + H.S(t2) + ". User might already exist or gamekey service not available.";
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), t1);
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                J.set$innerHtml$x(document.querySelector("#highscorewarning"), "");
                t2 = t1.game;
                $async$goto = 7;
                return P._asyncHelper(t1.gamekey.storeState$2(J.$index$asx(usr, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.2", "points", t2.get$highscore()])), $async$call$1, $async$completer);
              case 7:
                // returning from await.
                $async$goto = $async$result === true ? 4 : 6;
                break;
              case 4:
                // then
                P.print("test");
              ...
              case 8:
                ...
                $async$temp1.showOnlyHighscore$2($async$temp2, $async$result);
                t2 = J.get$onClick$x(document.querySelector("#close"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.TankGameController__gameOver___closure(t1)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
                // goto join
                $async$goto = 5;
                break;
              case 6:
    ...
    TankGameController__gameOver___closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._newGame$0();
      }
    },
    TankGameController__gameOver__closure1: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._newGame$0();
      }
    },
    TankGameController__gameOver_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._newGame$0();
      }
    },
    TankGameController__startNextLevel_closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._addEnemyTank$0();
      }
    },
    TankGameController__startNextLevel_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._moveBullet$0();
      }
    },
    TankGameController__startNextLevel_closure1: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._moveEnemy$0();
      }
    },
    TankGameController__startNextLevel_closure2: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        return t1.view.updateStats$2(t1.game, t1._player);
    ...
    TankGameController__loadLevel_closure: {
      "^": "Closure:0;levelnumber",
      call$1: function(lev) {
        return J.$eq$(lev.get$levelnumber(), this.levelnumber);
      }
    },
    TankGameController__loadLevel_closure0: {
      "^": "Closure:0;$this,nextLevelMap",
      call$1: function(wandposition) {
        var t1, posis, wall;
        t1 = this.$this.game;
        posis = t1.generatePositions$2(wandposition.get$row(), wandposition._col);
        wall = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, t1, 3, null, null);
        wall._type = C.GameObjectType_2;
        wall._mittelpunkt = wandposition;
        wall._coords = posis;
        C.JSArray_methods.forEach$1(posis, new X.TankGameController__loadLevel__closure(this.nextLevelMap, wall));
      }
    },
    TankGameController__loadLevel__closure: {
      "^": "Closure:0;nextLevelMap,wall",
      call$1: function(pos) {
        this.nextLevelMap.$indexSet(0, pos, this.wall);
      }
    },
    TankGameController__loadLevel_closure1: {
      "^": "Closure:0;nextLevelMap,base",
      call$1: function(posi) {
        this.nextLevelMap.$indexSet(0, posi, this.base);
      }
    },
    TankGameController__loadLevel_closure2: {
      "^": "Closure:0;nextLevel",
      call$1: function(posi) {
        var t1 = this.nextLevel;
        return J.$eq$(posi.get$row(), t1.startpositionPlayer._row) && J.$eq$(posi._col, t1.startpositionPlayer._col);
      }
    },
    TankGameController__loadLevel_closure3: {
      "^": "Closure:0;$this,nextLevelMap",
      call$1: function(pos) {
        this.nextLevelMap.$indexSet(0, pos, this.$this._player);
      }
    },
    GameKey: {
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (users == null) {
                  ...
                  ;
                user = J.firstWhere$2$orElse$ax(users, new X.GameKey_getUserId_closure($name), null);
    ...
    TankGame: {
      "^": "Object;_gamestate,_gameObjectsMap,gamePositions,_size,_anzahlAktiverGegner,_bereitsErstellteGegner,countForHighscore,zerstoerteEnemys,_aktuelleLevelNummer,aktuellesLevelObjekt,_player,_base",
      get$highscore: function() {
        var t1 = {};
        t1.ret = 0;
        this.countForHighscore.forEach$1(0, new X.TankGame_highscore_closure(t1));
        return t1.ret;
      },
      get$gameover: function() {
        return (J.$lt$n(this._player._leben, 1) || J.$lt$n(this._base._leben, 1)) && true;
      },
      get$field: function() {
        var _field = P.Iterable_Iterable$generate(this._size, new X.TankGame_field_closure(this), null).toList$0(0);
        this._gameObjectsMap.forEach$1(0, new X.TankGame_field_closure0(this, _field));
        return _field;
      },
      makeTank$1: function(obj) {
        var retList, t1;
        retList = [];
        switch (obj.get$ausrichtung()) {
          case C.Alignment_0:
            t1 = this.gamePositions;
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure(obj)));
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure0(obj)));
            break;
          case C.Alignment_1:
            t1 = this.gamePositions;
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure1(obj)));
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure2(obj)));
            break;
          case C.Alignment_2:
            t1 = this.gamePositions;
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure3(obj)));
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure4(obj)));
            break;
          case C.Alignment_3:
            t1 = this.gamePositions;
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure5(obj)));
            retList.push(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_makeTank_closure6(obj)));
            break;
        }
        return retList;
      },
      generatePositionsObjects$0: function() {
        var t1, row, col;
        for (t1 = this.gamePositions, row = 0; row < 42; ++row)
          for (col = 0; col < 42; ++col)
            t1.push(new X.Position(row, col));
      },
      resetGame$0: function() {
        this._aktuelleLevelNummer = 1;
        this.aktuellesLevelObjekt = C.JSArray_methods.singleWhere$1($.$get$levels(), new X.TankGame_resetGame_closure(this));
        this.countForHighscore.clear$0(0);
        this.zerstoerteEnemys.clear$0(0);
        this._anzahlAktiverGegner = 0;
        this._bereitsErstellteGegner = 0;
        this._gamestate = C.Symbol_stopped;
      },
      generatePositions$2: function(row, col) {
        var temp, t1, limit_row, t2, limit_col, i, t3, j, t4;
        temp = [];
        t1 = J.getInterceptor$ns(row);
        limit_row = t1.$add(row, 1);
        t2 = J.getInterceptor$ns(col);
        limit_col = t2.$add(col, 1);
        for (i = t2.$sub(col, 1), t2 = this.gamePositions; t3 = J.getInterceptor$n(i), t3.$le(i, limit_col); i = t3.$add(i, 1))
          for (j = t1.$sub(row, 1); t4 = J.getInterceptor$n(j), t4.$le(j, limit_row); j = t4.$add(j, 1))
            temp.push(C.JSArray_methods.singleWhere$1(t2, new X.TankGame_generatePositions_closure(i, j)));
        return temp;
      },
      moveBullets$0: function() {
        var bullets, t1;
        bullets = [];
        t1 = this._gameObjectsMap;
        t1 = t1.get$values(t1);
        C.JSArray_methods.addAll$1(bullets, H.setRuntimeTypeInfo(new H.WhereIterable(t1, new X.TankGame_moveBullets_closure()), [H.getRuntimeTypeArgument(t1, "Iterable", 0)]));
        P.LinkedHashSet_LinkedHashSet$from(bullets, H.getTypeArgumentByIndex(bullets, 0)).forEach$1(0, new X.TankGame_moveBullets_closure0(this));
        this.deleteDeadObjects$0();
      },
      moveLenkrakete$0: function() {
        var t1, lenkrakete, t2;
        t1 = {};
        lenkrakete = [];
        t2 = this._gameObjectsMap;
        t2 = t2.get$values(t2);
        C.JSArray_methods.addAll$1(lenkrakete, H.setRuntimeTypeInfo(new H.WhereIterable(t2, new X.TankGame_moveLenkrakete_closure()), [H.getRuntimeTypeArgument(t2, "Iterable", 0)]));
        t1.gegnerPosiErreicht = false;
        C.JSArray_methods.forEach$1(lenkrakete, new X.TankGame_moveLenkrakete_closure0(t1, this));
        this.deleteDeadObjects$0();
      },
      deleteDeadObjects$0: function() {
        var objects, t1;
        objects = [];
        t1 = this._gameObjectsMap;
        C.JSArray_methods.addAll$1(objects, t1.get$values(t1));
        C.JSArray_methods.forEach$1(objects, new X.TankGame_deleteDeadObjects_closure(this));
      },
      getNextBulletPosition$1: function(bullet) {
        var collisionPosition = bullet.get$mittelpunkt();
        switch (bullet._ausrichtung) {
          case C.Alignment_0:
            if (J.$lt$n(J.$sub$n(bullet._mittelpunkt.get$row(), 1), 0))
              break;
            collisionPosition = C.JSArray_methods.singleWhere$1(this.gamePositions, new X.TankGame_getNextBulletPosition_closure(bullet));
            break;
          case C.Alignment_1:
            if (J.$gt$n(J.$add$ns(bullet._mittelpunkt.get$col(), 1), 41))
              break;
            collisionPosition = C.JSArray_methods.singleWhere$1(this.gamePositions, new X.TankGame_getNextBulletPosition_closure0(bullet));
            break;
          case C.Alignment_2:
            if (J.$gt$n(J.$add$ns(bullet._mittelpunkt.get$row(), 1), 41))
              break;
            collisionPosition = C.JSArray_methods.singleWhere$1(this.gamePositions, new X.TankGame_getNextBulletPosition_closure1(bullet));
            break;
          case C.Alignment_3:
            if (J.$lt$n(J.$sub$n(bullet._mittelpunkt.get$col(), 1), 0))
              break;
            collisionPosition = C.JSArray_methods.singleWhere$1(this.gamePositions, new X.TankGame_getNextBulletPosition_closure2(bullet));
            break;
        }
        return collisionPosition;
      },
      moveEnemys$0: function() {
        var enemys, t1;
        enemys = [];
        t1 = this._gameObjectsMap;
        t1 = t1.get$values(t1);
        C.JSArray_methods.addAll$1(enemys, H.setRuntimeTypeInfo(new H.WhereIterable(t1, new X.TankGame_moveEnemys_closure()), [H.getRuntimeTypeArgument(t1, "Iterable", 0)]));
        P.LinkedHashSet_LinkedHashSet$from(enemys, H.getTypeArgumentByIndex(enemys, 0)).forEach$1(0, new X.TankGame_moveEnemys_closure0(this));
      },
      addEnemyTank$2: function(shootspeed, movespeed) {
        var t1, t2, t3, erfolg, random_row, random_col, koordinaten, i;
        t1 = this._anzahlAktiverGegner;
        t2 = this.aktuellesLevelObjekt;
        t3 = t2.concurrentlyEnemysOnField;
        if (typeof t3 !== "number")
          return H.iae(t3);
        if (t1 < t3) {
          t1 = this._bereitsErstellteGegner;
          t2 = t2.anzahlgegner;
          if (typeof t2 !== "number")
            return H.iae(t2);
          t2 = t1 < t2;
          ...
          t1 = false;
        if (t1)
          for (t1 = this.gamePositions, erfolg = false; !erfolg;) {
            random_row = C.C__JSRandom.nextInt$1(20) + 2;
            random_col = C.C__JSRandom.nextInt$1(37) + 2;
            koordinaten = this.generatePositions$2(random_row, random_col);
            for (i = 0; i < koordinaten.length; ++i, erfolg = true)
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_addEnemyTank_closure(koordinaten, i))))
                ;
              else {
                erfolg = false;
                break;
            ...
            if (erfolg) {
              X.GameObject$Enemy(C.JSArray_methods.singleWhere$1(t1, new X.TankGame_addEnemyTank_closure0(random_row, random_col)), this.aktuellesLevelObjekt.enemyLeben, shootspeed, movespeed, this);
              ++this._anzahlAktiverGegner;
              ++this._bereitsErstellteGegner;
            }
          }
      },
      findeAbzweigung$1: function(obj) {
        var choice, t1, returnvalue;
        choice = C.C__JSRandom.nextInt$1(3);
        switch (obj._ausrichtung) {
          case C.Alignment_0:
            if (J.$lt$n(J.$sub$n(obj._mittelpunkt.get$col(), 4), 1))
              choice = 1;
            else if (J.$gt$n(J.$add$ns(obj._mittelpunkt.get$col(), 4), 41))
              choice = 2;
            if (choice === 1) {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure0(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure1(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure2(obj))) && true;
            } else {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure3(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure4(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure5(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure6(obj))) && true;
            }
            break;
          case C.Alignment_1:
            if (J.$lt$n(J.$sub$n(obj._mittelpunkt.get$row(), 4), 1))
              choice = 2;
            else if (J.$gt$n(J.$add$ns(obj._mittelpunkt.get$row(), 4), 41))
              choice = 1;
            if (choice === 1) {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure7(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure8(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure9(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure10(obj))) && true;
            } else {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure11(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure12(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure13(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure14(obj))) && true;
            }
            break;
          case C.Alignment_2:
            if (J.$lt$n(J.$sub$n(obj._mittelpunkt.get$col(), 4), 1))
            ...
            if (choice === 1) {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure15(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure16(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure17(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure18(obj))) && true;
            } else {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure19(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure20(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure21(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure22(obj))) && true;
            }
            break;
          case C.Alignment_3:
            if (J.$lt$n(J.$sub$n(obj._mittelpunkt.get$row(), 4), 1))
            ...
            if (choice === 1) {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure23(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure24(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure25(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure26(obj))) && true;
            } else {
              t1 = this.gamePositions;
              if (!this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure27(obj))))
                return false;
              returnvalue = !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure28(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure29(obj))) && !this._gameObjectsMap.containsKey$1(0, C.JSArray_methods.singleWhere$1(t1, new X.TankGame_findeAbzweigung_closure30(obj))) && true;
            }
            break;
          default:
            returnvalue = false;
    ...
    TankGame_highscore_closure: {
      "^": "Closure:0;_box_0",
      call$1: function(obj) {
        var t1, t2, t3, ret;
        t1 = this._box_0;
        t2 = t1.ret;
        t3 = J.get$level$x(obj);
        if (typeof t3 !== "number")
          return H.iae(t3);
        ret = t2 + 100 * t3;
        t1.ret = ret;
    ...
    TankGame_field_closure: {
      "^": "Closure:0;$this",
      call$1: function(row) {
        return P.Iterable_Iterable$generate(this.$this._size, new X.TankGame_field__closure(), null).toList$0(0);
      }
    },
    TankGame_field__closure: {
      "^": "Closure:0;",
      call$1: function(col) {
        return C.Symbol_empty;
      }
    },
    TankGame_field_closure0: {
      "^": "Closure:3;$this,_field",
      call$2: function(pos, obj) {
        var t1, t2, t3, style, a, b, t4, t5;
        t1 = J.getInterceptor$x(obj);
        if (t1.get$type(obj) === C.GameObjectType_2) {
          t2 = this._field;
          t3 = pos.get$row();
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(t2[t3], pos._col, C.Symbol_wall);
        }
        if (t1.get$type(obj) === C.GameObjectType_0) {
          style = this.$this.makeTank$1(obj);
          a = C.JSArray_methods.get$first(style);
          b = C.JSArray_methods.get$last(style);
          if (!(J.$eq$(pos.get$row(), a.get$row()) && J.$eq$(pos._col, a._col)))
            t2 = J.$eq$(pos._row, b.get$row()) && J.$eq$(pos._col, b._col);
          else
            t2 = true;
          t3 = pos._row;
          t4 = this._field;
          ...
          if (t2) {
            if (t3 >>> 0 !== t3 || t3 >= t4.length)
              return H.ioore(t4, t3);
            J.$indexSet$ax(t4[t3], t5, C.Symbol_empty);
          } else {
            if (t3 >>> 0 !== t3 || t3 >= t4.length)
              return H.ioore(t4, t3);
            J.$indexSet$ax(t4[t3], t5, C.Symbol_playerTank);
          }
        }
        if (t1.get$type(obj) === C.GameObjectType_1) {
          style = this.$this.makeTank$1(obj);
          a = C.JSArray_methods.get$first(style);
          b = C.JSArray_methods.get$last(style);
          if (!(J.$eq$(pos.get$row(), a.get$row()) && J.$eq$(pos._col, a._col)))
          ...
          if (t2) {
            ...
            if (t3 >>> 0 !== t3 || t3 >= t4.length)
              return H.ioore(t4, t3);
            J.$indexSet$ax(t4[t3], t5, C.Symbol_enemyTank);
          }
        }
        if (t1.get$type(obj) === C.GameObjectType_4) {
          t2 = this._field;
          t3 = pos.get$row();
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(t2[t3], pos._col, C.Symbol_base);
        }
        if (t1.get$type(obj) === C.GameObjectType_3) {
          t2 = this._field;
          t3 = pos.get$row();
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(t2[t3], pos._col, C.Symbol_bullet);
        }
        if (t1.get$type(obj) === C.GameObjectType_5) {
          t1 = this._field;
          t2 = pos.get$row();
          if (t2 >>> 0 !== t2 || t2 >= t1.length)
            return H.ioore(t1, t2);
          J.$indexSet$ax(t1[t2], pos._col, C.Symbol_lenkrakete);
        }
      }
    },
    TankGame_makeTank_closure: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_makeTank_closure0: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_makeTank_closure1: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
    ...
    TankGame_makeTank_closure2: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_makeTank_closure3: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_makeTank_closure4: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
    ...
    TankGame_resetGame_closure: {
      "^": "Closure:0;$this",
      call$1: function(level) {
        return J.$eq$(level.get$levelnumber(), this.$this._aktuelleLevelNummer);
      }
    },
    TankGame_generatePositions_closure: {
      "^": "Closure:0;i,j",
      call$1: function(posi) {
        return J.$eq$(posi.get$row(), this.j) && J.$eq$(posi._col, this.i);
      }
    },
    TankGame_moveBullets_closure: {
      "^": "Closure:0;",
      call$1: function(obj) {
        return J.get$type$x(obj) === C.GameObjectType_3;
      }
    },
    TankGame_moveBullets_closure0: {
      "^": "Closure:0;$this",
      call$1: function(obj) {
        var t1 = this.$this;
        if (!obj.CollisionDetection$0()) {
          t1._gameObjectsMap.$indexSet(0, t1.getNextBulletPosition$1(obj), obj);
          t1._gameObjectsMap.remove$1(0, obj._mittelpunkt);
          obj._mittelpunkt = t1.getNextBulletPosition$1(obj);
        } else {
          obj.decrementHealth$0();
          P.print("BOOM!");
          t1._gameObjectsMap.$index(0, t1.getNextBulletPosition$1(obj)).decrementHealth$0();
        }
      }
    },
    TankGame_moveLenkrakete_closure: {
      "^": "Closure:0;",
      call$1: function(obj) {
        return J.get$type$x(obj) === C.GameObjectType_5;
      }
    },
    TankGame_moveLenkrakete_closure0: {
      "^": "Closure:0;_box_0,$this",
      call$1: function(obj) {
        var t1, t2;
        t1 = this._box_0;
        if (!t1.gegnerPosiErreicht)
          C.JSArray_methods.forEach$1(this.$this.generatePositions$2(C.JSArray_methods.get$first(obj.get$gegnerPositionen()).get$row(), C.JSArray_methods.get$first(obj.gegnerPositionen).get$col()), new X.TankGame_moveLenkrakete__closure(t1, obj));
        if (J.$lt$n(C.JSArray_methods.get$first(obj.get$gegnerPositionen()).get$row(), obj.get$mittelpunkt().get$row()))
          obj.set$ausrichtung(C.Alignment_0);
        t2 = obj.gegnerPositionen;
        if (J.$gt$n(C.JSArray_methods.get$first(t2).get$row(), obj.get$mittelpunkt().get$row()))
          obj.set$ausrichtung(C.Alignment_2);
        if (J.$lt$n(C.JSArray_methods.get$first(t2).get$col(), obj.get$mittelpunkt().get$col()))
          obj.set$ausrichtung(C.Alignment_3);
        if (J.$gt$n(C.JSArray_methods.get$first(t2).get$col(), obj.get$mittelpunkt().get$col()))
          obj.set$ausrichtung(C.Alignment_1);
        if (!obj.CollisionDetection$0() && !t1.gegnerPosiErreicht) {
          P.print("position noch nicht erreicht");
          t1 = this.$this;
          t1._gameObjectsMap.$indexSet(0, t1.getNextBulletPosition$1(obj), obj);
          t1._gameObjectsMap.remove$1(0, obj.get$mittelpunkt());
          obj.set$mittelpunkt(t1.getNextBulletPosition$1(obj));
        } else if (!obj.CollisionDetection$0() && t1.gegnerPosiErreicht) {
          P.print("gegner verfolgen");
          t1 = this.$this;
          t1._gameObjectsMap.$indexSet(0, C.JSArray_methods.get$first(t2), obj);
          t1._gameObjectsMap.remove$1(0, obj.get$mittelpunkt());
          obj.set$mittelpunkt(C.JSArray_methods.get$first(t2));
          C.JSArray_methods.checkGrowable$1(t2, "removeAt");
          if (0 >= t2.length)
            H.throwExpression(P.RangeError$value(0, null, null));
          t2.splice(0, 1)[0];
        } else {
          t1 = obj.CollisionDetection$0() && t1.gegnerPosiErreicht;
          t2 = this.$this;
          if (t1) {
            t2._gameObjectsMap.$index(0, obj._lenkraketeZiel._mittelpunkt).decrementHealth$0();
            obj.decrementHealth$0();
            P.print("gegner getroffen");
          } else {
            t2._gameObjectsMap.$index(0, t2.getNextBulletPosition$1(obj)).decrementHealth$0();
            obj.decrementHealth$0();
            P.print("else");
          }
        }
    ...
    TankGame_moveLenkrakete__closure: {
      "^": "Closure:0;_box_0,obj",
      call$1: function(posi) {
        if (J.$eq$(posi, this.obj._mittelpunkt))
          this._box_0.gegnerPosiErreicht = true;
      }
    },
    TankGame_deleteDeadObjects_closure: {
      "^": "Closure:0;$this",
      call$1: function(obj) {
        var t1, t2;
        if (J.$eq$(obj.get$leben(), 0) || J.$lt$n(obj._leben, 1)) {
          t1 = obj._type;
          if (t1 === C.GameObjectType_1) {
            t1 = this.$this;
            t2 = t1.zerstoerteEnemys;
            if (!t2.contains$1(0, obj))
              --t1._anzahlAktiverGegner;
            t1.countForHighscore.add$1(0, obj);
            t2.add$1(0, obj);
            C.JSArray_methods.forEach$1(obj._coords, new X.TankGame_deleteDeadObjects__closure(t1));
          } else {
            t1 = t1 === C.GameObjectType_3 || t1 === C.GameObjectType_5;
            t2 = this.$this;
            if (t1)
              t2._gameObjectsMap.remove$1(0, obj._mittelpunkt);
            else
              C.JSArray_methods.forEach$1(obj._coords, new X.TankGame_deleteDeadObjects__closure0(t2));
          }
        }
      }
    },
    TankGame_deleteDeadObjects__closure: {
      "^": "Closure:0;$this",
      call$1: function(f) {
        this.$this._gameObjectsMap.remove$1(0, f);
      }
    },
    TankGame_deleteDeadObjects__closure0: {
      "^": "Closure:0;$this",
      call$1: function(f) {
        this.$this._gameObjectsMap.remove$1(0, f);
      }
    },
    TankGame_getNextBulletPosition_closure: {
      "^": "Closure:0;bullet",
      call$1: function(posi) {
        var t1 = this.bullet;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
      }
    },
    TankGame_getNextBulletPosition_closure0: {
      "^": "Closure:0;bullet",
      call$1: function(posi) {
        var t1 = this.bullet;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_getNextBulletPosition_closure1: {
      "^": "Closure:0;bullet",
      call$1: function(posi) {
        var t1 = this.bullet;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
      }
    },
    TankGame_getNextBulletPosition_closure2: {
      "^": "Closure:0;bullet",
      call$1: function(posi) {
        var t1 = this.bullet;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_moveEnemys_closure: {
      "^": "Closure:0;",
      call$1: function(obj) {
        return J.get$type$x(obj) === C.GameObjectType_1;
      }
    },
    TankGame_moveEnemys_closure0: {
      "^": "Closure:0;$this",
      call$1: function(f) {
        var t1, basePosition, playerPosition, enemyPosition, t2, t3, t4;
        t1 = this.$this;
        basePosition = t1._base._mittelpunkt;
        playerPosition = t1._player._mittelpunkt;
        enemyPosition = f.get$mittelpunkt();
        if (f.CollisionDetection$0())
          if (J.$eq$(enemyPosition.get$row(), basePosition.get$row()))
            f.enemyEntscheidung = 6;
          else if (J.$eq$(f._mittelpunkt.get$row(), 1) && J.$eq$(f._mittelpunkt.get$col(), 1))
            if (C.C__JSRandom.nextInt$1(3) === 1)
              f.enemyEntscheidung = 1;
            else
              f.enemyEntscheidung = 3;
          else if (J.$eq$(f._mittelpunkt.get$row(), 1) && J.$eq$(f._mittelpunkt.get$col(), 40))
            if (C.C__JSRandom.nextInt$1(3) === 1)
              f.enemyEntscheidung = 1;
            else
              f.enemyEntscheidung = 4;
          else
            f.enemyEntscheidung = C.C__JSRandom.nextInt$1(5);
        switch (f.enemyEntscheidung) {
          case 1:
            f.moveDown$0();
            t2 = f._isTargetFrom;
            if (t2 != null)
              t2.gegnerPositionen.push(f._mittelpunkt);
            if (J.$eq$(enemyPosition.get$col(), playerPosition.get$col())) {
              t2 = playerPosition._row;
              t3 = enemyPosition._row;
              t4 = J.getInterceptor$n(t2);
              t2 = t4.$lt(t2, J.$add$ns(t3, 15)) && t4.$gt(t2, t3);
            } else
              t2 = false;
            if (t2)
              f.shoot$0();
            if (J.$eq$(enemyPosition._col, playerPosition._col)) {
              t2 = playerPosition._row;
              t3 = enemyPosition._row;
              t4 = J.getInterceptor$n(t2);
              t2 = t4.$gt(t2, J.$sub$n(t3, 9)) && t4.$lt(t2, t3);
            } else
              t2 = false;
            if (t2) {
              if (f._ausrichtung !== C.Alignment_0)
                f.moveUp$0();
              t2 = f._isTargetFrom;
              if (t2 != null)
                t2.gegnerPositionen.push(f._mittelpunkt);
              f.shoot$0();
              f.enemyEntscheidung = 2;
            }
            if (t1.findeAbzweigung$1(f))
              f.enemyEntscheidung = 4;
            break;
          case 2:
            f.moveUp$0();
            ...
            if (J.$eq$(enemyPosition.get$col(), playerPosition.get$col())) {
              ...
              t3 = enemyPosition._row;
              t4 = J.getInterceptor$n(t2);
              t2 = t4.$gt(t2, J.$sub$n(t3, 15)) && t4.$lt(t2, t3);
            } else
              t2 = false;
            if (t2)
              f.shoot$0();
            if (J.$eq$(enemyPosition._col, playerPosition._col)) {
              ...
              t3 = enemyPosition._row;
              t4 = J.getInterceptor$n(t2);
              t2 = t4.$lt(t2, J.$add$ns(t3, 9)) && t4.$gt(t2, t3);
            } else
              t2 = false;
            if (t2) {
              if (f._ausrichtung !== C.Alignment_2)
                f.moveDown$0();
              t2 = f._isTargetFrom;
              if (t2 != null)
                t2.gegnerPositionen.push(f._mittelpunkt);
          ...
          case 3:
            ...
            if (t2 != null)
              t2.gegnerPositionen.push(f._mittelpunkt);
            if (J.$eq$(enemyPosition.get$row(), playerPosition.get$row())) {
              t2 = playerPosition._col;
              t3 = enemyPosition._col;
              t4 = J.getInterceptor$n(t2);
              t2 = t4.$lt(t2, J.$add$ns(t3, 15)) && t4.$gt(t2, t3);
            } else
              t2 = false;
            if (t2)
              f.shoot$0();
            if (J.$eq$(enemyPosition._row, playerPosition._row)) {
              t2 = playerPosition._col;
              t3 = enemyPosition._col;
              t4 = J.getInterceptor$n(t2);
              t2 = t4.$gt(t2, J.$sub$n(t3, 9)) && t4.$lt(t2, t3);
              ...
              t2 = false;
            if (t2) {
              if (f._ausrichtung !== C.Alignment_3)
                f.moveLeft$0();
              t2 = f._isTargetFrom;
              if (t2 != null)
                t2.gegnerPositionen.push(f._mittelpunkt);
          ...
          case 4:
            ...
            if (J.$eq$(enemyPosition._row, playerPosition._row)) {
              ...
              t2 = false;
            if (t2) {
              if (f._ausrichtung !== C.Alignment_1)
                f.moveRight$0();
              t2 = f._isTargetFrom;
              if (t2 != null)
                t2.gegnerPositionen.push(f._mittelpunkt);
            ...
            break;
          case 6:
            if (J.$lt$n(enemyPosition.get$col(), basePosition.get$col())) {
              f.moveRight$0();
              t1 = f._isTargetFrom;
              if (t1 != null)
                t1.gegnerPositionen.push(f._mittelpunkt);
              f.shoot$0();
            } else {
              f.moveLeft$0();
              t1 = f._isTargetFrom;
    ...
    TankGame_addEnemyTank_closure: {
      "^": "Closure:0;koordinaten,i",
      call$1: function(pos) {
        var t1, t2, t3;
        t1 = pos.get$row();
        t2 = this.koordinaten;
        ...
        if (t3 >= t2.length)
          return H.ioore(t2, t3);
        if (J.$eq$(t1, t2[t3].get$row())) {
          t1 = pos._col;
          if (t3 >= t2.length)
            return H.ioore(t2, t3);
          t3 = J.$eq$(t1, t2[t3].get$col());
          t1 = t3;
        } else
          t1 = false;
        return t1;
    ...
    TankGame_addEnemyTank_closure0: {
      "^": "Closure:0;random_row,random_col",
      call$1: function(pos) {
        return J.$eq$(pos.get$row(), this.random_row) && J.$eq$(pos._col, this.random_col);
      }
    },
    TankGame_findeAbzweigung_closure: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure0: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure1: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure2: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure3: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure4: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure5: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure6: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure7: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
      }
    },
    TankGame_findeAbzweigung_closure8: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_findeAbzweigung_closure9: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_findeAbzweigung_closure10: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
      }
    },
    TankGame_findeAbzweigung_closure11: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
      }
    },
    TankGame_findeAbzweigung_closure12: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_findeAbzweigung_closure13: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    TankGame_findeAbzweigung_closure14: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
      }
    },
    TankGame_findeAbzweigung_closure15: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure16: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
    ...
    TankGame_findeAbzweigung_closure17: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
    ...
    TankGame_findeAbzweigung_closure18: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 4));
    ...
    TankGame_findeAbzweigung_closure19: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
      }
    },
    TankGame_findeAbzweigung_closure20: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
    ...
    TankGame_findeAbzweigung_closure21: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
    ...
    TankGame_findeAbzweigung_closure22: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 4));
    ...
    TankGame_findeAbzweigung_closure23: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
      }
    },
    TankGame_findeAbzweigung_closure24: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
    ...
    TankGame_findeAbzweigung_closure25: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
    ...
    TankGame_findeAbzweigung_closure26: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    TankGame_findeAbzweigung_closure27: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
      }
    },
    TankGame_findeAbzweigung_closure28: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
    ...
    TankGame_findeAbzweigung_closure29: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
    ...
    TankGame_findeAbzweigung_closure30: {
      "^": "Closure:0;obj",
      call$1: function(posi) {
        var t1 = this.obj;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 4)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject: {
      "^": "Object;_mittelpunkt,_coords,_ausrichtung,_type,enemyEntscheidung,_lenkraketeZiel,_isTargetFrom,gegnerPositionen<,_schussbereit,_fahrbereit,_shootTimer,_moveTimer,_game,_leben,_level,_lenkraketenMunition",
      get$mittelpunkt: function() {
        return this._mittelpunkt;
      },
      ...
      get$ausrichtung: function() {
        return this._ausrichtung;
      },
      set$ausrichtung: function(value) {
      ...
      decrementHealth$0: function() {
        var t1 = J.$sub$n(this._leben, 1);
        this._leben = t1;
        if (J.$lt$n(t1, 1))
          return true;
        return false;
      ...
      moveRight$0: function() {
        this._ausrichtung = C.Alignment_1;
        if (!this._fahrbereit)
          return;
        if (this.CollisionDetection$0())
          P.print("Collission!");
        else {
          var t1 = this._game;
          this._mittelpunkt = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_moveRight_closure(this._mittelpunkt));
          C.JSArray_methods.forEach$1(this._coords, new X.GameObject_moveRight_closure0(this));
          t1 = t1.generatePositions$2(this._mittelpunkt.get$row(), this._mittelpunkt.get$col());
          this._coords = t1;
          C.JSArray_methods.forEach$1(t1, new X.GameObject_moveRight_closure1(this));
          this._fahrbereit = false;
        }
      },
      set$mittelpunkt: function(value) {
        this._mittelpunkt = value;
        return value;
      },
      moveLeft$0: function() {
        this._ausrichtung = C.Alignment_3;
        if (!this._fahrbereit)
          return;
        if (this.CollisionDetection$0())
          P.print("Collission!");
          ...
          var t1 = this._game;
          this._mittelpunkt = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_moveLeft_closure(this._mittelpunkt));
          C.JSArray_methods.forEach$1(this._coords, new X.GameObject_moveLeft_closure0(this));
          t1 = t1.generatePositions$2(this._mittelpunkt.get$row(), this._mittelpunkt.get$col());
          this._coords = t1;
          C.JSArray_methods.forEach$1(t1, new X.GameObject_moveLeft_closure1(this));
          this._fahrbereit = false;
        }
      },
      moveUp$0: function() {
        this._ausrichtung = C.Alignment_0;
        if (!this._fahrbereit)
          return;
        if (this.CollisionDetection$0())
          P.print("Collission!");
          ...
          var t1 = this._game;
          this._mittelpunkt = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_moveUp_closure(this._mittelpunkt));
          C.JSArray_methods.forEach$1(this._coords, new X.GameObject_moveUp_closure0(this));
          t1 = t1.generatePositions$2(this._mittelpunkt.get$row(), this._mittelpunkt.get$col());
          this._coords = t1;
          C.JSArray_methods.forEach$1(t1, new X.GameObject_moveUp_closure1(this));
          this._fahrbereit = false;
        }
      },
      moveDown$0: function() {
        this._ausrichtung = C.Alignment_2;
        if (!this._fahrbereit)
          return;
        if (this.CollisionDetection$0())
          P.print("Collission!");
          ...
          var t1 = this._game;
          this._mittelpunkt = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_moveDown_closure(this._mittelpunkt));
          C.JSArray_methods.forEach$1(this._coords, new X.GameObject_moveDown_closure0(this));
          t1 = t1.generatePositions$2(this._mittelpunkt.get$row(), this._mittelpunkt.get$col());
          this._coords = t1;
          C.JSArray_methods.forEach$1(t1, new X.GameObject_moveDown_closure1(this));
          this._fahrbereit = false;
        }
      },
      shoot$0: function() {
        var bullet, t1, t2, t3;
        if (this._schussbereit) {
          switch (this._ausrichtung) {
            case C.Alignment_0:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$row(), 2), 0)) {
                bullet = null;
                break;
              }
              t1 = this._game;
              t2 = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_shoot_closure(this));
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, t1, 1, null, null);
              bullet._type = C.GameObjectType_3;
              bullet._mittelpunkt = t2;
              bullet._ausrichtung = C.Alignment_0;
              break;
            case C.Alignment_1:
              if (J.$gt$n(J.$add$ns(this._mittelpunkt.get$col(), 2), 41)) {
                bullet = null;
                break;
              }
              t1 = this._game;
              t2 = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_shoot_closure0(this));
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, t1, 1, null, null);
              bullet._type = C.GameObjectType_3;
              bullet._mittelpunkt = t2;
              bullet._ausrichtung = C.Alignment_1;
              break;
            case C.Alignment_2:
              if (J.$gt$n(J.$add$ns(this._mittelpunkt.get$row(), 2), 41)) {
                bullet = null;
                break;
              }
              t1 = this._game;
              t2 = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_shoot_closure1(this));
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, t1, 1, null, null);
              bullet._type = C.GameObjectType_3;
              bullet._mittelpunkt = t2;
              bullet._ausrichtung = C.Alignment_2;
              break;
            case C.Alignment_3:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$col(), 2), 0)) {
                bullet = null;
                break;
              }
              t1 = this._game;
              t2 = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_shoot_closure2(this));
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, t1, 1, null, null);
              bullet._type = C.GameObjectType_3;
              bullet._mittelpunkt = t2;
              bullet._ausrichtung = C.Alignment_3;
              break;
            default:
              bullet = null;
          }
          if (bullet == null)
            return;
          t1 = this._game;
          t2 = t1._gameObjectsMap.containsKey$1(0, bullet._mittelpunkt);
          t3 = bullet._mittelpunkt;
          t1 = t1._gameObjectsMap;
          if (t2)
            t1.$index(0, t3).decrementHealth$0();
          else
            t1.$indexSet(0, t3, bullet);
          this._schussbereit = false;
        }
      },
      lenkrakete$0: function() {
        var t1, t2, waende, t3, alleziele, bullet, t4, t5;
        t1 = {};
        t2 = this._lenkraketenMunition;
        if (typeof t2 !== "number")
          return t2.$lt();
        if (t2 < 1)
          return;
        ...
        waende = [];
        t2 = this._game;
        t3 = t2._gameObjectsMap;
        t3 = t3.get$values(t3);
        C.JSArray_methods.addAll$1(waende, H.setRuntimeTypeInfo(new H.WhereIterable(t3, new X.GameObject_lenkrakete_closure()), [H.getRuntimeTypeArgument(t3, "Iterable", 0)]));
        alleziele = [];
        t3 = t2._gameObjectsMap;
        t3 = t3.get$values(t3);
        C.JSArray_methods.addAll$1(alleziele, H.setRuntimeTypeInfo(new H.WhereIterable(t3, new X.GameObject_lenkrakete_closure0()), [H.getRuntimeTypeArgument(t3, "Iterable", 0)]));
        P.LinkedHashSet_LinkedHashSet$from(alleziele, H.getTypeArgumentByIndex(alleziele, 0)).forEach$1(0, new X.GameObject_lenkrakete_closure1(t1, this, waende));
        if (this._schussbereit) {
          switch (this._ausrichtung) {
            case C.Alignment_0:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$row(), 2), 0)) {
              ...
              t3 = C.JSArray_methods.singleWhere$1(t2.gamePositions, new X.GameObject_lenkrakete_closure2(this));
              t4 = t1.ziel;
              t5 = [];
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, t5, true, true, null, null, t2, 1, null, null);
              bullet._type = C.GameObjectType_5;
              bullet._mittelpunkt = t3;
              bullet._lenkraketeZiel = t4;
              bullet._ausrichtung = C.Alignment_0;
              if (t4 != null) {
                t5.push(t4._mittelpunkt);
                t1.ziel._isTargetFrom = bullet;
              }
              break;
            case C.Alignment_1:
              if (J.$gt$n(J.$add$ns(this._mittelpunkt.get$col(), 2), 41)) {
              ...
              t3 = C.JSArray_methods.singleWhere$1(t2.gamePositions, new X.GameObject_lenkrakete_closure3(this));
              t4 = t1.ziel;
              t5 = [];
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, t5, true, true, null, null, t2, 1, null, null);
              bullet._type = C.GameObjectType_5;
            ...
            case C.Alignment_2:
              ...
              t3 = C.JSArray_methods.singleWhere$1(t2.gamePositions, new X.GameObject_lenkrakete_closure4(this));
              t4 = t1.ziel;
              t5 = [];
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, t5, true, true, null, null, t2, 1, null, null);
              bullet._type = C.GameObjectType_5;
            ...
            case C.Alignment_3:
              ...
              t3 = C.JSArray_methods.singleWhere$1(t2.gamePositions, new X.GameObject_lenkrakete_closure5(this));
              t4 = t1.ziel;
              t5 = [];
              bullet = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, t5, true, true, null, null, t2, 1, null, null);
              bullet._type = C.GameObjectType_5;
          ...
          if (bullet == null)
            return;
          if (t1.wandImWeg || t1.ziel == null)
            return;
          t1 = t2._gameObjectsMap.containsKey$1(0, bullet._mittelpunkt);
          t3 = bullet._mittelpunkt;
          t2 = t2._gameObjectsMap;
          if (t1)
            t2.$index(0, t3).decrementHealth$0();
          else
            t2.$indexSet(0, t3, bullet);
          this._schussbereit = false;
          t1 = this._lenkraketenMunition;
          if (typeof t1 !== "number")
            return t1.$sub();
          this._lenkraketenMunition = t1 - 1;
        }
      },
      CollisionDetection$0: function() {
        var futurePositions, t1, futureBulletPosition, returnvalue, t2, i;
        futurePositions = [];
        t1 = this._type;
        if (t1 === C.GameObjectType_3 || t1 === C.GameObjectType_5) {
          switch (this._ausrichtung) {
            case C.Alignment_1:
              if (J.$ge$n(J.$add$ns(this._mittelpunkt.get$col(), 1), 42))
                return true;
              else {
                t1 = this._game;
                futureBulletPosition = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_CollisionDetection_closure(this));
                return t1._gameObjectsMap.containsKey$1(0, futureBulletPosition) && true;
              }
            case C.Alignment_3:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$col(), 1), 0))
                return true;
              else {
                t1 = this._game;
                futureBulletPosition = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_CollisionDetection_closure0(this));
                return t1._gameObjectsMap.containsKey$1(0, futureBulletPosition) && true;
              }
            case C.Alignment_0:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$row(), 1), 0))
                ;
              else {
                t1 = this._game;
                futureBulletPosition = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_CollisionDetection_closure1(this));
                return t1._gameObjectsMap.containsKey$1(0, futureBulletPosition) && true;
              }
              returnvalue = true;
              break;
            case C.Alignment_2:
              if (J.$ge$n(J.$add$ns(this._mittelpunkt.get$row(), 1), 42))
                return true;
              else {
                t1 = this._game;
                futureBulletPosition = C.JSArray_methods.singleWhere$1(t1.gamePositions, new X.GameObject_CollisionDetection_closure2(this));
                return t1._gameObjectsMap.containsKey$1(0, futureBulletPosition) && true;
              }
            default:
              returnvalue = false;
          ...
          switch (this._ausrichtung) {
            case C.Alignment_1:
              if (J.$ge$n(J.$add$ns(this._mittelpunkt.get$col(), 2), 42))
                return true;
              else {
                t1 = this._game;
                t2 = t1.gamePositions;
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure3(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure4(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure5(this)));
                for (returnvalue = false, i = 0; i < futurePositions.length; ++i)
                  if (t1._gameObjectsMap.containsKey$1(0, futurePositions[i]))
                    returnvalue = true;
                return returnvalue;
              }
            case C.Alignment_3:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$col(), 2), 0))
                ...
                t1 = this._game;
                t2 = t1.gamePositions;
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure6(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure7(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure8(this)));
                for (returnvalue = false, i = 0; i < futurePositions.length; ++i)
                  if (t1._gameObjectsMap.containsKey$1(0, futurePositions[i]))
                    returnvalue = true;
                return returnvalue;
            ...
            case C.Alignment_0:
              if (J.$lt$n(J.$sub$n(this._mittelpunkt.get$row(), 2), 0))
                ...
                t1 = this._game;
                t2 = t1.gamePositions;
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure9(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure10(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure11(this)));
                for (returnvalue = false, i = 0; i < futurePositions.length; ++i)
                  if (t1._gameObjectsMap.containsKey$1(0, futurePositions[i]))
                    returnvalue = true;
                return returnvalue;
            ...
            case C.Alignment_2:
              if (J.$ge$n(J.$add$ns(this._mittelpunkt.get$row(), 2), 42))
                return true;
              else {
                t1 = this._game;
                t2 = t1.gamePositions;
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure12(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure13(this)));
                futurePositions.push(C.JSArray_methods.singleWhere$1(t2, new X.GameObject_CollisionDetection_closure14(this)));
                for (returnvalue = false, i = 0; i < futurePositions.length; ++i)
                  if (t1._gameObjectsMap.containsKey$1(0, futurePositions[i]))
                    returnvalue = true;
                return returnvalue;
      ...
      GameObject$Enemy$5: function(mittel, _leben, shoottimer, enemySpeed, _game) {
        var t1;
        this._type = C.GameObjectType_1;
        this._mittelpunkt = mittel;
        this._level = this._leben;
        t1 = this._game.generatePositions$2(mittel.get$row(), this._mittelpunkt.get$col());
        this._coords = t1;
        C.JSArray_methods.forEach$1(t1, new X.GameObject$Enemy_closure(this));
        t1 = P.Timer_Timer$periodic(shoottimer, new X.GameObject$Enemy_closure0(this));
        this._shootTimer = t1;
        this._shootTimer = t1;
        this._moveTimer = P.Timer_Timer$periodic(enemySpeed, new X.GameObject$Enemy_closure1(this));
      },
      GameObject$Player$4: function(leben, shoottimer, playerSpeed, _game) {
        this._lenkraketenMunition = 3;
        this._leben = leben;
        this._type = C.GameObjectType_0;
        this._shootTimer = P.Timer_Timer$periodic(shoottimer, new X.GameObject$Player_closure(this));
        this._moveTimer = P.Timer_Timer$periodic(playerSpeed, new X.GameObject$Player_closure0(this));
      },
      static: {
        GameObject$Enemy: function(mittel, _leben, shoottimer, enemySpeed, _game) {
          var t1 = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, _game, _leben, null, null);
          t1.GameObject$Enemy$5(mittel, _leben, shoottimer, enemySpeed, _game);
          return t1;
        },
        GameObject$Player: function(leben, shoottimer, playerSpeed, _game) {
          var t1 = new X.GameObject(null, [], C.Alignment_0, null, 1, null, null, [], true, true, null, null, _game, null, null, null);
          t1.GameObject$Player$4(leben, shoottimer, playerSpeed, _game);
          return t1;
        }
      }
    },
    GameObject$Enemy_closure: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        var t1 = this.$this;
        t1._game._gameObjectsMap.$indexSet(0, pos, t1);
        return t1;
      }
    },
    GameObject$Enemy_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._schussbereit = true;
        return true;
      }
    },
    GameObject$Enemy_closure1: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._fahrbereit = true;
        return true;
      }
    },
    GameObject$Player_closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        this.$this._schussbereit = true;
        return true;
    ...
    GameObject_moveRight_closure: {
      "^": "Closure:0;mittel",
      call$1: function(posi) {
        var t1 = this.mittel;
        return J.$eq$(posi.get$row(), t1.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._col, 1));
      }
    },
    GameObject_moveRight_closure0: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        this.$this._game._gameObjectsMap.remove$1(0, pos);
      }
    },
    GameObject_moveRight_closure1: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        var t1 = this.$this;
        t1._game._gameObjectsMap.$indexSet(0, pos, t1);
    ...
    GameObject_moveLeft_closure: {
      "^": "Closure:0;mittel",
      call$1: function(posi) {
        var t1 = this.mittel;
        return J.$eq$(posi.get$row(), t1.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._col, 1));
      }
    },
    GameObject_moveLeft_closure0: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        this.$this._game._gameObjectsMap.remove$1(0, pos);
      }
    },
    GameObject_moveLeft_closure1: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        var t1 = this.$this;
        t1._game._gameObjectsMap.$indexSet(0, pos, t1);
    ...
    GameObject_moveUp_closure: {
      "^": "Closure:0;mittel",
      call$1: function(posi) {
        var t1 = this.mittel;
        return J.$eq$(posi.get$row(), J.$sub$n(t1.get$row(), 1)) && J.$eq$(posi._col, t1._col);
      }
    },
    GameObject_moveUp_closure0: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        this.$this._game._gameObjectsMap.remove$1(0, pos);
      }
    },
    GameObject_moveUp_closure1: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        var t1 = this.$this;
        t1._game._gameObjectsMap.$indexSet(0, pos, t1);
    ...
    GameObject_moveDown_closure: {
      "^": "Closure:0;mittel",
      call$1: function(posi) {
        var t1 = this.mittel;
        return J.$eq$(posi.get$row(), J.$add$ns(t1.get$row(), 1)) && J.$eq$(posi._col, t1._col);
      }
    },
    GameObject_moveDown_closure0: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        this.$this._game._gameObjectsMap.remove$1(0, pos);
      }
    },
    GameObject_moveDown_closure1: {
      "^": "Closure:0;$this",
      call$1: function(pos) {
        var t1 = this.$this;
        t1._game._gameObjectsMap.$indexSet(0, pos, t1);
    ...
    GameObject_shoot_closure: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
      }
    },
    GameObject_shoot_closure0: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
      }
    },
    GameObject_shoot_closure1: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
      }
    },
    GameObject_shoot_closure2: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
      }
    },
    GameObject_lenkrakete_closure: {
      "^": "Closure:0;",
      call$1: function(obj) {
        return J.get$type$x(obj) === C.GameObjectType_2;
      }
    },
    GameObject_lenkrakete_closure0: {
      "^": "Closure:0;",
      call$1: function(obj) {
        return J.get$type$x(obj) === C.GameObjectType_1;
      }
    },
    GameObject_lenkrakete_closure1: {
      "^": "Closure:0;_box_0,$this,waende",
      call$1: function(enemys) {
        var t1, t2;
        t1 = this.$this;
        switch (t1._ausrichtung) {
          case C.Alignment_0:
            if (J.$lt$n(enemys.get$mittelpunkt().get$row(), t1._mittelpunkt.get$row()))
              t2 = J.$eq$(enemys._mittelpunkt.get$col(), t1._mittelpunkt.get$col()) || J.$eq$(J.$sub$n(enemys._mittelpunkt.get$col(), 1), t1._mittelpunkt.get$col()) || J.$eq$(J.$add$ns(enemys._mittelpunkt.get$col(), 1), t1._mittelpunkt.get$col());
            else
              t2 = false;
            if (t2) {
              t2 = this.waende;
              P.LinkedHashSet_LinkedHashSet$from(t2, H.getTypeArgumentByIndex(t2, 0)).forEach$1(0, new X.GameObject_lenkrakete__closure(this._box_0, t1, enemys));
            }
            break;
          case C.Alignment_3:
            if (J.$lt$n(enemys.get$mittelpunkt().get$col(), t1._mittelpunkt.get$col()))
              t2 = J.$eq$(enemys.get$mittelpunkt().get$row(), t1._mittelpunkt.get$row()) || J.$eq$(J.$sub$n(enemys.get$mittelpunkt().get$row(), 1), t1._mittelpunkt.get$row()) || J.$eq$(J.$add$ns(enemys.get$mittelpunkt().get$row(), 1), t1._mittelpunkt.get$row());
            else
              t2 = false;
            if (t2) {
              t2 = this.waende;
              P.LinkedHashSet_LinkedHashSet$from(t2, H.getTypeArgumentByIndex(t2, 0)).forEach$1(0, new X.GameObject_lenkrakete__closure0(this._box_0, t1, enemys));
            }
            break;
          case C.Alignment_2:
            if (J.$gt$n(enemys.get$mittelpunkt().get$row(), t1._mittelpunkt.get$row()))
              t2 = J.$eq$(enemys.get$mittelpunkt().get$col(), t1._mittelpunkt.get$col()) || J.$eq$(J.$add$ns(enemys.get$mittelpunkt().get$col(), 1), t1._mittelpunkt.get$col()) || J.$eq$(J.$sub$n(enemys.get$mittelpunkt().get$col(), 1), t1._mittelpunkt.get$col());
            else
              t2 = false;
            if (t2) {
              t2 = this.waende;
              P.LinkedHashSet_LinkedHashSet$from(t2, H.getTypeArgumentByIndex(t2, 0)).forEach$1(0, new X.GameObject_lenkrakete__closure1(this._box_0, t1, enemys));
            }
            break;
          case C.Alignment_1:
            if (J.$gt$n(enemys.get$mittelpunkt().get$col(), t1._mittelpunkt.get$col()))
              t2 = J.$eq$(enemys.get$mittelpunkt().get$row(), t1._mittelpunkt.get$row()) || J.$eq$(J.$add$ns(enemys.get$mittelpunkt().get$row(), 1), t1._mittelpunkt.get$row()) || J.$eq$(J.$sub$n(enemys.get$mittelpunkt().get$row(), 1), t1._mittelpunkt.get$row());
            else
              t2 = false;
            if (t2) {
              t2 = this.waende;
              P.LinkedHashSet_LinkedHashSet$from(t2, H.getTypeArgumentByIndex(t2, 0)).forEach$1(0, new X.GameObject_lenkrakete__closure2(this._box_0, t1, enemys));
            }
            break;
        }
      }
    },
    GameObject_lenkrakete__closure: {
      "^": "Closure:0;_box_0,$this,enemys",
      call$1: function(wand) {
        var t1, t2, t3;
        t1 = this.enemys;
        if (J.$gt$n(wand.get$mittelpunkt().get$row(), t1._mittelpunkt.get$row()) && J.$lt$n(wand._mittelpunkt.get$row(), this.$this._mittelpunkt.get$row())) {
          t2 = this.$this;
          t2 = J.$eq$(wand._mittelpunkt.get$col(), t2._mittelpunkt.get$col()) || J.$eq$(J.$add$ns(wand._mittelpunkt.get$col(), 1), t2._mittelpunkt.get$col()) || J.$eq$(J.$sub$n(wand._mittelpunkt.get$col(), 1), t2._mittelpunkt.get$col());
        } else
          t2 = false;
        t3 = this._box_0;
        if (t2) {
    ...
    GameObject_lenkrakete__closure0: {
      "^": "Closure:0;_box_0,$this,enemys",
      call$1: function(wand) {
        var t1, t2, t3;
        t1 = this.enemys;
        if (J.$gt$n(wand.get$mittelpunkt().get$col(), t1.get$mittelpunkt().get$col()) && J.$lt$n(wand._mittelpunkt.get$col(), this.$this._mittelpunkt.get$col())) {
          t2 = this.$this;
          t2 = J.$eq$(wand._mittelpunkt.get$row(), t2._mittelpunkt.get$row()) || J.$eq$(J.$add$ns(wand._mittelpunkt.get$row(), 1), t2._mittelpunkt.get$row()) || J.$eq$(J.$sub$n(wand._mittelpunkt.get$row(), 1), t2._mittelpunkt.get$row());
        } else
          t2 = false;
        t3 = this._box_0;
        if (t2) {
    ...
    GameObject_lenkrakete__closure1: {
      "^": "Closure:0;_box_0,$this,enemys",
      call$1: function(wand) {
        var t1, t2, t3;
        t1 = this.enemys;
        if (J.$lt$n(wand.get$mittelpunkt().get$row(), t1.get$mittelpunkt().get$row()) && J.$gt$n(wand._mittelpunkt.get$row(), this.$this._mittelpunkt.get$row())) {
          t2 = this.$this;
          t2 = J.$eq$(wand._mittelpunkt.get$col(), t2._mittelpunkt.get$col()) || J.$eq$(J.$add$ns(wand._mittelpunkt.get$col(), 1), t2._mittelpunkt.get$col()) || J.$eq$(J.$sub$n(wand._mittelpunkt.get$col(), 1), t2._mittelpunkt.get$col());
        } else
          t2 = false;
    ...
    GameObject_lenkrakete__closure2: {
      "^": "Closure:0;_box_0,$this,enemys",
      call$1: function(wand) {
        var t1, t2, t3;
        t1 = this.enemys;
        if (J.$lt$n(wand.get$mittelpunkt().get$col(), t1.get$mittelpunkt().get$col()) && J.$gt$n(wand._mittelpunkt.get$col(), this.$this._mittelpunkt.get$col())) {
          t2 = this.$this;
          t2 = J.$eq$(wand._mittelpunkt.get$row(), t2._mittelpunkt.get$row()) || J.$eq$(J.$add$ns(wand._mittelpunkt.get$row(), 1), t2._mittelpunkt.get$row()) || J.$eq$(J.$sub$n(wand._mittelpunkt.get$row(), 1), t2._mittelpunkt.get$row());
        } else
          t2 = false;
    ...
    GameObject_lenkrakete_closure2: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject_lenkrakete_closure3: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
    ...
    GameObject_lenkrakete_closure4: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject_lenkrakete_closure5: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
    ...
    GameObject_CollisionDetection_closure: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
    ...
    GameObject_CollisionDetection_closure0: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
    ...
    GameObject_CollisionDetection_closure1: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject_CollisionDetection_closure2: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject_CollisionDetection_closure3: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
      }
    },
    GameObject_CollisionDetection_closure4: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
    ...
    GameObject_CollisionDetection_closure5: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 2));
      }
    },
    GameObject_CollisionDetection_closure6: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
      }
    },
    GameObject_CollisionDetection_closure7: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), t1._mittelpunkt.get$row()) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
    ...
    GameObject_CollisionDetection_closure8: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 1)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 2));
      }
    },
    GameObject_CollisionDetection_closure9: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    GameObject_CollisionDetection_closure10: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject_CollisionDetection_closure11: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$sub$n(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    GameObject_CollisionDetection_closure12: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$sub$n(t1._mittelpunkt.get$col(), 1));
      }
    },
    GameObject_CollisionDetection_closure13: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, t1._mittelpunkt.get$col());
    ...
    GameObject_CollisionDetection_closure14: {
      "^": "Closure:0;$this",
      call$1: function(posi) {
        var t1 = this.$this;
        return J.$eq$(posi.get$row(), J.$add$ns(t1._mittelpunkt.get$row(), 2)) && J.$eq$(posi._col, J.$add$ns(t1._mittelpunkt.get$col(), 1));
      }
    },
    Level: {
      "^": "Object;levelnumber@,anzahlgegner?,concurrentlyEnemysOnField?,enemyLeben?,wallpositions,startpositionPlayer?,basis?"
    },
    Position: {
      "^": "Object;_row,_col",
      get$row: function() {
      ...
      toString$0: function(_) {
        return "( " + H.S(this._row) + " / " + H.S(this._col) + " )\n";
      }
    },
    Alignment: {
      "^": "Object;index",
      toString$0: function(_) {
        return C.Map_iTAu4.$index(0, this.index);
      }
    },
    GameObjectType: {
      "^": "Object;index",
      toString$0: function(_) {
        return C.Map_wwoQ0.$index(0, this.index);
      }
    },
    TankView: {
      "^": "Object;_gameTable,_warningoverlay,_highscore,_overlay,_levelanzeige,_lenkMunition,_verbleibendeGegener,_nextLevelButton,_startbutton,_playerleben,_stats,htmlField",
      generateField$1: function(game) {
        var field, table, row, col, t1, t2;
        field = game.get$field();
        for (table = "", row = 0; row <= field.length - 1; ++row) {
          table += "<tr>";
          col = 0;
          while (true) {
            if (row >= field.length)
        ...
        this.htmlField = H.setRuntimeTypeInfo(new Array(field.length), [[P.List, W.HtmlElement]]);
      ...
      update$2: function(_, game, player) {
        var field, row, col, t1, td;
        field = game.get$field();
        for (row = 0; row < field.length; ++row) {
          col = 0;
          while (true) {
            ...
            if (td != null) {
              ...
              if (row >= field.length)
                return H.ioore(field, row);
              if (J.$eq$(J.$index$asx(field[row], col), C.Symbol_wall))
                t1.get$classes(td).add$1(0, "wall");
              else {
                if (row >= field.length)
                  return H.ioore(field, row);
                if (J.$eq$(J.$index$asx(field[row], col), C.Symbol_bullet))
                  t1.get$classes(td).add$1(0, "bullet");
                else {
                  if (row >= field.length)
                    return H.ioore(field, row);
                  if (J.$eq$(J.$index$asx(field[row], col), C.Symbol_playerTank))
                    t1.get$classes(td).add$1(0, "playerTank");
                  else {
                    if (row >= field.length)
                      return H.ioore(field, row);
                    if (J.$eq$(J.$index$asx(field[row], col), C.Symbol_enemyTank))
                      t1.get$classes(td).add$1(0, "enemyTank");
                    else {
                      if (row >= field.length)
                        return H.ioore(field, row);
                      if (J.$eq$(J.$index$asx(field[row], col), C.Symbol_base))
                        t1.get$classes(td).add$1(0, "base");
                      else {
                        if (row >= field.length)
                          return H.ioore(field, row);
                        if (J.$eq$(J.$index$asx(field[row], col), C.Symbol_lenkrakete))
                          t1.get$classes(td).add$1(0, "lenkrakete");
                      }
                    }
                  }
                }
      ...
      updateStats$2: function(game, player) {
        var leben, high, level, verbleibende, lenkMunition;
        leben = J.toString$0$(player._leben);
        high = C.JSNumber_methods.toString$0(game.get$highscore());
        level = C.JSInt_methods.toString$0(game._aktuelleLevelNummer);
        verbleibende = J.toString$0$(J.$sub$n(game.aktuellesLevelObjekt.anzahlgegner, game.zerstoerteEnemys._collection$_length));
        lenkMunition = J.toString$0$(game._player._lenkraketenMunition);
        J.set$innerHtml$x(this._playerleben, "Leben: " + H.S(leben));
        J.set$innerHtml$x(this._lenkMunition, "Lenkraketen Munition: " + lenkMunition);
        J.set$innerHtml$x(this._highscore, "Highscore: " + high);
        J.set$innerHtml$x(this._levelanzeige, "Level: " + level);
        J.set$innerHtml$x(this._verbleibendeGegener, "Verbleibende Gegner: " + verbleibende);
      },
      generateHighscore$2$score: function(scores, score) {
        var list, points, t1;
        list = J.map$1$ax(scores, new X.TankView_generateHighscore_closure()).join$1(0, "");
        points = "Du hast " + H.S(score) + " Punkte erreicht!";
        t1 = "<div id='scorelist'>" + (score === 0 ? "" : points);
        return t1 + (J.get$isEmpty$asx(list) ? "" : "<ul>" + list + "</ul>") + "</div>";
      },
      showHighscore$2: function(model, scores) {
        var t1, t2, score, t3, t4;
        t1 = this._overlay;
        t2 = J.getInterceptor$x(t1);
        if (t2.get$innerHtml(t1) !== "")
          return;
        score = model.get$highscore();
        t2.set$innerHtml(t1, "<div id='highscore'>   <h1>Highscore</h1></div><div id='highscorewarning'></div>");
        t3 = J.getInterceptor$asx(scores);
        if (t3.get$isEmpty(scores) !== true) {
          t4 = J.$index$asx(t3.get$last(scores), "score");
          if (typeof t4 !== "number")
            return H.iae(t4);
          if (!(score > t4)) {
            t3 = t3.get$length(scores);
            if (typeof t3 !== "number")
              return t3.$lt();
            t3 = t3 < 10;
          } else
          ...
          t3 = true;
        if (t3)
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", this.generateHighscore$2$score(scores, score) + "<form id='highscoreform'><input type='text' id='user' placeholder='user'><input type='password' id='pwd' placeholder='password'><button type='button' id='save'>Save</button><button type='button' id='close' class='discard'>Close</button></form>", null, null);
        else {
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", this.generateHighscore$2$score(scores, score), null, null);
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", "<button type='button' id='close' class='discard'>Close</button>", null, null);
        }
      },
      showOnlyHighscore$2: function(model, scores) {
        var t1, t2, score;
        t1 = this._overlay;
        t2 = J.getInterceptor$x(t1);
        if (t2.get$innerHtml(t1) !== "")
    ...
    TankView_generateHighscore_closure: {
      "^": "Closure:0;",
      call$1: function(entry) {
  ...
  C.Alignment_0 = new X.Alignment(0);
  C.Alignment_1 = new X.Alignment(1);
  C.Alignment_2 = new X.Alignment(2);
  C.Alignment_3 = new X.Alignment(3);
  ...
  C.GameObjectType_0 = new X.GameObjectType(0);
  C.GameObjectType_1 = new X.GameObjectType(1);
  C.GameObjectType_2 = new X.GameObjectType(2);
  C.GameObjectType_3 = new X.GameObjectType(3);
  C.GameObjectType_4 = new X.GameObjectType(4);
  C.GameObjectType_5 = new X.GameObjectType(5);
...
;
  ...
  C.Map_iTAu4 = new H.GeneralConstantMap([0, "Alignment.NORTH", 1, "Alignment.EAST", 2, "Alignment.SOUTH", 3, "Alignment.WEST"]);
  C.Map_wwoQ0 = new H.GeneralConstantMap([0, "GameObjectType.PLAYER", 1, "GameObjectType.ENEMY", 2, "GameObjectType.WALL", 3, "GameObjectType.BULLET", 4, "GameObjectType.BASE", 5, "GameObjectType.LENKRAKETE"]);
  C.Symbol_base = new H.Symbol("base");
  C.Symbol_bullet = new H.Symbol("bullet");
  C.Symbol_changeLevel = new H.Symbol("changeLevel");
  C.Symbol_empty = new H.Symbol("empty");
  C.Symbol_enemyTank = new H.Symbol("enemyTank");
  C.Symbol_gameover = new H.Symbol("gameover");
  C.Symbol_lenkrakete = new H.Symbol("lenkrakete");
  C.Symbol_paused = new H.Symbol("paused");
  C.Symbol_playerTank = new H.Symbol("playerTank");
  ...
  }, "CssClassSetImpl__validTokenRE", "levels", "$get$levels", function() {
    return [];
  }, "levels"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, ret: W.Node}, {func: 1, ret: P.Future, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.String, P.String]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, args: [W.TouchEvent]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(L.tankclient__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(L.tankclient__main$closure(), a);
...
//# sourceMappingURL=tankclient.dart.js.map
