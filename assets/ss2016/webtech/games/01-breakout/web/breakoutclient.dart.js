...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
  ...
  }], ["breakoutDart", "package:BreakoutHtml/breakoutLib.dart",, N, {
    "^": "",
    GameController: {
      "^": "Object;game,view,levelLoader,ballspeed,gameID,score,moveright,moveleft,gamekeyCheck,gamekeyHost,gamekeyPort,ballTrigger,panelrightTrigger,panelleftTrigger,gamekeyTrigger,listenerList,Score_List,gamekey",
      startGamekey$0: function() {
        var error, stacktrace, exception, t1;
        try {
          W.HttpRequest_getString("gamekey.json", null, null).then$1(new N.GameController_startGamekey_closure(this));
          this.gamekeyTrigger = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 5), new N.GameController_startGamekey_closure0(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          error = t1;
          stacktrace = H.getTraceFromException(exception);
          P.print("Error in startGamekey(): '" + H.S(error) + "'");
      ...
      startGame$0: function() {
        ...
        var $async$startGame$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = new N.LevelLoaderJSON(null, null, null, ".json", null, null);
                t1.filePath = "levels/";
                t1.fileName = "Level";
                t1.fileNumber = 1;
                $async$self.levelLoader = t1;
                $async$self.view.toggleoverlay$1(false);
                $async$goto = 2;
                return P._asyncHelper($async$self.initNewLevel$0(), $async$startGame$0, $async$completer);
              case 2:
        ...
        return P._asyncHelper(null, $async$startGame$0, $async$completer, null);
      },
      initNewLevel$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, hasNextLevel, t1, t2, t3, t4, t5, t6;
        var $async$initNewLevel$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper($async$self.levelLoader.loadNextLevel$0(), $async$initNewLevel$0, $async$completer);
              case 2:
                // returning from await.
                hasNextLevel = $async$result;
                $async$self.game = null;
                if (hasNextLevel === true) {
                  t1 = J.$index$asx($async$self.levelLoader.map.$index(0, "fieldSize"), 0);
                  t2 = J.$index$asx($async$self.levelLoader.map.$index(0, "fieldSize"), 1);
                  t3 = $async$self.levelLoader.map.$index(0, "lifes");
                  t4 = $async$self.score;
                  t5 = $async$self.levelLoader.map.$index(0, "level");
                  t6 = new N.BreakoutGame(null, null, null, null, null, null, null, null, null, [], [], [], [], [], []);
                  t6.control = $async$self;
                  t6.sizeX = t1;
                  t6.sizeY = t2;
                  t6.running = false;
                  t6.stopped = true;
                  ...
                  t6.level = t5;
                  t6.lifeCounter = t3;
                  t6.field = t6.initList$2(t2, t1);
                  t6.generateBorders$0();
                  $async$self.game = t6;
                  t1 = $async$self.view;
                  t1.gameModel = t6;
                  t1.generateField$1(t6);
                  $async$self.game.add_gameParts_JSON$2("ball", $async$self.levelLoader.map.$index(0, "ball"));
                  $async$self.game.add_gameParts_JSON$2("panelPart", $async$self.levelLoader.map.$index(0, "panelPart"));
                  $async$self.game.add_gameParts_JSON$2("stone", $async$self.levelLoader.map.$index(0, "stone"));
                  $async$self.ballspeed = $async$self.levelLoader.map.$index(0, "ballspeed");
                  $async$self.view.update$0();
                  $async$self.initStartListener$1(false);
                  $async$self.view.gamePaused$1(true);
                  t6 = $async$self.view;
                  J.set$innerHtml$x(t6.life, "Life: (" + H.S(t6.gameModel.lifeCounter) + ")");
                  t6 = $async$self.view;
                  J.set$innerHtml$x(t6.score, "Points: " + H.S(t6.gameModel.score));
                  t6 = $async$self.view;
                  J.set$innerHtml$x(t6.level, "Level: (" + H.S(t6.gameModel.level) + ")");
                } else
                  $async$self.gameOver$1(true);
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
        ...
        return P._asyncHelper(null, $async$initNewLevel$0, $async$completer, null);
      },
      initStartListener$1: function(panelMoveActiv) {
        var t1, t2;
        t1 = this.listenerList;
        t2 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
        t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initStartListener_closure(this, panelMoveActiv)), false), [H.getTypeArgumentByIndex(t2, 0)]);
        t2._tryResume$0();
        t1.push(t2);
        t2 = document.querySelector("#down");
        t2.toString;
        t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, "touchstart", false), [null]);
        t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initStartListener_closure0(this)), false), [H.getTypeArgumentByIndex(t2, 0)]);
        t2._tryResume$0();
        t1.push(t2);
      },
      initListener$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1, t2;
        var $async$initListener$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = $async$self.listenerList;
                t2 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
                t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initListener_closure($async$self)), false), [H.getTypeArgumentByIndex(t2, 0)]);
                t2._tryResume$0();
                t1.push(t2);
                t2 = document.querySelector("#right");
                t2.toString;
                t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, "touchstart", false), [null]);
                t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initListener_closure0($async$self)), false), [H.getTypeArgumentByIndex(t2, 0)]);
                t2._tryResume$0();
                t1.push(t2);
                t2 = document.querySelector("#right");
                t2.toString;
                t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, "touchend", false), [null]);
                t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initListener_closure1($async$self)), false), [H.getTypeArgumentByIndex(t2, 0)]);
                t2._tryResume$0();
                t1.push(t2);
                t2 = document.querySelector("#left");
                t2.toString;
                t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, "touchstart", false), [null]);
                t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initListener_closure2($async$self)), false), [H.getTypeArgumentByIndex(t2, 0)]);
                t2._tryResume$0();
                t1.push(t2);
                t2 = document.querySelector("#left");
                t2.toString;
                t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t2, "touchend", false), [null]);
                t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new N.GameController_initListener_closure3($async$self)), false), [H.getTypeArgumentByIndex(t2, 0)]);
                t2._tryResume$0();
                t1.push(t2);
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
        ...
        return P._asyncHelper(null, $async$initListener$0, $async$completer, null);
      },
      initTimer$0: function() {
        this.ballTrigger = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, this.ballspeed, 0, 0), this.get$moveBall());
        this.panelrightTrigger = P.Timer_Timer$periodic(C.Duration_25000, this.get$movePanelRightWithTimer());
        this.panelleftTrigger = P.Timer_Timer$periodic(C.Duration_25000, this.get$movePanelLeftWithTimer());
      },
      movePanelLeft$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$movePanelLeft$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper($async$self.game.movePanel$2(-1, 0), $async$movePanelLeft$0, $async$completer);
              case 2:
                // returning from await.
                $async$self.game.load_field_from_Gamepart_List$0();
                $async$self.view.update$0();
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
        ...
        return P._asyncHelper(null, $async$movePanelLeft$0, $async$completer, null);
      },
      movePanelRight$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$movePanelRight$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper($async$self.game.movePanel$2(1, 0), $async$movePanelRight$0, $async$completer);
              case 2:
                // returning from await.
                $async$self.game.load_field_from_Gamepart_List$0();
                $async$self.view.update$0();
        ...
        return P._asyncHelper(null, $async$movePanelRight$0, $async$completer, null);
      },
      movePanelLeftWithTimer$1: [function(t) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$movePanelLeftWithTimer$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = $async$self.moveleft === true ? 2 : 3;
                break;
              case 2:
                // then
                $async$goto = 4;
                return P._asyncHelper($async$self.game.movePanel$2(-1, 0), $async$movePanelLeftWithTimer$1, $async$completer);
              case 4:
                // returning from await.
                $async$self.game.load_field_from_Gamepart_List$0();
                $async$self.view.update$0();
        ...
        return P._asyncHelper(null, $async$movePanelLeftWithTimer$1, $async$completer, null);
      }, "call$1", "get$movePanelLeftWithTimer", 2, 0, 4],
      movePanelRightWithTimer$1: [function(t) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$movePanelRightWithTimer$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = $async$self.moveright === true ? 2 : 3;
                break;
              case 2:
                // then
                $async$goto = 4;
                return P._asyncHelper($async$self.game.movePanel$2(1, 0), $async$movePanelRightWithTimer$1, $async$completer);
              case 4:
                // returning from await.
                $async$self.game.load_field_from_Gamepart_List$0();
                $async$self.view.update$0();
        ...
        return P._asyncHelper(null, $async$movePanelRightWithTimer$1, $async$completer, null);
      }, "call$1", "get$movePanelRightWithTimer", 2, 0, 4],
      moveBall$1: [function(t) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$moveBall$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper($async$self.game.moveBall$0(), $async$moveBall$1, $async$completer);
              case 2:
                // returning from await.
                $async$self.game.load_field_from_Gamepart_List$0();
                $async$self.view.update$0();
        ...
        return P._asyncHelper(null, $async$moveBall$1, $async$completer, null);
      }, "call$1", "get$moveBall", 2, 0, 4],
      stopTimer$0: function() {
        this.ballTrigger.cancel$0();
        this.panelrightTrigger.cancel$0();
        this.panelleftTrigger.cancel$0();
      },
      cancelAllListeners$0: function() {
        var t1, t2, _i;
        for (t1 = this.listenerList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          t1[_i].cancel$0();
        C.JSArray_methods.set$length(t1, 0);
      },
      gameOver$1: function(win) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1;
        var $async$gameOver$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$self.stopTimer$0();
                $async$self.cancelAllListeners$0();
                $async$self.view.update$0();
                $async$self.view.toggleoverlay$1(true);
                $async$goto = 2;
                return P._asyncHelper($async$self.getHighscores$0(), $async$gameOver$1, $async$completer);
              case 2:
                // returning from await.
                t1 = $async$result;
                $async$self.Score_List = t1;
                $async$self.view.showHighscore$3(t1, win, true);
                $async$self.initSaveListener$1(win);
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
        ...
        return P._asyncHelper(null, $async$gameOver$1, $async$completer, null);
      },
      initSaveListener$1: function(win) {
        var t1 = document.querySelector("#save");
        t1 = t1 == null ? t1 : J.get$onClick$x(t1);
        if (t1 == null)
          ;
        else
          H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1.get$_target(), t1._eventType, W._wrapZone(new N.GameController_initSaveListener_closure(this, win)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      levelDone$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$levelDone$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$self.stopTimer$0();
                $async$self.cancelAllListeners$0();
                $async$self.score = $async$self.game.score;
                $async$goto = 2;
                return P._asyncHelper($async$self.initNewLevel$0(), $async$levelDone$0, $async$completer);
              case 2:
                // returning from await.
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
        ...
        return P._asyncHelper(null, $async$levelDone$0, $async$completer, null);
      },
      getHighscores$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, scoreslist, states, stacktrace, exception, $async$exception;
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 7:
                // returning from await.
                states = $async$result;
                scoreslist = J.toList$0$ax(J.map$1$ax(states, new N.GameController_getHighscores_closure()));
                J.sort$1$ax(scoreslist, new N.GameController_getHighscores_closure0());
                $async$handler = 2;
                // goto after finally
                $async$goto = 6;
                break;
              ...
              case 6:
                // after finally
                $async$returnValue = J.take$1$ax(scoreslist, 5);
                // goto return
                $async$goto = 1;
                break;
              case 1:
    ...
    GameController_startGamekey_closure: {
      "^": "Closure:0;$this",
      call$1: function(json) {
        ...
        t4 = new N.GameKeyClient(null, "1d69428cdd6c224d", J.$index$asx(settings, "gameid"), false);
        t4._uri = P.Uri__makeHttpUri("http", H.S(t2) + ":" + H.S(t3), "/", null);
        t1.gamekey = t4;
        t4.authenticate$0().then$1(new N.GameController_startGamekey__closure(t1));
      }
    },
    GameController_startGamekey__closure: {
      "^": "Closure:15;$this",
      call$1: function(isOnline) {
        var t1 = this.$this;
        if (isOnline === true) {
          t1 = t1.view;
          J.set$innerHtml$x(t1.status, "Status: Online");
          return true;
        } else {
          t1 = t1.view;
          J.set$innerHtml$x(t1.status, "Status: Offline");
          return false;
        }
      }
    },
    GameController_startGamekey_closure0: {
      "^": "Closure:6;$this",
      call$1: function(_) {
    ...
    GameController_initStartListener_closure: {
      "^": "Closure:7;$this,panelMoveActiv",
      call$1: function(ev) {
        var t1, t2;
        if (J.get$keyCode$x(ev) === 32 && !this.$this.game.running) {
          if (!this.panelMoveActiv)
            this.$this.initListener$0();
          t1 = this.$this;
          t1.initTimer$0();
          t2 = t1.game;
          t2.stopped = false;
          t2.running = true;
          t1.view.gamePaused$1(false);
        } else if (ev.keyCode === 32 && this.$this.game.running) {
          t1 = this.$this;
          t1.stopTimer$0();
          t1.cancelAllListeners$0();
          t1.initStartListener$1(false);
          t2 = t1.game;
          t2.stopped = true;
          t2.running = false;
          t1.view.gamePaused$1(true);
        }
      }
    },
    GameController_initStartListener_closure0: {
      "^": "Closure:0;$this",
    ...
    GameController_initListener_closure: {
      "^": "Closure:7;$this",
      call$1: function(ev) {
        if (J.get$keyCode$x(ev) === 37)
          this.$this.movePanelLeft$0();
        if (ev.keyCode === 39)
          this.$this.movePanelRight$0();
      }
    },
    GameController_initListener_closure0: {
      "^": "Closure:0;$this",
      call$1: function($event) {
        this.$this.moveright = true;
      }
    },
    GameController_initListener_closure1: {
      "^": "Closure:0;$this",
      call$1: function($event) {
        this.$this.moveright = false;
      }
    },
    GameController_initListener_closure2: {
      "^": "Closure:0;$this",
      call$1: function($event) {
        this.$this.moveleft = true;
      }
    },
    GameController_initListener_closure3: {
      "^": "Closure:0;$this",
      call$1: function($event) {
        this.$this.moveleft = false;
      }
    },
    GameController_initSaveListener_closure: {
      "^": "Closure:6;$this,win",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, user, pwd, t2, id;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                if ((user == null ? user : user.length === 0) === true) {
                  t1.view.toString;
                  J.set$innerHtml$x(document.querySelector("#warning"), "Please insert Username !");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                if ((pwd == null ? pwd : pwd.length === 0) === true) {
                  t1.view.toString;
                  J.set$innerHtml$x(document.querySelector("#warning"), "Please insert a Password !");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
              ...
              case 5:
                // returning from await.
                $async$goto = $async$result == null ? 3 : 4;
                break;
              case 3:
                // then
                $async$goto = 6;
                return P._asyncHelper(t1.gamekey.registerUser$2(user, pwd), $async$call$1, $async$completer);
              case 6:
                // returning from await.
                if ($async$result == null) {
                  t1 = t1.view;
                  t2 = "Could not register user " + H.S(user) + ". User might already exist or gamekey service not available.";
                  t1.toString;
                  J.set$innerHtml$x(document.querySelector("#warning"), t2);
                  // goto return
                  $async$goto = 1;
                  break;
                } else
              ...
              case 10:
                ...
                if (user == null) {
                  t1.view.toString;
                  J.set$innerHtml$x(document.querySelector("#warning"), "User exists !");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                $async$goto = 14;
                return P._asyncHelper(t1.gamekey.storeState$2(J.$index$asx(user, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.2", "points", t1.game.score])), $async$call$1, $async$completer);
              case 14:
                // returning from await.
                $async$goto = $async$result === true ? 11 : 13;
                break;
              case 11:
                // then
                $async$goto = 15;
              ...
              case 15:
                ...
                t2 = $async$result;
                t1.Score_List = t2;
                t1.view.showHighscore$3(t2, $async$self.win, false);
                // goto return
                $async$goto = 1;
                break;
                // goto join
              ...
              case 13:
                // else
                t1.view.toString;
                J.set$innerHtml$x(document.querySelector("#failedsave"), "Save failed! Please check your Status!");
                // goto return
                $async$goto = 1;
                break;
              case 12:
    ...
    GameController_getHighscores_closure: {
      "^": "Closure:0;",
    ...
    GameController_getHighscores_closure0: {
      "^": "Closure:3;",
      call$2: function(a, b) {
    ...
    LevelLoaderJSON: {
      "^": "Object;filePath,fileName,fileNumber,fileEnding,map,jsonString",
      loadNextLevel$0: function() {
        ...
        var $async$loadNextLevel$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t1 = {};
                t1.ret = false;
                $async$self.map = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [null, null]);
                $async$goto = 3;
                return P._asyncHelper(P.Future_wait([$async$self.loadJsonFileToMap$1("Settings"), $async$self.loadJsonFileToMap$1("Stones"), $async$self.loadJsonFileToMap$1("MoveableParts")], null, false).then$1(new N.LevelLoaderJSON_loadNextLevel_closure(t1, $async$self)), $async$loadNextLevel$0, $async$completer);
              case 3:
                // returning from await.
                t1 = t1.ret;
                if (t1)
                  ++$async$self.fileNumber;
                else
                  ;
        ...
        return P._asyncHelper(null, $async$loadNextLevel$0, $async$completer, null);
      },
      loadJsonFileToMap$1: function(fileType) {
        ...
        var $async$loadJsonFileToMap$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 4;
                $async$goto = 7;
                return P._asyncHelper(W.HttpRequest_getString(C.JSString_methods.$add($async$self.filePath + $async$self.fileName + $async$self.fileNumber, fileType) + $async$self.fileEnding, null, null).then$1(new N.LevelLoaderJSON_loadJsonFileToMap_closure(t1)), $async$loadJsonFileToMap$1, $async$completer);
              case 7:
                // returning from await.
                t1 = C.JsonCodec_null_null.decode$1(t1.ret);
                $async$returnValue = t1;
                // goto return
                $async$goto = 1;
                break;
        ...
        return P._asyncHelper(null, $async$loadJsonFileToMap$1, $async$completer, null);
      },
      map$1: function($receiver, arg0) {
        return this.map.call$1(arg0);
      }
    },
    LevelLoaderJSON_loadNextLevel_closure: {
      "^": "Closure:16;_box_0,$this",
      call$1: function(ml) {
        var t1, t2, t3, m;
        for (t1 = J.get$iterator$ax(ml), t2 = this._box_0, t3 = this.$this; t1.moveNext$0();) {
          m = t1.get$current();
          if (m != null) {
            t3.map.addAll$1(0, m);
            t2.ret = true;
    ...
    LevelLoaderJSON_loadJsonFileToMap_closure: {
      "^": "Closure:0;_box_0",
      call$1: function(json) {
        this._box_0.ret = json;
      }
    },
    GameKeyClient: {
      "^": "Object;_uri,_secret,_gid,GameKey_available",
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (J.get$status$x(answer) === 200)
                  $async$self.GameKey_available = true;
                else
                  ;
                if (J.get$status$x(answer) === 200)
                  t1 = true;
              ...
              case 4:
                ...
                P.print(H.S(stacktrace));
                $async$self.GameKey_available = false;
                $async$returnValue = false;
                // goto return
                $async$goto = 1;
                break;
        ...
        var $async$getStates$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                if (!$async$self.GameKey_available) {
      ...
      getUserId$1: function($name) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, user, users, u, error, stacktrace, t1, exception, $async$exception;
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (users == null) {
                  ...
                  ;
                for (t1 = J.get$iterator$ax(users); t1.moveNext$0();) {
                  u = t1.get$current();
                  if (J.$eq$(J.$index$asx(u, "name"), $name)) {
                    user = u;
                    break;
                  } else
                    ;
    ...
    Ball: {
      "^": "GamePart;game,dirX,dirY,cellList,type,powerup,powerupVal,changeX,changeY,destructionInfo,score"
    },
    BreakoutGame: {
      "^": "Object;control,sizeX,sizeY,running,stopped,gameOver,lifeCounter,score,level,field,gamePartList_desStein,gamePartList_indesStein,gamePartList_Ball,gamePartList_PanelPart,newBallsAddedDuringMove",
      add_gameParts_JSON$2: function(partType, objectList) {
        var t1, t2, t3, t4, t5, m, t6, dirX, dirY, type, powerup, powerupVal, changex, changey, destrInfo, score, cl, JSON_cell, t7, t8, t9, ball, stein, panel;
        for (t1 = J.get$iterator$ax(objectList), t2 = this.gamePartList_PanelPart, t3 = this.gamePartList_indesStein, t4 = this.gamePartList_desStein, t5 = this.gamePartList_Ball; t1.moveNext$0();) {
          m = t1.get$current();
          t6 = J.getInterceptor$asx(m);
          dirX = t6.$index(m, "dirX");
          dirY = t6.$index(m, "dirY");
          type = t6.$index(m, "type");
          powerup = t6.$index(m, "powerup");
          powerupVal = powerup != null ? t6.$index(m, "powerupVal") : 0;
          changex = t6.$index(m, "changeX");
          changey = t6.$index(m, "changeY");
          destrInfo = t6.$index(m, "destructionInfo");
          score = t6.$index(m, "score");
          cl = H.setRuntimeTypeInfo([], [N.Cell]);
          for (t6 = J.get$iterator$ax(t6.$index(m, "cell")); t6.moveNext$0();) {
            JSON_cell = t6.get$current();
            t7 = J.getInterceptor$asx(JSON_cell);
            t8 = t7.$index(JSON_cell, "posX");
            t7 = t7.$index(JSON_cell, "posY");
            t9 = new N.Cell(null, null, null);
            t9.posX = t8;
            t9.posY = t7;
            cl.push(t9);
          }
          switch (type) {
            case "ball":
              ball = new N.Ball(null, null, null, null, null, null, null, null, null, null, null);
              ball.GamePart$11(this, dirX, dirY, cl, type, powerup, powerupVal, changex, changey, destrInfo, score);
              ball.addCellOwner$0();
              t5.push(ball);
              break;
            case "desS":
              stein = new N.Stein(null, null, null, null, null, null, null, null, null, null, null);
              stein.GamePart$11(this, dirX, dirY, cl, type, powerup, powerupVal, changex, changey, destrInfo, score);
              stein.addCellOwner$0();
              t4.push(stein);
              break;
            case "idesS":
              stein = new N.Stein(null, null, null, null, null, null, null, null, null, null, null);
              ...
              break;
            case "panelPart":
              panel = new N.PanelPart(null, null, null, null, null, null, null, null, null, null, null);
              panel.GamePart$11(this, dirX, dirY, cl, type, powerup, powerupVal, changex, changey, destrInfo, score);
              panel.addCellOwner$0();
              t2.push(panel);
              break;
            default:
              H.printString("Error Type not definied");
          }
        }
        this.load_field_from_Gamepart_List$0();
      },
      load_field_from_Gamepart_List$0: function() {
        var t1, t2, _i, t3, t4, _i0, cl, t5, t6, clis, clds, clpnl;
        for (t1 = this.gamePartList_Ball, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = t1[_i].get$cellList(), t4 = t3.length, _i0 = 0; _i0 < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i0) {
            cl = t3[_i0];
            t5 = this.field;
            t6 = cl.get$posY();
            if (t6 >>> 0 !== t6 || t6 >= t5.length)
              return H.ioore(t5, t6);
            J.$indexSet$ax(t5[t6], cl.posX, cl);
          }
        for (t1 = this.gamePartList_indesStein, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = t1[_i].cellList, t4 = t3.length, _i0 = 0; _i0 < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i0) {
            clis = t3[_i0];
            t5 = this.field;
            t6 = clis.get$posY();
            if (t6 >>> 0 !== t6 || t6 >= t5.length)
              return H.ioore(t5, t6);
            J.$indexSet$ax(t5[t6], clis.posX, clis);
          }
        for (t1 = this.gamePartList_desStein, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = t1[_i].cellList, t4 = t3.length, _i0 = 0; _i0 < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i0) {
            clds = t3[_i0];
            t5 = this.field;
            t6 = clds.get$posY();
            if (t6 >>> 0 !== t6 || t6 >= t5.length)
              return H.ioore(t5, t6);
            J.$indexSet$ax(t5[t6], clds.posX, clds);
          }
        for (t1 = this.gamePartList_PanelPart, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = t1[_i].cellList, t4 = t3.length, _i0 = 0; _i0 < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i0) {
            clpnl = t3[_i0];
            t5 = this.field;
            t6 = clpnl.get$posY();
            if (t6 >>> 0 !== t6 || t6 >= t5.length)
              return H.ioore(t5, t6);
            J.$indexSet$ax(t5[t6], clpnl.posX, clpnl);
          }
      },
      movePanel$2: function(dirX, dirY) {
        var t1, i, t2, t3;
        if (dirX < 0) {
          t1 = this.gamePartList_PanelPart;
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          if (t1[0].panelCheck$2(dirX, dirY))
            for (i = 0; i < t1.length; ++i)
              t1[i].movePanel$2(dirX, dirY);
        } else if (dirX > 0) {
          t1 = this.gamePartList_PanelPart;
          t2 = t1.length;
          t3 = t2 - 1;
          if (t3 < 0)
            return H.ioore(t1, t3);
          if (t1[t3].panelCheck$2(dirX, dirY))
      ...
      moveBall$0: function() {
        var tmp, t1, t2, _i, bll;
        tmp = H.setRuntimeTypeInfo([], [N.Ball]);
        for (t1 = this.gamePartList_Ball, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          bll = t1[_i];
          if (bll.move$0())
            tmp.push(bll);
        }
        for (t2 = tmp.length, _i = 0; _i < tmp.length; tmp.length === t2 || (0, H.throwConcurrentModificationError)(tmp), ++_i)
          tmp[_i].destroyBlock$1(t1);
        t2 = this.newBallsAddedDuringMove;
        if (t2.length !== 0) {
          C.JSArray_methods.addAll$1(t1, t2);
          this.newBallsAddedDuringMove = [];
        }
        if (0 === t1.length) {
          t1 = this.lifeCounter;
          if (typeof t1 !== "number")
          ...
          if (1 < t1) {
            t1 = this.control;
            t1.game.add_gameParts_JSON$2("ball", t1.levelLoader.map.$index(0, "ball"));
            this.running = false;
            this.stopped = true;
            this.lifeCounter = J.$sub$n(this.lifeCounter, 1);
            t1 = this.control.view;
            J.set$innerHtml$x(t1.life, "Life: (" + H.S(t1.gameModel.lifeCounter) + ")");
            t1 = this.control;
            t1.stopTimer$0();
            t1.cancelAllListeners$0();
            t1.initListener$0();
            t1.initStartListener$1(true);
            t1.view.gamePaused$1(true);
          } else {
            this.lifeCounter = t1 - 1;
            t1 = this.control.view;
            J.set$innerHtml$x(t1.life, "Life: (" + H.S(t1.gameModel.lifeCounter) + ")");
            this.running = false;
            this.gameOver = true;
            this.control.gameOver$1(false);
          }
        }
      },
      initList$2: function(tableHeight, tableWidth) {
        var ret, i, oneDList;
        ret = [];
        if (typeof tableHeight !== "number")
          return H.iae(tableHeight);
        i = 0;
        for (; i < tableHeight; ++i) {
          if (typeof tableWidth !== "number")
            return H.iae(tableWidth);
          oneDList = new Array(tableWidth);
          oneDList.fixed$length = Array;
          ret.push(oneDList);
        }
        return ret;
      },
      generateBorders$0: function() {
        this.generateBorder$1("top");
        this.generateBorder$1("left");
        this.generateBorder$1("right");
        this.load_field_from_Gamepart_List$0();
      },
      generateBorder$1: function(orientation) {
        var cellList, jLimit, iVal, iLimit, jVal, i, j, t1, t2, stein;
        cellList = H.setRuntimeTypeInfo([], [N.Cell]);
        switch (orientation) {
          case "top":
            jLimit = this.sizeX;
            iVal = 0;
          ...
          case "right":
            iLimit = this.sizeY;
            jVal = J.$sub$n(this.sizeX, 2);
            jLimit = this.sizeX;
            iVal = 2;
            break;
          default:
            P.print("Error while generating Border! Default reached!");
            iVal = 0;
            iLimit = 0;
            jVal = 0;
            jLimit = 0;
        ...
        i = iVal;
        for (; i < iLimit; ++i)
          for (j = jVal; t1 = J.getInterceptor$n(j), t1.$lt(j, jLimit); j = t1.$add(j, 1)) {
            t2 = new N.Cell(null, null, null);
            t2.posX = j;
            t2.posY = i;
            cellList.push(t2);
          }
        stein = new N.Stein(null, null, null, null, null, null, null, null, null, null, null);
        stein.GamePart$11(this, 0, 0, cellList, "ideS", null, 0, -1, -1, -1, 0);
        stein.addCellOwner$0();
        this.gamePartList_indesStein.push(stein);
      },
      getManagementList$1: function(objectType) {
        switch (objectType) {
          case "desS":
            return this.gamePartList_desStein;
          case "ball":
            return this.gamePartList_Ball;
          case "idesS":
            return this.gamePartList_indesStein;
          case "panelPart":
            return this.gamePartList_PanelPart;
          default:
            return;
        }
      }
    ...
    Cell: {
      "^": "Object;posX<,posY<,owner@",
      setGamePart$1: function(gp) {
        this.owner = gp;
      },
      toString$0: function(_) {
        return "X : " + H.S(this.posX) + " Y : " + H.S(this.posY) + " ";
      }
    },
    GamePart: {
      "^": "Object;cellList<,type>,changeX<",
      addCellOwner$0: function() {
        var t1, t2, _i;
        for (t1 = this.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          t1[_i].setGamePart$1(this);
      },
      hit$1: function(gp) {
        var t1, t2, t3;
        t1 = this.powerup;
        if (t1 != null)
          switch (t1) {
            case "ballExploder":
              if (J.$eq$(gp.type, "ball"))
                gp.explode$1(this.powerupVal);
              break;
            default:
              break;
          }
        switch (this.type) {
          case "desS":
            this.destructionInfo = J.$sub$n(this.destructionInfo, 1);
            t1 = this.game;
            t2 = this.score;
            t3 = t1.score;
            if (typeof t2 !== "number")
            ...
            t1.score = t3 + t2;
            t1 = t1.control.view;
            J.set$innerHtml$x(t1.score, "Points: " + H.S(t1.gameModel.score));
            if (J.$lt$n(this.destructionInfo, 1)) {
              this.destroyBlock$1(this.game.gamePartList_desStein);
              t1 = this.game;
              if (t1.gamePartList_desStein.length <= 0)
                t1.control.levelDone$0();
            }
            break;
          default:
            break;
      ...
      chooseCell$0: function() {
        var t1, t2, t3, checkingCell;
        if (J.$gt$n(this.dirX, 0) && J.$gt$n(this.dirY, 0)) {
          t1 = this.cellList;
          t2 = t1.length;
          t3 = t2 - 1;
          if (t3 < 0)
          ...
          checkingCell = null;
        if (J.$ge$n(this.dirX, 0) && J.$le$n(this.dirY, 0)) {
          t1 = this.cellList;
          t2 = t1.length;
          t2 = C.JSNumber_methods.toInt$0(Math.floor(Math.sqrt(t2))) - 1;
          if (t2 < 0 || t2 >= t1.length)
            return H.ioore(t1, t2);
          checkingCell = t1[t2];
        }
        if (J.$le$n(this.dirX, 0) && J.$ge$n(this.dirY, 0)) {
          t1 = this.cellList;
          t2 = t1.length;
          t2 -= C.JSNumber_methods.toInt$0(Math.floor(Math.sqrt(t2)));
          if (t2 < 0 || t2 >= t1.length)
            return H.ioore(t1, t2);
          checkingCell = t1[t2];
        }
        if (J.$lt$n(this.dirX, 0) && J.$lt$n(this.dirY, 0)) {
          t1 = this.cellList;
          if (0 >= t1.length)
            return H.ioore(t1, 0);
          checkingCell = t1[0];
      ...
      calculateCells$1: function(checkingCell) {
        var retList, posXown, posYown, t1, ballLength, t2, iVal, limitY, iModifier, jVal, limitX, jModifier, i, j, t3;
        retList = H.setRuntimeTypeInfo([], [N.Cell]);
        posXown = checkingCell.get$posX();
        posYown = checkingCell.posY;
        t1 = this.cellList.length;
        ballLength = C.JSNumber_methods.round$0(Math.sqrt(t1));
        t1 = J.getInterceptor$ns(posYown);
        t2 = ballLength - 1;
        if (J.$lt$n(this.dirY, 0)) {
          iVal = t1.$add(posYown, t2);
          limitY = J.$sub$n(t1.$add(posYown, this.dirY), 1);
          iModifier = -1;
        } else {
          iVal = t1.$sub(posYown, t2);
          limitY = J.$add$ns(t1.$add(posYown, this.dirY), 1);
          if (J.$eq$(this.dirY, 0) && J.$gt$n(this.dirX, 0)) {
            iVal = t1.$add(posYown, t2);
            limitY = J.$sub$n(t1.$add(posYown, this.dirY), 1);
            iModifier = -1;
          } else
        ...
        t1 = J.getInterceptor$ns(posXown);
        t2 = ballLength - 1;
        if (J.$lt$n(this.dirX, 0)) {
          jVal = t1.$add(posXown, t2);
          limitX = J.$sub$n(t1.$add(posXown, this.dirX), 1);
          jModifier = -1;
        } else {
          jVal = t1.$sub(posXown, t2);
          limitX = J.$add$ns(t1.$add(posXown, this.dirX), 1);
          if (J.$eq$(this.dirX, 0) && J.$gt$n(this.dirY, 0)) {
            jVal = t1.$add(posXown, t2);
            limitX = J.$sub$n(t1.$add(posXown, this.dirX), 1);
            jModifier = -1;
          } else
        ...
        if (J.$ge$n(J.abs$0$n(this.dirY), J.abs$0$n(this.dirX)))
          for (i = iVal; t1 = J.getInterceptor(i), !t1.$eq(i, limitY); i = t1.$add(i, iModifier))
            for (j = jVal; t2 = J.getInterceptor(j), !t2.$eq(j, limitX); j = t2.$add(j, jModifier)) {
              t3 = this.game.field;
              if (i >>> 0 !== i || i >= t3.length)
                return H.ioore(t3, i);
              if (J.$index$asx(t3[i], j) != null) {
                t3 = this.game.field;
                if (i >= t3.length)
                  return H.ioore(t3, i);
                t3 = !J.$eq$(J.$index$asx(t3[i], j).get$owner(), checkingCell.owner);
              } else
                t3 = true;
              if (t3) {
                t3 = this.game.field;
                if (i >= t3.length)
                  return H.ioore(t3, i);
                retList.push(J.$index$asx(t3[i], j));
              }
            }
        else
          for (j = jVal; t1 = J.getInterceptor(j), !t1.$eq(j, limitX); j = t1.$add(j, jModifier))
            for (i = iVal; !J.$eq$(i, limitY); i += iModifier) {
              t2 = this.game.field;
              if (i >>> 0 !== i || i >= t2.length)
                return H.ioore(t2, i);
              if (J.$index$asx(t2[i], j) != null) {
                t2 = this.game.field;
                if (i >= t2.length)
                  return H.ioore(t2, i);
                t2 = !J.$eq$(J.$index$asx(t2[i], j).get$owner(), checkingCell.owner);
              } else
                t2 = true;
              if (t2) {
                t2 = this.game.field;
                if (i >= t2.length)
                  return H.ioore(t2, i);
                retList.push(J.$index$asx(t2[i], j));
              }
            }
        return retList;
      },
      move$0: function() {
        var t1, zwischen_Speicher_DirX, zwischen_Speicher_DirY, hitCells, hitGameParts, longTime_zwischen_Speicher_DirY, longTime_zwischen_Speicher_DirX, bewegung_Step_in_X, bewegung_Step_in_Y, x, collison, cellsToCheck, t2, t3, t4, i, _i, c, gp;
        t1 = this.cellList;
        if (2 >= t1.length)
          return H.ioore(t1, 2);
        if (J.$ge$n(t1[2].get$posY(), this.game.field.length - 2))
          return true;
        zwischen_Speicher_DirX = this.dirX;
        zwischen_Speicher_DirY = this.dirY;
        hitCells = H.setRuntimeTypeInfo([], [N.Cell]);
        hitGameParts = H.setRuntimeTypeInfo([], [N.GamePart]);
        for (longTime_zwischen_Speicher_DirY = zwischen_Speicher_DirY, longTime_zwischen_Speicher_DirX = zwischen_Speicher_DirX, bewegung_Step_in_X = null, bewegung_Step_in_Y = null, x = true, collison = false; x;) {
          t1 = J.getInterceptor(zwischen_Speicher_DirX);
          if (t1.$eq(zwischen_Speicher_DirX, 0) && J.$eq$(zwischen_Speicher_DirY, 0))
            x = false;
          if (J.$eq$(this.dirX, 2))
          ...
          cellsToCheck = this.calculateCells$1(this.chooseCell$0());
          this.dirX = zwischen_Speicher_DirX;
          this.dirY = zwischen_Speicher_DirY;
          t2 = cellsToCheck.length;
          if (t2 === 2) {
            if (0 >= t2)
              return H.ioore(cellsToCheck, 0);
            if (cellsToCheck[0] == null) {
              if (1 >= t2)
                return H.ioore(cellsToCheck, 1);
              t2 = cellsToCheck[1] != null;
            } else
              t2 = true;
          } else
            t2 = false;
          if (t2) {
            t2 = J.getInterceptor$n(longTime_zwischen_Speicher_DirY);
            t3 = J.getInterceptor$n(longTime_zwischen_Speicher_DirX);
            if (J.$gt$n(t2.abs$0(longTime_zwischen_Speicher_DirY), t3.abs$0(longTime_zwischen_Speicher_DirX))) {
              this.dirY = J.$mul$ns(this.dirY, -1);
              longTime_zwischen_Speicher_DirY = t2.$mul(longTime_zwischen_Speicher_DirY, -1);
            } else {
              this.dirX = J.$mul$ns(this.dirX, -1);
              longTime_zwischen_Speicher_DirX = t3.$mul(longTime_zwischen_Speicher_DirX, -1);
            }
            if (0 >= cellsToCheck.length)
              return H.ioore(cellsToCheck, 0);
            t2 = cellsToCheck[0];
            if (t2 != null)
              hitCells.push(t2);
            if (1 >= cellsToCheck.length)
              return H.ioore(cellsToCheck, 1);
            t2 = cellsToCheck[1];
            if (t2 != null)
              hitCells.push(t2);
          ...
          if (t2 === 5) {
            if (0 >= t2)
              return H.ioore(cellsToCheck, 0);
            t3 = cellsToCheck[0] == null;
            if (t3) {
              if (1 >= t2)
                return H.ioore(cellsToCheck, 1);
              t4 = cellsToCheck[1] != null;
            } else
              t4 = true;
            if (t4) {
              if (2 >= t2)
                return H.ioore(cellsToCheck, 2);
              if (cellsToCheck[2] == null) {
                if (3 >= t2)
                  return H.ioore(cellsToCheck, 3);
                t4 = cellsToCheck[3] != null;
              } else
                t4 = true;
            } else
              t4 = false;
            if (t4) {
              this.dirX = J.$mul$ns(this.dirX, -1);
              this.dirY = J.$mul$ns(this.dirY, -1);
              longTime_zwischen_Speicher_DirX = J.$mul$ns(longTime_zwischen_Speicher_DirX, -1);
              longTime_zwischen_Speicher_DirY = J.$mul$ns(longTime_zwischen_Speicher_DirY, -1);
              for (i = 0; i <= 3; ++i) {
                if (i >= cellsToCheck.length)
                  return H.ioore(cellsToCheck, i);
                t2 = cellsToCheck[i];
                if (t2 != null)
                  hitCells.push(t2);
                else
              ...
              if (t4) {
                ...
                if (t3) {
                  ...
                  if (4 >= t2)
                    return H.ioore(cellsToCheck, 4);
                  if (cellsToCheck[4] != null) {
                    this.dirX = J.$mul$ns(this.dirX, -1);
                    this.dirY = J.$mul$ns(this.dirY, -1);
                    longTime_zwischen_Speicher_DirX = J.$mul$ns(longTime_zwischen_Speicher_DirX, -1);
                    longTime_zwischen_Speicher_DirY = J.$mul$ns(longTime_zwischen_Speicher_DirY, -1);
                    if (4 >= cellsToCheck.length)
                      return H.ioore(cellsToCheck, 4);
                    t2 = cellsToCheck[4];
                    if (t2 != null)
                      hitCells.push(t2);
          ...
          if (collison) {
            for (t1 = hitCells.length, _i = 0; _i < hitCells.length; hitCells.length === t1 || (0, H.throwConcurrentModificationError)(hitCells), ++_i) {
              c = hitCells[_i];
              if (C.JSArray_methods.contains$1(hitGameParts, c.get$owner()))
                P.LinkedHashMap__makeEmpty();
              else
                hitGameParts.push(c.get$owner());
            }
            for (t1 = hitGameParts.length, _i = 0; _i < hitGameParts.length; hitGameParts.length === t1 || (0, H.throwConcurrentModificationError)(hitGameParts), ++_i) {
              gp = hitGameParts[_i];
              if (J.$eq$(J.get$type$x(gp), "panelPart")) {
                longTime_zwischen_Speicher_DirX = gp.get$changeX();
            ...
            this.moveStep$2(bewegung_Step_in_X, bewegung_Step_in_Y);
            if (!t1.$eq(zwischen_Speicher_DirX, 0))
              zwischen_Speicher_DirX = t1.$sub(zwischen_Speicher_DirX, bewegung_Step_in_X);
            else
              bewegung_Step_in_X = 0;
            t1 = J.getInterceptor(zwischen_Speicher_DirY);
            if (!t1.$eq(zwischen_Speicher_DirY, 0))
              zwischen_Speicher_DirY = t1.$sub(zwischen_Speicher_DirY, bewegung_Step_in_Y);
            else
              bewegung_Step_in_Y = 0;
          }
        }
      ...
      moveStep$2: function(x, y) {
        var oldPos, newPos, t1, t2, _i, cl, t3, t4, tmp, c;
        oldPos = H.setRuntimeTypeInfo([], [N.Cell]);
        newPos = H.setRuntimeTypeInfo([], [N.Cell]);
        for (t1 = this.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          cl = t1[_i];
          t3 = cl.get$posX();
          t4 = cl.posY;
          tmp = new N.Cell(null, null, null);
          tmp.posX = t3;
          tmp.posY = t4;
          cl.posX = null;
          cl.posY = null;
          cl.posY = J.$add$ns(t4, y);
          cl.posX = J.$add$ns(t3, x);
          oldPos.push(tmp);
          newPos.push(cl);
        }
        for (t1 = oldPos.length, _i = 0; _i < oldPos.length; oldPos.length === t1 || (0, H.throwConcurrentModificationError)(oldPos), ++_i) {
          c = oldPos[_i];
          t2 = this.game.field;
          t3 = c.posY;
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(t2[t3], c.posX, null);
        }
        for (t1 = newPos.length, _i = 0; _i < newPos.length; newPos.length === t1 || (0, H.throwConcurrentModificationError)(newPos), ++_i) {
          c = newPos[_i];
          t2 = this.game.field;
          t3 = c.posY;
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(t2[t3], c.posX, c);
        }
        return;
      },
      explode$1: function(powerUpVal) {
        var newDirs, list, i, newCellList, t1, t2, _i, c, t3, t4, t5, newBall;
        newDirs = [P.LinkedHashMap__makeLiteral(["x", 0, "y", -1]), P.LinkedHashMap__makeLiteral(["x", 0, "y", 1]), P.LinkedHashMap__makeLiteral(["x", -2, "y", -1]), P.LinkedHashMap__makeLiteral(["x", 2, "y", -1]), P.LinkedHashMap__makeLiteral(["x", 2, "y", 1]), P.LinkedHashMap__makeLiteral(["x", -2, "y", 1]), P.LinkedHashMap__makeLiteral(["x", -1, "y", -1]), P.LinkedHashMap__makeLiteral(["x", 1, "y", -1]), P.LinkedHashMap__makeLiteral(["x", -1, "y", -2]), P.LinkedHashMap__makeLiteral(["x", 1, "y", -2]), P.LinkedHashMap__makeLiteral(["x", 1, "y", 1]), P.LinkedHashMap__makeLiteral(["x", -1, "y", 1]), P.LinkedHashMap__makeLiteral(["x", 1, "y", 2]), P.LinkedHashMap__makeLiteral(["x", -1, "y", 2])];
        list = [];
        this.destroyBlock$1(this.game.getManagementList$1(this.type));
        if (typeof powerUpVal !== "number")
          return H.iae(powerUpVal);
        i = 0;
        for (; i < powerUpVal; ++i) {
          newCellList = [];
          for (t1 = this.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          ...
          t1 = this.game;
          if (i >= 14)
            return H.ioore(newDirs, i);
          newBall = new N.Ball(null, null, null, null, null, null, null, null, null, null, null);
          newBall.GamePart$11(t1, newDirs[i].$index(0, "x"), newDirs[i].$index(0, "y"), newCellList, H.S(this.type), H.S(this.powerup), this.powerupVal, this.changeX, this.changeY, this.destructionInfo, this.score);
          for (t1 = newBall.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
            t1[_i].set$owner(newBall);
          list.push(newBall);
        }
        C.JSArray_methods.addAll$1(this.game.newBallsAddedDuringMove, list);
      },
      destroyBlock$1: function(list) {
        ...
        for (t1 = this.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          ...
          J.$indexSet$ax(t3[t4], c.posX, null);
        }
        (list && C.JSArray_methods).remove$1(list, this);
        for (t1 = this.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          t1[_i].set$owner(null);
      },
      GamePart$11: function(game, dirX, dirY, list, type, powerup, powerupVal, changeX, changeY, destructionInfo, score) {
        this.game = game;
        this.dirX = dirX;
        this.dirY = dirY;
        this.cellList = list;
    ...
    PanelPart: {
      ...
      movePanel$2: function(dirX, dirY) {
        ...
        for (t1 = this.cellList, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          ...
          tmp.posX = t3;
          tmp.posY = t4;
          cl.posY = J.$add$ns(t4, this.dirY);
          cl.posX = J.$add$ns(t3, this.dirX);
          oldPos.push(tmp);
          newPos.push(cl);
        }
        for (t1 = oldPos.length, _i = 0; _i < oldPos.length; oldPos.length === t1 || (0, H.throwConcurrentModificationError)(oldPos), ++_i) {
      ...
      panelCheck$2: function(dirX, dirY) {
        var cellsToCheck, t1, free, _i, t2;
        this.dirX = dirX;
        this.dirY = dirY;
        cellsToCheck = this.calculateCells$1(this.chooseCell$0());
        for (t1 = cellsToCheck.length, free = true, _i = 0; t2 = cellsToCheck.length, _i < t2; t2 === t1 || (0, H.throwConcurrentModificationError)(cellsToCheck), ++_i)
          if (cellsToCheck[_i] != null)
            free = false;
        return free;
      }
    },
    ...
    View: {
      "^": "Object;status>,overlay,life,score,level,down,gameTable,fields,allFields,gameModel,gameController",
      generateField$1: function(gameModel) {
        var t1, t2, table, i, t3, j, x, y;
        t1 = this.gameTable;
        ...
        while (true) {
          ...
          while (true) {
            ...
            if (!(j < t3))
              break;
            table += "<td id='" + ("field_" + j + "_" + i) + "'></td>";
            ++j;
          }
          table += "</tr>";
          ++i;
        }
        t2.set$innerHtml(t1, table);
        t1 = gameModel.sizeX;
        if (typeof t1 !== "number")
          return H.iae(t1);
        this.fields = H.setRuntimeTypeInfo(new Array(t1), [[P.List, W.HtmlElement]]);
        x = 0;
        while (true) {
          t1 = gameModel.sizeX;
          if (typeof t1 !== "number")
        ...
        this.allFields = new W._FrozenElementList(document.querySelectorAll("#breakoutgame td"));
      },
      gamePaused$1: function(isPaused) {
        var t1 = this.down;
        if (!isPaused)
          J.set$innerHtml$x(t1, "Game running: Hit SPACE to pause!");
        else
          J.set$innerHtml$x(t1, "Game paused: Hit SPACE to continue!");
      },
      update$0: function() {
        var t1, t2, _i, t3, c, t4, t5, htmlElement;
        t1 = this.allFields;
        t1.toString;
        W._MultiElementCssClassSet__MultiElementCssClassSet(t1).clear$0(0);
        for (t1 = this.gameModel.field, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = J.get$iterator$ax(t1[_i]); t3.moveNext$0();) {
            ...
            if (c != null) {
              ...
              htmlElement = t5[t4];
              t4 = J.getInterceptor$x(htmlElement);
              t4.get$classes(htmlElement).clear$0(0);
              t5 = c.owner;
              switch (t5.type) {
                case "desS":
                  switch (t5.destructionInfo) {
                    case 6:
                      t4.get$classes(htmlElement).add$1(0, "Stone6");
                      break;
                    case 5:
                      t4.get$classes(htmlElement).add$1(0, "Stone5");
                      break;
                    case 4:
                      t4.get$classes(htmlElement).add$1(0, "Stone4");
                      break;
                    case 3:
                      t4.get$classes(htmlElement).add$1(0, "Stone3");
                      break;
                    case 2:
                      t4.get$classes(htmlElement).add$1(0, "Stone2");
                      break;
                    case 1:
                      t4.get$classes(htmlElement).add$1(0, "Stone1");
                      break;
                    default:
                      t4.get$classes(htmlElement).add$1(0, "Stone7");
                  }
                  break;
                case "ideS":
                  t4.get$classes(htmlElement).add$1(0, "InDesStone");
                  break;
                case "panelPart":
                  t4.get$classes(htmlElement).add$1(0, "Panel");
                  break;
                case "ball":
                  t4.get$classes(htmlElement).add$1(0, "Ball");
                  break;
                default:
                  break;
              }
      ...
      generateHighscore$2$score: function(scores, score) {
        var list, points, t1;
        list = J.join$1$ax(J.map$1$ax(scores, new N.View_generateHighscore_closure()), "");
        points = "You got " + H.S(score) + " points";
        t1 = "<div id='scorelist'>" + (score === 0 ? "" : points);
        return t1 + (J.get$isEmpty$asx(list) ? "" : "<ul>" + list + "</ul>") + "</div>";
      },
      showHighscore$3: function(scores, win, showLogin) {
        var score, t1, t2, t3, t4;
        score = this.gameModel.score;
        t1 = this.overlay;
        t2 = J.getInterceptor$x(t1);
        t2.set$innerHtml(t1, "<div id='highscore3'><h1>Highscore</h1></div>");
        ...
        if (t3 && showLogin) {
          t3 = win ? "Win" : "GameOver";
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", t3 + this.generateHighscore$2$score(scores, score) + "<form id='highscoreform'><input type='text' id='user' placeholder='user'><input type='password' id='pwd' placeholder='password'><button type='button' id='save'>Save</button><a type='button' id='close'href='index.html' class='discard'>Close</a><div id='failedsave'></div><div id='warning'></div></form>", null, null);
        } else {
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", this.generateHighscore$2$score(scores, score), null, null);
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", "<a type='button' id='close'href='index.html' class='discard'>Close</a>", null, null);
        }
      },
      toggleoverlay$1: function(vis) {
        var t1, t2;
        t1 = this.overlay;
        t2 = J.getInterceptor$x(t1);
        t2.get$classes(t1).clear$0(0);
        if (vis)
          t2.get$classes(t1).add$1(0, "visible");
        else
          t2.get$classes(t1).add$1(0, "hidden");
      }
    },
  ...
  }], ["", "breakoutclient.dart",, X, {
    "^": "",
    main: [function() {
      var t1, t2;
      t1 = H.setRuntimeTypeInfo([], [P.Map]);
      t2 = new N.GameKeyClient(null, "undefined", "undefined", false);
      t2._uri = P.Uri__makeHttpUri("http", "undefined:8080", "/", null);
      t2 = new N.GameController(null, null, null, null, null, 0, null, null, null, null, null, null, null, null, null, [], t1, t2);
      t1 = new N.View(document.querySelector("#status"), document.querySelector("#overlay"), document.querySelector("#life"), document.querySelector("#score"), document.querySelector("#level"), document.querySelector("#down"), document.querySelector("#breakoutgame"), null, null, null, null);
      t1.gameController = t2;
      t2.view = t1;
      t2.startGamekey$0();
      t2.startGame$0();
    }, "call$0", "breakoutclient__main$closure", 0, 0, 1]
    ...
    EfficientLengthTakeIterable: {
      ...
      get$length: function(_) {
        ...
        t1 = this._takeCount;
        if (C.JSInt_methods.$gt(iterableLength, t1))
          return t1;
    ...
    Future_wait_handleError: {
      "^": "Closure:19;_box_0,eagerError,cleanUp,result",
    ...
    Future_wait_closure: {
      "^": "Closure:20;_box_0,eagerError,cleanUp,result,pos",
  ...
  C.Duration_25000 = new P.Duration(25000);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, args: [P.Timer]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [P.CssClassSetImpl]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [P.bool]}, {func: 1, args: [[P.List, P.Map]]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,,]}, {func: 1, args: [P.Object]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, args: [W.Element]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, ret: P.Object, args: [,]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(X.breakoutclient__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(X.breakoutclient__main$closure(), a);
...
//# sourceMappingURL=breakoutclient.dart.js.map
