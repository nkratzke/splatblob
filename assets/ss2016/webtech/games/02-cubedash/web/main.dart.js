...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    Controller: {
      "^": "Object;game,view,gameTrigger,gameKeyCheck,gamekey",
      getHighscores$1: function(amountOfScores) {
        ...
        var $async$getHighscores$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 4;
                $async$goto = 7;
                return P._asyncHelper($async$self.gamekey.getStates$0(), $async$getHighscores$1, $async$completer);
              case 7:
                // returning from await.
                states = $async$result;
                scores = J.map$1$ax(states, new Y.Controller_getHighscores_closure()).toList$0(0);
                J.sort$1$ax(scores, new Y.Controller_getHighscores_closure0());
                $async$handler = 2;
                // goto after finally
                $async$goto = 6;
                break;
              ...
              case 6:
                // after finally
                $async$returnValue = J.take$1$ax(scores, amountOfScores);
                // goto return
                $async$goto = 1;
                break;
              case 1:
        ...
        return P._asyncHelper(null, $async$getHighscores$1, $async$completer, null);
      },
      gameOver$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, highscore, t1;
        var $async$gameOver$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$self.gameTrigger.cancel$0(0);
                J.set$innerHtml$x($async$self.view.gameOver, "Game Over!");
                $async$goto = 2;
                return P._asyncHelper($async$self.getHighscores$1(5), $async$gameOver$0, $async$completer);
              case 2:
                // returning from await.
                highscore = $async$result;
                $async$self.view.showHighscores$1(highscore);
                t1 = document.querySelector("#save");
                t1 = t1 == null ? t1 : J.get$onClick$x(t1);
                if (t1 == null)
                  ;
                else
                  H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1.get$_target(), t1._eventType, W._wrapZone(new Y.Controller_gameOver_closure($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = document.querySelector("#close");
                t1 = t1 == null ? t1 : J.get$onClick$x(t1);
                if (t1 == null)
                  ;
                else
                  H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1.get$_target(), t1._eventType, W._wrapZone(new Y.Controller_gameOver_closure0($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                // implicit return
        ...
        return P._asyncHelper(null, $async$gameOver$0, $async$completer, null);
      },
      Controller$0: function() {
        var error, stacktrace, exception, t1;
        X.Generator__readLevelFromJson(1);
        this.view = new A.View(this, document.querySelector("#score"), document.querySelector("#highscoreform"), document.querySelector("#scorelist"), document.querySelector("#warningoverlay"), document.querySelector("#highscore"), document.querySelector("#startButton"), document.querySelector("#gameover"), document.querySelector("#field"), document.querySelector("#powerupbutton"), []);
        try {
          W.HttpRequest_getString("gamekey.json", null, null).then$1(new Y.Controller_closure(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          error = t1;
          ...
          J.set$innerHtml$x(this.view.warningoverlay, "Could not connect to GameKey-Service!<br>Highscore will not work properly!");
        }
        this.view.generateField$0();
        t1 = J.get$onClick$x(this.view.startButton);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Controller_closure0(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Controller_closure1(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(this.view.gameField);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Controller_closure2(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Controller_closure3(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(this.view.powerupButton);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Controller_closure4(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {
        Controller$: function() {
          var t1 = new U.GameKey(null, "undefined", "undefined", false);
          t1._uri = P.Uri__makeHttpUri("http", "undefined:0", "/", null);
          t1 = new Y.Controller(null, null, null, null, t1);
          t1.Controller$0();
          return t1;
        }
      }
    ...
    Controller_closure: {
      ...
      call$1: function(json) {
        ...
        t4 = new U.GameKey(null, J.$index$asx(settings, "gameid"), "ad596ae475d0183a", false);
        t4._uri = P.Uri__makeHttpUri("http", H.S(t2) + ":" + H.S(t3), "/", null);
        t1.gamekey = t4;
        t4.authenticate$0();
        t1.gameKeyCheck = P.Timer_Timer$periodic(C.Duration_30000000, new Y.Controller__closure0(t1));
      }
    },
    Controller__closure0: {
      "^": "Closure:6;$this",
      call$1: function(_) {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 2:
                ...
                t1 = t1.view;
                if (t2 === true)
                  J.set$innerHtml$x(t1.warningoverlay, "");
                else
                  J.set$innerHtml$x(t1.warningoverlay, "Could not connect to GameKey-Service!<br>Highscore will not work properly!");
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
    ...
    Controller_closure0: {
      ...
      call$1: function(_) {
        var t1, t2, t3;
        t1 = this.$this;
        t1.view.clearScores$0();
        t2 = new D.Game(false, false, 0, 0, [], [], null, null);
        t3 = new Q.Player(t2, 4, 0, 4, 4, null, null, null);
        t3._powerupDuration = 0;
        t3._isJumping = false;
        t3._isFalling = false;
        t2._player = t3;
        t2._generator = new X.Generator(C.C__JSRandom, t2, 60);
        t1.game = t2;
        t2.gameOver = false;
        t2.running = true;
        t2 = t1.gameTrigger;
        if (t2 != null)
          t2.cancel$0(0);
        t1.gameTrigger = P.Timer_Timer$periodic(C.Duration_40000, new Y.Controller__closure(t1));
        t1.view.update$0(0);
      }
    },
    Controller__closure: {
    ...
    Controller_closure1: {
      ...
      call$1: function(ke) {
        ...
        t1 = this.$this;
        t2 = t1.game;
        if ((t2 == null ? t2 : t2.running) !== true)
          return;
        switch (J.get$keyCode$x(ke)) {
          case 38:
            t1.game._player.jump$0();
            break;
        }
      }
    },
    Controller_closure2: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this.game;
        if ((t1 == null ? t1 : t1.running) !== true)
          return;
        t1._player.jump$0();
      }
    },
    ...
    Controller_closure4: {
      ...
      call$1: function(_) {
        ...
        if ((t1 == null ? t1 : t1.running) !== true)
          return;
        t1._player.usePowerup$0();
      }
    },
    Controller_getHighscores_closure: {
      "^": "Closure:0;",
    ...
    Controller_getHighscores_closure0: {
      "^": "Closure:3;",
      call$2: function(a, b) {
        return J.$sub$n(J.$index$asx(b, "score"), J.$index$asx(a, "score"));
      }
    },
    Controller_gameOver_closure: {
      "^": "Closure:6;$this",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, user, pwd, id, newUser, stored;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
            ...
            switch ($async$goto) {
              case 0:
                ...
                if ((user == null ? user : user.length === 0) === true) {
                  J.set$innerHtml$x(t1.view.warningoverlay, "Please enter a username!");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                ...
                if ((pwd == null ? pwd : pwd.length === 0) === true) {
                  J.set$innerHtml$x(t1.view.warningoverlay, "Please enter a password!");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
              ...
              case 6:
                // returning from await.
                newUser = $async$result;
                if (newUser == null) {
                  J.set$innerHtml$x(t1.view.warningoverlay, "Could not register user " + H.S(user) + ".<br>User might already exist or gamekey service not available.");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                J.set$innerHtml$x(t1.view.warningoverlay, "");
                $async$goto = 7;
                return P._asyncHelper(t1.gamekey.storeState$2(J.$index$asx(newUser, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.1", "points", t1.game._score])), $async$call$1, $async$completer);
              case 7:
                // returning from await.
                stored = $async$result;
                t1 = t1.view;
                if (stored === true) {
                  ...
                  J.set$innerHtml$x(t1.warningoverlay, "Could not save highscore. Retry?");
                  // goto return
                  $async$goto = 1;
                  break;
                }
              ...
              case 8:
                ...
                user = $async$result;
                if (user == null) {
                  J.set$innerHtml$x(t1.view.warningoverlay, "Could not login. The entered password is wrong!");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                $async$goto = 9;
                return P._asyncHelper(t1.gamekey.storeState$2(J.$index$asx(user, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.1", "points", t1.game._score])), $async$call$1, $async$completer);
              case 9:
                // returning from await.
                stored = $async$result;
                t1 = t1.view;
    ...
    Controller_gameOver_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this.view.clearScores$0();
      }
    }
    ...
    DomIterator: {
      ...
      }, "next$0", "call$1", "call$0", "get$next", 0, 2, 24, 0],
      "%": "Iterator"
    },
    DomRectReadOnly: {
      "^": "Interceptor;",
    ...
    _Html5NodeValidator: {
      ...
      static: {
        ...
        _Html5NodeValidator__standardAttributeValidator: [function(element, attributeName, value, context) {
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 11],
        _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "html__Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 11]
      }
    },
    ImmutableListMixin: {
      "^": "Object;",
    ...
    "^": "",
    Game: {
      "^": "Object;running,gameOver,_score,_level,obstacles,powerups,_player,_generator",
      loop$0: function(_) {
        var t1, t2, _i, t3, t4;
        if (this._player.checkCollision$0()) {
          this.running = false;
          this.gameOver = true;
          return;
        }
        ++this._score;
        this._player.collectPowerup$0();
        t1 = this._player;
        t2 = t1._powerupDuration;
        if (t2 === 0) {
          if (t1._isJumping === true && t1._isFalling !== true && J.$lt$n(t1._posY, 10))
            t1._posY = J.$add$ns(t1._posY, 1);
          else if (t1._isJumping === true && t1._isFalling !== true && J.$eq$(t1._posY, 10))
            t1._isFalling = true;
          else if (t1._isJumping === true && t1._isFalling === true && J.$gt$n(t1._posY, 0))
            t1._posY = J.$sub$n(t1._posY, 1);
          else if (t1._isJumping === true && t1._isFalling === true && J.$eq$(t1._posY, 0)) {
            t1._isJumping = false;
            t1._isFalling = false;
          }
        } else
          t1._powerupDuration = t2 - 1;
        for (t1 = this.obstacles, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          t1[_i].move$0();
        for (t1 = this.powerups, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          t1[_i].move$0();
        this._generator.generateObstacle$0();
        this._generator.deleteObstacles$0();
        this._generator.deletePowerups$0();
        t1 = this._score;
        t2 = $.$get$Generator__levels();
        t3 = this._level;
        t4 = t2.length;
        if (t3 >= t4)
        ...
        if (t1 > t2 && t3 < t4 - 1) {
          this._level = t3 + 1;
          t1 = this._generator._game;
          t2 = new Y.Powerup(null, 40, 2, 2, 2, null, null, null);
          t2._powerupDuration = 0;
          t2._isJumping = false;
          t2._isFalling = false;
          t1.powerups.push(t2);
        }
    ...
    "^": "",
    GameKey: {
      "^": "Object;_uri,_gameId,_secret,_available",
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$handler = 4;
                uri = $async$self._uri.resolveUri$1(P.Uri_parse("/game/" + H.S($async$self._gameId), 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", $async$self._secret]), "", ""));
                $async$goto = 7;
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (users == null) {
                  ...
                  ;
                user = J.firstWhere$2$orElse$ax(users, new U.GameKey_getUserId_closure($name), null);
            ...
            switch ($async$goto) {
              case 0:
                ...
                if (!$async$self._available) {
                  ...
                  ;
                $async$handler = 4;
                uri = $async$self._uri.resolveUri$1(P.Uri_parse("/gamestate/" + H.S($async$self._gameId), 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", $async$self._secret]), "", ""));
                $async$goto = 7;
            ...
            switch ($async$goto) {
              case 0:
                ...
                if (!$async$self._available) {
                  ...
                  ;
                $async$handler = 4;
                t1 = $async$self._uri.resolveUri$1(P.Uri_parse("/gamestate/" + H.S($async$self._gameId) + "/" + H.S(uid), 0, null)).toString$0(0);
    ...
    "^": "",
    Generator: {
      "^": "Object;_rnd,_game,_nextObstacleDistance",
      generateObstacle$0: function() {
        var t1, t2, t3, t4, o;
        if (J.$eq$(this._nextObstacleDistance, 0)) {
          t1 = $.$get$Generator__possibleObstacles();
          t2 = t1.length;
          t3 = this._game;
          t4 = t3._level;
          if (t2 > t4)
            if (t1[t4].length > 0) {
              t1 = t1[t4];
              t2 = this._rnd.nextInt$1(t1.length);
              if (t2 < 0 || t2 >= t1.length)
                return H.ioore(t1, t2);
              for (t1 = J.get$iterator$ax(t1[t2]), t2 = t3.obstacles; t1.moveNext$0();) {
                o = t1.get$current();
                t4 = new M.Obstacle(J.$add$ns(o.get$posX(), 40), o._posY, o._width, o._height, null, null, null);
                t4._powerupDuration = 0;
                t4._isJumping = false;
                t4._isFalling = false;
                t2.push(t4);
              }
            }
          t1 = $.$get$Generator__nextObstacleDistances();
          t3 = t3._level;
          if (t3 >= t1.length)
            return H.ioore(t1, t3);
          this._nextObstacleDistance = t1[t3];
        } else
          this._nextObstacleDistance = J.$sub$n(this._nextObstacleDistance, 1);
      },
      deleteObstacles$0: function() {
        var t1, i, t2;
        for (t1 = this._game.obstacles, i = 0; i < t1.length; ++i) {
          t2 = t1[i];
          if (J.$lt$n(J.$add$ns(t2._posX, t2._width), 0))
            C.JSArray_methods.removeAt$1(t1, i);
        }
      },
      deletePowerups$0: function() {
        var t1, i, t2;
        for (t1 = this._game.powerups, i = 0; i < t1.length; ++i) {
          t2 = t1[i];
          if (J.$lt$n(J.$add$ns(t2._posX, t2._width), 0))
            C.JSArray_methods.removeAt$1(t1, i);
        }
      ...
      static: {
        Generator__readLevelFromJson: function(level) {
          var error, stacktrace, exception, t1;
          try {
            W.HttpRequest_request("lvl" + H.S(level) + ".json", "GET", null, null, null, null, null, null).then$1(new X.Generator__readLevelFromJson_closure(level));
          } catch (exception) {
            t1 = H.unwrapException(exception);
            error = t1;
            stacktrace = H.getTraceFromException(exception);
    ...
    Generator__readLevelFromJson_closure: {
      "^": "Closure:0;level",
      call$1: function(req) {
        var settings, t1;
        if (J.get$status$x(req) === 200) {
          settings = C.JsonCodec_null_null.decode$1(J.get$responseText$x(req));
          $.$get$Generator__levels().push(J.$index$asx(settings, "neededPoints"));
          $.$get$Generator__nextObstacleDistances().push(J.$index$asx(settings, "nextObstacleDistance"));
          t1 = H.subtypeCast(J.$index$asx(settings, "possibleObstacles"), "$isList", [P.List], "$asList");
          t1 = t1 == null ? t1 : J.get$isNotEmpty$asx(t1);
          if ((t1 == null ? false : t1) === true)
            $.$get$Generator__possibleObstacles().push(J.map$1$ax(H.listTypeCast(J.$index$asx(settings, "possibleObstacles")), new X.Generator__readLevelFromJson__closure()).toList$0(0));
          X.Generator__readLevelFromJson(this.level + 1);
        }
      }
    },
    Generator__readLevelFromJson__closure: {
      "^": "Closure:0;",
      call$1: function(l) {
        return J.map$1$ax(H.subtypeCast(l, "$isList", [P.Map], "$asList"), new X.Generator__readLevelFromJson___closure());
      }
    },
    Generator__readLevelFromJson___closure: {
      "^": "Closure:0;",
      call$1: function(m) {
        var t1 = new M.Obstacle(J.$index$asx(m, "posX"), J.$index$asx(m, "posY"), J.$index$asx(m, "width"), J.$index$asx(m, "height"), null, null, null);
        t1._powerupDuration = 0;
        t1._isJumping = false;
        t1._isFalling = false;
        return t1;
      }
    ...
    "^": "",
    Obstacle: {
      "^": "Entity;_posX,_posY,_width,_height,_powerupDuration,_isJumping,_isFalling",
      move$0: function() {
        this._posX = J.$sub$n(this._posX, 1);
      }
    }
  }], ["", "player.dart",, Q, {
    "^": "",
    Player: {
      "^": "Entity;_player$_game,_posX,_posY,_width,_height,_powerupDuration,_isJumping,_isFalling",
      jump$0: function() {
        var t1, t2;
        if (this._powerupDuration > 0) {
          ...
          if (typeof t2 !== "number")
            return H.iae(t2);
          if (J.$lt$n(t1, 28 - t2))
            this._posY = J.$add$ns(this._posY, 1);
          this._isFalling = true;
          this._isJumping = true;
        } else
          this._isJumping = true;
      },
      checkCollision$0: function() {
        var t1, t2, t3, t4, _i, e;
        for (t1 = this._player$_game.obstacles, t2 = t1.length, t3 = this._width, t4 = this._height, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          e = t1[_i];
          if (J.$lt$n(this._posX, J.$add$ns(e.get$posX(), e._width)) && J.$gt$n(J.$add$ns(this._posX, t3), e._posX) && J.$lt$n(this._posY, J.$add$ns(e._posY, e._height)) && J.$gt$n(J.$add$ns(this._posY, t4), e._posY))
            return true;
        }
        return false;
      },
      collectPowerup$0: function() {
        var t1, t2, t3, t4, _i, e;
        for (t1 = this._player$_game.powerups, t2 = t1.length, t3 = this._width, t4 = this._height, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          e = t1[_i];
          if (J.$lt$n(this._posX, J.$add$ns(e.get$posX(), e._width)) && J.$gt$n(J.$add$ns(this._posX, t3), e._posX) && J.$lt$n(this._posY, J.$add$ns(e._posY, e._height)) && J.$gt$n(J.$add$ns(this._posY, t4), e._posY)) {
            C.JSArray_methods.remove$1(t1, e);
            this._powerupDuration = 250;
          }
        }
      },
      usePowerup$0: function() {
        if (this._powerupDuration > 0 && J.$gt$n(this._posY, 0))
          this._posY = J.$sub$n(this._posY, 1);
      }
    }
  }], ["", "powerup.dart",, Y, {
    "^": "",
    Powerup: {
      "^": "Entity;game,_posX,_posY,_width,_height,_powerupDuration,_isJumping,_isFalling",
      move$0: function() {
        this._posX = J.$sub$n(this._posX, 1);
      }
    }
    ...
    "^": "",
    View: {
      "^": "Object;_controller,_view$_score,_highscoreform,_scorelist,warningoverlay,highscore,startButton,gameOver,gameField,powerupButton,_fields",
      generateField$0: function() {
        var table, i, t1, j, t2, t3;
        for (table = "", i = 0; i < 28; ++i) {
          table += "<tr>";
          for (t1 = 28 - i - 1, j = 0; j < 40; ++j)
            table += "<td id='field_" + t1 + "_" + j + "'></td>";
          table += "</tr>";
        }
        t1 = this.gameField;
        t2 = J.getInterceptor$x(t1);
        ...
        if (t3 == null)
          return t3.$add();
        t2.set$innerHtml(t1, t3 + table);
        for (t2 = this._fields, i = 0; i < 28; ++i) {
          t2.push([]);
          for (j = 0; j < 40; ++j) {
            if (i >= t2.length)
              return H.ioore(t2, i);
            t2[i].push(t1.querySelector("#field_" + i + "_" + j));
          }
        }
      },
      update$0: function(_) {
        var t1, t2, _i, t3, he, t4, i, j, e, t5, t6;
        for (t1 = this._fields, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = C.JSArray_methods.get$iterator(t1[_i]); t3.moveNext$0();) {
            he = t3.get$current();
            t4 = J.getInterceptor$x(he);
            t4.get$classes(he).clear$0(0);
            t4.get$classes(he).add$1(0, "empty");
          }
        t2 = this._controller;
        i = 0;
        while (true) {
          t3 = t2.game;
          t4 = t3._player._height;
          if (typeof t4 !== "number")
            return H.iae(t4);
          if (!(i < t4))
            break;
          ...
          while (true) {
            ...
            if (!(j < t4))
              break;
            t3 = J.$add$ns(t3._posY, i);
            if (t3 >>> 0 !== t3 || t3 >= t1.length)
              return H.ioore(t1, t3);
            t3 = t1[t3];
            t4 = J.$add$ns(t2.game._player._posX, j);
            if (t4 >>> 0 !== t4 || t4 >= t3.length)
              return H.ioore(t3, t4);
            J.get$classes$x(t3[t4]).add$1(0, "player");
            ++j;
          }
          ++i;
        }
        for (t3 = t3.obstacles, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i) {
          e = t3[_i];
          i = 0;
          while (true) {
            t5 = e.get$height(e);
            ...
            while (true) {
              ...
              if (!(j < t5))
                break;
              t5 = t1.length;
              t6 = J.$add$ns(e.get$posY(), i);
              if (typeof t6 !== "number")
                return H.iae(t6);
              if (t5 > t6) {
                t5 = J.$add$ns(e._posY, i);
                if (typeof t5 !== "number")
                  return H.iae(t5);
                t5 = 0 <= t5;
              } else
              ...
              if (t5) {
                ...
                if (t5 >>> 0 !== t5 || t5 >= t1.length)
                  return H.ioore(t1, t5);
                t5 = t1[t5].length;
                t6 = J.$add$ns(e._posX, j);
                if (typeof t6 !== "number")
                  return H.iae(t6);
                if (t5 > t6) {
                  t5 = J.$add$ns(e._posX, j);
                  if (typeof t5 !== "number")
                    return H.iae(t5);
                  t5 = 0 <= t5;
                } else
                ...
                if (t5) {
                  ...
                  J.get$classes$x(t5[t6]).add$1(0, "obstacle");
                }
              }
              ++j;
            }
        ...
        for (t3 = t2.game.powerups, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, H.throwConcurrentModificationError)(t3), ++_i) {
          e = t3[_i];
          i = 0;
          while (true) {
            t5 = e.get$height(e);
            ...
            while (true) {
              ...
              if (t5) {
                ...
                if (t5) {
                  ...
                  if (t6 >>> 0 !== t6 || t6 >= t5.length)
                    return H.ioore(t5, t6);
                  J.get$classes$x(t5[t6]).add$1(0, "powerup");
                }
              }
              ++j;
            }
        ...
        J.setInnerHtml$1$x(this._view$_score, "Score: " + t2.game._score);
        t1 = t2.game.gameOver ? "Game Over!" : "";
        J.setInnerHtml$1$x(this.gameOver, t1);
      },
      showHighscores$1: function(scores) {
        var list = J.map$1$ax(scores, new A.View_showHighscores_closure()).join$1(0, "");
        J.insertAdjacentHtml$4$treeSanitizer$validator$x(this._highscoreform, "beforeend", "<input type='text' id='user' placeholder='user'><input type='password' id='pwd' placeholder='password'><button type='button' id='save'>Save</button><button type='button' id='close'>Close</button>", null, null);
        J.insertAdjacentHtml$4$treeSanitizer$validator$x(this._scorelist, "beforeend", "<ol>" + H.S(list) + "</ol>", null, null);
      },
      clearScores$0: function() {
        J.set$innerHtml$x(this._highscoreform, "");
        J.set$innerHtml$x(this._scorelist, "");
      }
    },
    View_showHighscores_closure: {
      "^": "Closure:0;",
      call$1: function(entry) {
...
;
  ...
  }, "_Html5NodeValidator__attributeValidators", "Generator__levels", "$get$Generator__levels", function() {
    return [];
  }, "Generator__levels", "Generator__nextObstacleDistances", "$get$Generator__nextObstacleDistances", function() {
    return [];
  }, "Generator__nextObstacleDistances", "Generator__possibleObstacles", "$get$Generator__possibleObstacles", function() {
    return [];
  }, "Generator__possibleObstacles", "CssClassSetImpl__validTokenRE", "$get$CssClassSetImpl__validTokenRE", function() {
    return P.RegExp_RegExp("^\\S+$", true, false);
  }, "CssClassSetImpl__validTokenRE"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, ret: W.Node}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.String, P.String]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, v: true, opt: [P.Object]}];
