...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    getOpposite: function(direction) {
      ...
      switch (direction) {
        case C.Direction_5:
          newDirection = C.Direction_4;
          break;
        case C.Direction_4:
          newDirection = C.Direction_5;
          break;
        case C.Direction_1:
          newDirection = C.Direction_2;
          break;
        case C.Direction_0:
          newDirection = C.Direction_3;
          break;
        case C.Direction_2:
          newDirection = C.Direction_1;
          break;
        case C.Direction_3:
          newDirection = C.Direction_0;
          break;
        default:
          newDirection = null;
          break;
    ...
    getHealth: function(damage, health) {
      ...
      if (index <= 0)
        ...
        if (index >= 4)
          return H.ioore(C.List_WDf, index);
        return C.List_WDf[index];
      }
    },
    generateHealth: function(health) {
      var t1, buffer;
      t1 = J.getInterceptor(health);
      if (t1.$eq(health, "gb"))
        buffer = C.Health_1;
      else if (t1.$eq(health, "gyb"))
        buffer = C.Health_0;
      else if (t1.$eq(health, "yb"))
        buffer = C.Health_2;
      else
        buffer = t1.$eq(health, "rb") ? C.Health_3 : null;
      return buffer;
    },
    GameController: {
      "^": "Object;game,view,gameKey,_ballTrigger,_gameKeyTrigger,ballSpeed",
      newGame$0: function() {
        this._ballTrigger = P.Timer_Timer$periodic(this.ballSpeed, new G.GameController_newGame_closure(this));
        var t1 = this.view;
        J.set$innerHtml$x(t1.overlay, "");
      ...
      updateView$1: function(gameField) {
        ...
        if (t1.gameOver$0() || this.game.gameEnds$0())
          this._gameOver$0();
        else
          this.view.update$1(0, this.game);
      },
      _gameOver$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1, highscore;
        var $async$_gameOver$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$self._ballTrigger.cancel$0(0);
                t1 = $async$self.view;
                t1.update$1(0, $async$self.game);
                $async$goto = 2;
                return P._asyncHelper($async$self.gameKey.getStates$0(), $async$_gameOver$0, $async$completer);
              case 2:
                // returning from await.
                highscore = $async$result;
                t1.showHighscore$2($async$self.game, highscore);
                t1 = document.querySelector("#save");
                t1 = t1 == null ? t1 : J.get$onClick$x(t1);
                if (t1 == null)
                  ;
                else
                  H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1.get$_target(), t1._eventType, W._wrapZone(new G.GameController__gameOver_closure($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = document.querySelector("#close");
                t1 = t1 == null ? t1 : J.get$onClick$x(t1);
                if (t1 == null)
                  ;
                else
                  H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1.get$_target(), t1._eventType, W._wrapZone(new G.GameController__gameOver_closure0($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                J.set$innerHtml$x(document.querySelector("#title"), "");
                // implicit return
      ...
      readSettings$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, $async$temp1, $async$temp2, $async$temp3, $async$temp4, $async$temp5, $async$temp6;
        var $async$readSettings$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$temp4 = J;
                $async$temp5 = J;
                $async$temp6 = C.JsonCodec_null_null;
                $async$goto = 2;
                return P._asyncHelper(W.HttpRequest_getString("controller_settings.json", null, null), $async$readSettings$0, $async$completer);
              case 2:
                // returning from await.
                $async$temp1.ballSpeed = $async$temp2.Duration$(0, 0, 0, $async$temp3.Primitives_parseInt($async$temp4.toString$0$($async$temp5.$index$asx($async$temp6.decode$1($async$result), "ballspeed")), null, null), 0, 0);
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
        ...
        return P._asyncHelper(null, $async$readSettings$0, $async$completer, null);
      },
      GameController$0: function() {
        var error, stacktrace, exception, t1, t2;
        this.readSettings$0();
        try {
          this._gameKeyTrigger = P.Timer_Timer$periodic(C.Duration_3000000, new G.GameController_closure(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          error = t1;
          stacktrace = H.getTraceFromException(exception);
          P.print("GameController() caused following error: '" + H.S(error) + "'");
          P.print(H.S(stacktrace));
          J.set$innerHtml$x(this.view.warningoverlay, "Could not get gamekey settings. Highscore will not work properly.");
        }
        ...
        t1 = J.get$onClick$x(document.querySelector("#startgame"));
        ...
        t1 = J.get$onClick$x(document.querySelector("#backmenu"));
        ...
        t1 = J.get$onClick$x(document.querySelector("#howto"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure3(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#cancelbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure4(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#rightbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure5(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector("#leftbutton"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure6(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keyup, 0)]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.GameController_closure7(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = this.view;
        t2 = J.get$onClick$x(t1.highscore);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.GameController_closure8(this)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
        t1.generateField$1(this.game);
      },
      static: {
        GameController$: function() {
          ...
          t3 = document.querySelector("#overlay");
          t4 = document.querySelector("#title");
          t5 = document.querySelector("#level");
          t6 = document.querySelector("#gameover");
          t7 = document.querySelector("#game");
          t8 = document.querySelector("#points");
          t9 = document.querySelector("#score");
          t10 = document.querySelector("#startHigh");
          t11 = document.querySelector("#menuview");
          t12 = document.querySelector("#gameview");
          t13 = document.querySelector("#back");
          t14 = document.querySelector("#help");
          t15 = document.querySelector("#button");
          t16 = new G.GameKey(null, "c1b8f208-1e57-4431-bc7e-82f9db6e2780", "DontWorryAboutaT23", "BrickGame1");
          t16._uri = P.Uri__makeHttpUri("http", "212.201.22.169:50001", "", null);
          t16 = new G.GameController(t1, new G.View(t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, null), t16, null, null, null);
          t16.GameController$0();
          return t16;
        }
      }
    },
            ...
            switch ($async$goto) {
              ...
              case 2:
                ...
                if ($async$result === true)
                  J.set$innerHtml$x(t2.warningoverlay, "");
                else
                  J.set$innerHtml$x(t2.warningoverlay, "Could not connect to gamekey service. Highscore will not work properly.");
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
    ...
    GameController_closure1: {
      ...
      call$1: function(_) {
        var t1, t2;
        t1 = this.$this.view;
        t2 = t1.menuView.style;
        t2.display = "none";
        t1 = t1.gameView.style;
        t1.display = "block";
      }
    },
    ...
    GameController_closure8: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        t1.gameKey.getStates$0().then$1(new G.GameController__closure(t1));
      }
    },
    GameController__closure: {
      "^": "Closure:0;$this",
      call$1: function(contetn) {
        var t1, t2;
        t1 = this.$this;
        t1.view.showHighscore$2(t1.game, contetn);
        t2 = document.querySelector("#close");
        t2 = t2 == null ? t2 : J.get$onClick$x(t2);
        if (t2 == null)
          ;
        else
          H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2.get$_target(), t2._eventType, W._wrapZone(new G.GameController___closure(t1)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      }
    },
    GameController___closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        J.set$innerHtml$x(this.$this.view.overlay, "");
        J.set$innerHtml$x(document.querySelector("#title"), "Brick Break");
      }
    },
    GameController_newGame_closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
    ...
    GameController__gameOver_closure: {
      "^": "Closure:5;$this",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, user, pwd, t1, t2, id, t3, t4;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                pwd = H.interceptedTypeCast(document.querySelector("#password"), "$isInputElement").value;
                ...
                t2 = t1.gameKey;
                $async$goto = 3;
                return P._asyncHelper(t2.getUserId$1(user), $async$call$1, $async$completer);
              case 3:
                // returning from await.
                id = $async$result;
                t3 = id == null;
                if (t3) {
                  t4 = "User " + H.S(user) + " not found. Shall we create it?<button id='create'>Create</button><button id='cancel' class='discard'>Cancel</button>";
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), t4);
                  t4 = document.querySelector("#cancel");
                  t4 = t4 == null ? t4 : J.get$onClick$x(t4);
                  if (t4 == null)
                    ;
                  else
                    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4.get$_target(), t4._eventType, W._wrapZone(new G.GameController__gameOver__closure(t1)), false), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
                  t4 = document.querySelector("#create");
                  t4 = t4 == null ? t4 : J.get$onClick$x(t4);
                  if (t4 == null)
                    ;
                  else
                    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4.get$_target(), t4._eventType, W._wrapZone(new G.GameController__gameOver__closure0(t1, user, pwd)), false), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
                } else
                  ;
                $async$goto = !t3 ? 4 : 5;
                break;
              case 4:
                // then
                $async$goto = 6;
                return P._asyncHelper(t2.getUser$2(id, pwd), $async$call$1, $async$completer);
              case 6:
                // returning from await.
                user = $async$result;
                if (user == null) {
                  ...
                  ;
                t3 = J.getInterceptor$asx(user);
                $async$goto = 7;
                return P._asyncHelper(t2.storeState$2(t3.$index(user, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.2", "points", t1.game.points])), $async$call$1, $async$completer);
              case 7:
                // returning from await.
                if ($async$result === true) {
                  t2 = "" + t1.game.points + " points stored for " + H.S(t3.$index(user, "name"));
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), t2);
                  J.set$innerHtml$x(t1.view.overlay, "");
                  t1.game = G.Game$();
                  t1.newGame$0();
                  // goto return
                  $async$goto = 1;
    ...
    GameController__gameOver__closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this.newGame$0();
      }
    },
    GameController__gameOver__closure0: {
      "^": "Closure:5;$this,user,pwd",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, t3, usr;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t3 = $async$self.user;
                $async$goto = 3;
                return P._asyncHelper(t2.registerUser$2(t3, $async$self.pwd), $async$call$1, $async$completer);
              case 3:
                // returning from await.
                usr = $async$result;
                if (usr == null) {
                  t1 = "Could not register user " + H.S(t3) + ". User might already exist or gamekey service not available.";
                ...
                $async$goto = 4;
                return P._asyncHelper(t2.storeState$2(J.$index$asx(usr, "id"), P.LinkedHashMap__makeLiteral(["version", "0.0.2", "points", t1.game.points])), $async$call$1, $async$completer);
              case 4:
                // returning from await.
                if ($async$result === true) {
                  t2 = "" + t1.game.points + " points stored for " + H.S(t3);
                  J.set$innerHtml$x(document.querySelector("#highscorewarning"), t2);
                  t1.newGame$0();
                  // goto return
                  $async$goto = 1;
    ...
    GameController__gameOver_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        var t1 = this.$this;
        t1.game = G.Game$();
    ...
    GameKey: {
      "^": "Object;_uri,_gameid,_secret,_nameofGame",
      registerUser$2: function($name, password) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, answer, error, t1, t2, exception, $async$exception;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2 = P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["name", H.S($name), "pwd", H.S(password)]), "", "")._query;
                if (t2 == null)
                  t2 = "";
                else
                  ;
              ...
              case 4:
                ...
                error = t1;
                P.print("GameKey.registerUser() caused an error: '" + H.S(error) + "'");
                // goto return
                $async$goto = 1;
                break;
                // goto after finally
      ...
      getUser$2: function($name, password) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, uri, answer, error, t1, exception, $async$exception;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$handler = 4;
                uri = $async$self._uri.resolveUri$1(P.Uri_parse("/user/" + H.S($name), 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["pwd", H.S(password)]), "", ""));
                $async$goto = 7;
              ...
              case 4:
                ...
                t1 = H.unwrapException($async$exception);
                error = t1;
                P.print("GameKey.getUser() caused an error: '" + H.S(error) + "'");
                // goto return
                $async$goto = 1;
                break;
                // goto after finally
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$handler = 4;
                uri = $async$self._uri.resolveUri$1(P.Uri_parse("/game/" + $async$self._gameid, 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", $async$self._secret]), "", ""));
                $async$goto = 7;
              ...
              case 7:
                // returning from await.
                answer = $async$result;
                t1 = J.get$status$x(answer) === 200 && true;
                $async$returnValue = t1;
                // goto return
                $async$goto = 1;
                break;
              ...
              case 4:
                ...
                t1 = H.unwrapException($async$exception);
                error = t1;
                P.print("GameKey.authenticate() caused an error: '" + H.S(error));
      ...
      getUserId$1: function($name) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, listusers, user, error, t1, exception, $async$exception;
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (listusers == null) {
                  ...
                  ;
                user = J.firstWhere$2$orElse$ax(listusers, new G.GameKey_getUserId_closure($name), null);
              ...
              case 4:
                ...
                t1 = H.unwrapException($async$exception);
                error = t1;
                P.print("GameKey.getUserId() caused an error: '" + H.S(error) + "'");
                // goto return
                $async$goto = 1;
                break;
                // goto after finally
      ...
      listUsers$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, answer, error, t1, exception, $async$exception;
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 4:
                ...
                t1 = H.unwrapException($async$exception);
                error = t1;
                P.print("GameKey.listUsers() caused an error: '" + H.S(error) + "'");
                // goto return
                $async$goto = 1;
                break;
                // goto after finally
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$handler = 4;
                uri = $async$self._uri.resolveUri$1(P.Uri_parse("/gamestate/" + $async$self._gameid, 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", $async$self._secret]), "", ""));
                $async$goto = 7;
              ...
              case 4:
                ...
                t1 = H.unwrapException($async$exception);
                error = t1;
                P.print("GameKey.getStates() caused an error: '" + H.S(error) + "'");
                // goto return
                $async$goto = 1;
                break;
                // goto after finally
      ...
      storeState$2: function(id, state) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, answer, error, t1, t2, exception, $async$exception;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$handler = 4;
                t1 = $async$self._uri.resolveUri$1(P.Uri_parse("/gamestate/" + $async$self._gameid + "/" + H.S(id), 0, null)).toString$0(0);
              ...
              case 4:
                ...
                t1 = H.unwrapException($async$exception);
                error = t1;
                P.print("GameKey.storeState() caught an error: '" + H.S(error) + "'");
                $async$returnValue = false;
                // goto return
                $async$goto = 1;
                break;
    ...
    Ball: {
      "^": "MoveableObject;_damage,activated@,_direction,xPosition,yPosition,width,height,destroyed,itemsBuffer",
      collision$2: function(gameField, collisionObject) {
        var t1, playerPieces, t2, playerMiddle, ballPosition;
        t1 = J.getInterceptor(collisionObject);
        if (!!t1.$isBall) {
          collisionObject._direction = G.getOpposite(collisionObject._direction);
          this._direction = G.getOpposite(this._direction);
        }
        if (!!t1.$isPlayer) {
          ...
          if (ballPosition >= playerMiddle && ballPosition <= playerMiddle + playerPieces)
            ...
            t1 = playerMiddle - playerPieces;
            if (ballPosition >= t1 && ballPosition < playerMiddle || ballPosition === t1)
      ...
      move$3: function(direction, gameField, controller) {
        var t1, t2, t3, coordinates, response;
        t1 = this.yPosition;
        ...
        if (t1 === J.$sub$n(J.get$length$asx(gameField[0]), 1)) {
          ...
          t2 = gameField[t1];
          t3 = this.yPosition;
          t1 = new G.Field(t1, t3, $.Field__widthField, $.Field__heightField, false, null);
          t1.itemsBuffer = [];
        ...
        if (t1.get$first(t1) !== true) {
          ...
          if (response.$index(0, true) != null) {
            ...
            if (response.$index(0, true) instanceof G.Brick) {
              t1 = controller.game;
              response.$index(0, true).get$health();
              t1.points += 10;
            }
          }
    ...
    Brick: {
      "^": "GameObject;_item,health<,xPosition,yPosition,width,height,destroyed,itemsBuffer",
      collision$2: function(gameField, collisionObject) {
        var t1, t2, t3;
    ...
    Health: {
      "^": "Object;index",
      toString$0: function(_) {
        return C.Map_iTRoN.$index(0, this.index);
      }
    },
    Field: {
      "^": "GameObject;xPosition,yPosition,width,height,destroyed,itemsBuffer",
      collision$2: function(gameField, collisionObject) {
        return;
      },
      toString$0: function(_) {
    ...
    Game: {
      "^": "Object;countLevel,checkLevel,points,gameFields",
      moveBall$1: function(controller) {
        ...
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        C.JSArray_methods.forEach$1(t1[t2].balls, new G.Game_moveBall_closure(this, controller));
      },
      ...
      gameOver$0: function() {
        ...
        if (t3 >= t2.length)
          return H.ioore(t2, t3);
        C.JSArray_methods.forEach$1(t2[t3].balls, new G.Game_gameOver_closure(t1));
        return t1.gameOver;
      },
      won$0: function() {
        var t1, t2;
        ...
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        return !C.JSArray_methods.any$1(t1[t2].bricks, new G.Game_won_closure());
      },
      newLevel$0: function() {
        var t1, t2, t3;
        t1 = this.countLevel;
        ...
        if (t1 !== t3 - 1) {
          ...
          C.JSArray_methods.forEach$1(t2[t1].balls, new G.Game_newLevel_closure());
          ++this.countLevel;
        }
      },
      gameEnds$0: function() {
        if (this.countLevel === this.gameFields.length - 1)
          if (this.won$0())
            return true;
        return false;
      },
      _readConfig$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, i, answer, level;
        var $async$_readConfig$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              ...
              case 2:
                // for condition
                if (!(i < $async$self.checkLevel)) {
                  // goto after for
                  $async$goto = 4;
                  break;
                }
                $async$goto = 5;
                return P._asyncHelper(W.HttpRequest_getString("level" + i + ".json", null, null), $async$_readConfig$0, $async$completer);
              case 5:
                // returning from await.
                answer = $async$result;
                level = new G.Level(null, null, null, null, null, null, null, null);
                level.balls = [];
                level.items = [];
                level.bricks = [];
                level.readLevel$1(answer);
                $async$self.gameFields.push(level);
                ++$async$self.checkLevel;
              case 3:
                // for update
                ++i;
                // goto for condition
        ...
        return P._asyncHelper(null, $async$_readConfig$0, $async$completer, null);
      },
      Game$0: function() {
        this.gameFields = [];
        this.countLevel = 0;
      ...
      static: {
        Game$: function() {
          var t1 = new G.Game(null, 1, 0, null);
          t1.Game$0();
          return t1;
        }
      }
      ...
      call$1: function(ball) {
        ...
        if (ball.get$activated()) {
          ...
          if (ball.destroyed) {
            ...
            if (t2 >= t1.length)
              return H.ioore(t1, t2);
            t5.updateView$1(t1[t2]._gameField);
            return;
          }
        }
        t1 = this.$this;
    ...
    Game_gameOver_closure: {
      "^": "Closure:0;_box_0",
      call$1: function(b) {
        if (!b.get$destroyed() && b.get$activated())
          this._box_0.gameOver = false;
      }
    },
    Game_won_closure: {
      "^": "Closure:0;",
      call$1: function(brick) {
        return brick.get$health() !== C.Health_0;
      }
    },
    Game_newLevel_closure: {
      "^": "Closure:0;",
      call$1: function(ball) {
        ball.set$activated(false);
        ball.destroyed = true;
      }
    },
    GameObject: {
      "^": "Object;xPosition<,yPosition<,width>,height>,destroyed<",
    ...
    MoveableObject: {
      ...
      collisionAhead$4: function(direction, gameField, y, x) {
        ...
        if (!this._isOutofMap$3(y, x, gameField)) {
          ...
          if (!!this.$isBall && buffer instanceof G.Ball)
    ...
    Level: {
      "^": "Object;_height,_brickGame$_length,_countPositiveItems,_gameField,_player,balls,items,bricks",
      readLevel$1: function(config) {
        var jsonLevel, t1, playerHeight, playerLength, brickHeight, brickLength, ballHeight, ballLength, playerSpeed, jsonField, row, t2, col, t3, ball, newBrick;
        ...
        while (true) {
          ...
          while (true) {
            ...
            if (!(col < t2))
              break;
            if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "e") === 0) {
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              t2 = t2[col];
              t3 = new G.Field(col, row, brickLength, brickHeight, false, null);
              t3.itemsBuffer = [];
              $.Field__widthField = brickLength;
              $.Field__heightField = brickHeight;
              J.$indexSet$ax(t2, row, t3);
            } else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "item") === 0)
              ;
            else if (J.compareTo$1$ns(J.$index$asx(t1.$index(jsonField, row), col), "ball") === 0) {
              ball = new G.Ball(null, false, C.Direction_5, col, row, ballHeight, ballLength, false, null);
              ball.itemsBuffer = [];
              ball._damage = 1;
              ball.activated = true;
              t2 = this._gameField;
              ...
              t2 = new G.Player(null, playerSpeed, null, col, row, playerLength, playerHeight, false, null);
              t2.itemsBuffer = [];
              this._player = t2;
              t3 = this._gameField;
              if (col >= t3.length)
              ...
              t2 = J.$index$asx(t1.$index(jsonField, row), col);
              newBrick = new G.Brick(null, null, col, row, brickLength, brickHeight, false, null);
              newBrick.itemsBuffer = [];
              newBrick.health = G.generateHealth(t2);
              t2 = this._gameField;
              if (col >= t2.length)
                return H.ioore(t2, col);
              J.$indexSet$ax(t2[col], row, newBrick);
    ...
    Player: {
      "^": "MoveableObject;lastMove,_moveSpeed,_direction,xPosition,yPosition,width,height,destroyed,itemsBuffer",
      move$3: function(direction, gameField, controller) {
    ...
    View: {
      "^": "Object;warningoverlay,overlay,title,level,gameover,game,points,highscore,startHigh,menuView,gameView,backMenu,help,vanishedLeftRightButton,gameFields",
      ...
      update$2$scores: function(_, model, scores) {
        var t1, t2, field, row, col, td, object;
        t1 = model.gameOver$0() ? "Game Over!" : "";
        J.set$innerHtml$x(this.gameover, t1);
        t1 = this.startHigh.style;
        t2 = model.gameOver$0() ? "block" : "none";
        t1.display = t2;
        t1 = this.backMenu.style;
        t2 = model.gameOver$0() ? "block" : "none";
        t1.display = t2;
        t1 = this.vanishedLeftRightButton.style;
        t2 = model.gameOver$0() ? "none" : "block";
        t1.display = t2;
        J.set$innerHtml$x(this.level, "Level: " + (model.countLevel + 1));
      ...
      update$1: function($receiver, model) {
        return this.update$2$scores($receiver, model, C.List_empty);
      },
      ...
      generateHighscore$2$score: function(scores, score) {
        var list, points, t1;
        list = J.map$1$ax(scores, new G.View_generateHighscore_closure()).join$1(0, "");
      ...
      showHighscore$2: function(model, scores) {
        ...
        score = model.points;
        J.set$innerHtml$x(document.querySelector("#title"), "");
        t2.set$innerHtml(t1, "<div id='highscore'>   <h3>Highscore</h3></div><div id='highscorewarning'></div>");
        P.print(scores);
        if (score > 0)
          if (scores != null) {
            t3 = J.getInterceptor$asx(scores);
            t3 = t3.get$isEmpty(scores) === true || J.$lt$n(J.$index$asx(J.$index$asx(t3.get$last(scores), "state"), "points"), score) || J.$lt$n(t3.get$length(scores), 10);
          } else
            t3 = false;
        else
          t3 = false;
        if (t3)
          t2.insertAdjacentHtml$4$treeSanitizer$validator(t1, "beforeend", this.generateHighscore$2$score(scores, score) + "<form id='highscoreform'><input type='text' id='user' placeholder='user'><input type='password' id='password' placeholder='password'><button type='button' id='save'>Save</button><button type='button' id='close' class='discard'>Close</button></form>", null, null);
        else {
    ...
    View_generateHighscore_closure: {
      ...
      call$1: function(entry) {
        ...
        return "<li>" + H.S(t1.$index(entry, "username")) + ": " + H.S(J.$index$asx(t1.$index(entry, "state"), "points")) + "</li>";
      }
    }
  }], ["", "brickgameClient.dart",, X, {
    "^": "",
    main: [function() {
    ...
    SetMixin: {
      ...
      get$first: function(_) {
        var it = new P._LinkedHashSetIterator(this, this._modifications, null, null);
      ...
      get$last: function(_) {
        var it, result;
        it = new P._LinkedHashSetIterator(this, this._modifications, null, null);
        it._cell = this._first;
        if (!it.moveNext$0())
          throw H.wrapException(H.IterableElementError_noElement());
        do
...
;
  ...
  C.List_WDf = Isolate.makeConstantList([C.Health_0, C.Health_1, C.Health_2, C.Health_3]);
  ...
  C.Map_iTRoN = new H.GeneralConstantMap([0, "Health.grey", 1, "Health.green", 2, "Health.yellow", 3, "Health.red"]);
  ...
  $.Field__widthField = null;
  $.Field__heightField = null;
  $._nextCallback = null;
  $._lastCallback = null;
  $._lastPriorityCallback = null;
  $._isInCallbackLoop = false;
...
//# sourceMappingURL=brickgameClient.dart.js.map
